    ...
    <div class="container">
      <div class="center_it">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6">
            <img src="<?php  echo base_url(); ?>assets/front/images/404.png" alt="">
          </div>
          <div class="col-lg-6 text-center">
            <span class="spn-para">It looks like you are lost</span>
            <span class="span1">The page you are looking for no longer exist.<br>Don’t stress, we have a way out for you
              <a class="link-retry" href="<?php  echo base_url(); ?>">GO TO HOME</a></span>
          </div>
        </div>
      </div>
    </div>
