	...
	<tbody>
		...
		if (!empty($products_list)) { ?>
			...
			foreach ($products_list as $col) {
				...
				if (empty($combi_ref_code)) {
					$combi_ref_code = $product_combination_id;
				}
				$short_description = $short_description;
				?>
				<tr>
					<td><?php  echo $product_combination_id ?></td>
					<td><?php  echo $product_name ?></td>
					<td><?php  echo $product_weight ?></td>
					<td><?php  echo $manufacturer_name ?></td>
					<td></td>
					<td><?php  echo $tax_providers_percentage ?></td>
					<td><?php  echo $product_link ?></td>
					<td><?php  echo $m_category ?></td>
					<td><?php  echo $s_category ?></td>
					<td><?php  echo $ss_category ?></td>
					<td><?php  echo base_url() ?>assets/uploads/product/medium/<?  echo $product_image_name; ?></td>
					<td><?php  echo $combi_ref_code ?></td>
					<td><?php  echo $combi ?></td>
					<td><?php  echo number_format((float) $price, 2, '.', ''); ?> INR</td>
					<td><?php  echo $discount ?> </td>
					<td><?php  echo number_format((float) $final_price, 2, '.', ''); ?> INR</td>
...
//echo count($csv_head_arr[0]);exit;
			 ...
			 <td><?php  echo  base_url() ?>assets/uploads/product/medium/<?  echo $product_image_name; ?></td>
			 <td><?php  echo $manufacturer_name?></td>
			 <td><?php  echo implode(',' , $additional_images)?></td>
			 <td><?php  echo number_format((float)$final_price, 2, '.', '');?> INR</td>
