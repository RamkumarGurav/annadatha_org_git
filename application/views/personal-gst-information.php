                        ...
                        <div class="shipping-address">
                          <div class="shipping-address-inner">
                            <div class="shipping-address-center">
                              ...
                              <button class="add-addr-btn manageGstInfo noGstInfo" type="button" data-id="0" id="hide">ADD
                                GST INFORMATION</button>
                            </div>
                          </div>
                        </div>
                      </div>
...
<div id="smartblog_block" class="block products_block hb-animate-element bottom-to-top hb-in-viewport">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="editmodal_body">
            <form action="#" method="post" onSubmit="submitGstInfoForm()" id="user_address_form"
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" name="address" value="" id="address" class="form-control"
                        placeholder="GstInfo Line 1" required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" name="address2" value="" id="address2" class="form-control"
                        placeholder="GstInfo Line 2" required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" name="address3" value="" id="address3" class="form-control"
                        placeholder="GstInfo Line 3" required="required">
  ...
  <script type="text/javascript">
    ...
    function editGstInfo(id) {
      ...
      $.ajax({
        type: "POST",
        url: '<?php  echo base_url() ?>dashboard/editUpdateGstInfo',
        //dataType : "json",
        data: { 'gst_info_id': id },
        success: function (result) {
    ...
    function do_gst_info_form(id) {
      ...
      $("#gst_info_form").submit(function () {
        ...
        $.ajax({
          type: "POST",
          url: '<?php  echo base_url() ?>dashboard/do_gst_info_form',
          dataType: "json",
