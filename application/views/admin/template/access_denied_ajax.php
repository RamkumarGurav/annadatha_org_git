...
<div class="modal-content">
  <div class="modal-header">
    <h4 class="modal-title">ACCESS DENIED!!!</h4><button type="button" class="close" data-dismiss="modal"
  ...
  <div class="modal-body" id="'+modal_id+'-body-templete">
    ...
    <div class="cartfl_list">
      ...
      <article class="clearfix col-lg-12 cart-indi">
        ...
        <center><i class="fa fa-ban"></i>
          <h1>ACCESS <span style="color:#FF0000">DENIED!!!</span></h1>
        </center>
        ...
        ?>
        <p>
          <center><?php echo $no_access_flash_message ?></center>
        </p>
        <? 
        if (!empty($no_access_message)) {
          ...
          <p>
            <center>
              <div class="alert alert-info"><strong><?php echo $no_access_message ?></strong></div>
            </center>
          </p>
        <?  } ?>
      </article>
