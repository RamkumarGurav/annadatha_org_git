                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='aau.banner_name' <?  if ($field_name == 'aau.banner_name') {
                                                        echo 'selected';
                                                    } ?>>Banner
                                                        Name</option>
                                                    <option value='aau.link' <?  if ($field_name == 'aau.link') {
                                                        echo 'selected';
                                                    } ?>>Link</option>
                                                    <option value='aau.title1' <?  if ($field_name == 'aau.title1') {
                                                        echo 'selected';
                                                    } ?>>Title 1</option>
                                                    <option value='aau.title2' <?  if ($field_name == 'aau.title2') {
                                                        echo 'selected';
                                                    } ?>>Title 2</option>
                                                    <option value='aau.title3' <?  if ($field_name == 'aau.title3') {
                                                        echo 'selected';
                                                    } ?>>Title 3</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="record_status" id="banner_for" class="form-control"
                                                        style="width: 100%;">
                                                        <option value=''>Active / Block</option>
                                                        <option value='1' <?  if ($banner_for == 1) {
                                                            echo 'selected';
                                                        } ?>>
                                                            Active</option>
                                                        <option value='zero' <?  if ($banner_for == 'zero') {
                                                            echo 'selected';
                                                        } ?>>Block</option>
                                                    </select>
                        ...
                        <div class="card-header">
                            ...
                            <div class="float-right">
                                <? php if ($user_access->add_module == 1) { ?>
                                    <a href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/edit"><button
                                            type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add
                                            New</button></a>
                                    <a href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/setPositions"><button
                                            type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Set
                                            Position</button></a>
                                <?  } ?>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($banner_data as $urm) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?  } ?>
                                                    <td><a
                                                            href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->banner_id ?>"><? php echo $urm->banner_name ?></a>
                                                    </td>
                                                    <td><a href="<? php echo _uploaded_files_ . 'banner/' . $urm->image; ?>"
                                                            target="_blank"><img
                                                                src="<? php echo _uploaded_files_ . 'banner/' . $urm->image; ?>"
