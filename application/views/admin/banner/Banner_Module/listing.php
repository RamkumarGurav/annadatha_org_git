						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='aau.banner_name' <?php  if($field_name=='aau.banner_name'){echo 'selected';} ?>>Banner Name</option>
									<option value='aau.link' <?php  if($field_name=='aau.link'){echo 'selected';} ?>>Link</option>
									<option value='aau.title1' <?php  if($field_name=='aau.title1'){echo 'selected';} ?>>Title 1</option>
									<option value='aau.title2' <?php  if($field_name=='aau.title2'){echo 'selected';} ?>>Title 2</option>
									<option value='aau.title3' <?php  if($field_name=='aau.title3'){echo 'selected';} ?>>Title 3</option>
								</select>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="record_status" id="banner_for" class="form-control" style="width: 100%;">
										<option value='' >Active / Block</option>
										<option value='1' <?php  if($banner_for==1){echo 'selected';} ?>>Active</option>
										<option value='zero' <?php  if($banner_for=='zero'){echo 'selected';} ?>>Block</option>
									</select>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="sel_recds[]"
                                                ...
                                                value="<?php  echo $urm->banner_id; ?>" /></td>
                                        <?php  } ?>
										<td><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/view/".$urm->banner_id?>"><?php  echo $urm->banner_name	?></a></td>
                                        <td><a href="<?php  echo _uploaded_files_.'banner/'.$urm->image; ?>" target="_blank"><img src="<?php  echo _uploaded_files_.'banner/'.$urm->image; ?>" alt="Active" width="120" height="60"  border="0" /></a></td>
                                        <td><?php  echo $urm->link?></td>
                                        <td>
                                            <?php  if($urm->banner_for==1){ echo "Desktop"; } else{ echo "Mobile"; }?>
                                        </td>
