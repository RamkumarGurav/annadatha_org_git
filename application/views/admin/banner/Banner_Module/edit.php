			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?  if (!empty($banner_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $banner_id ?>">View</a></li>
						<?  } ?>
							...
							<div class="">
								...
								<div class="form-group row">
									<div class="col-lg-3 col-md-4 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Banner Name <span
										...
										<div class="col-sm-12">
											<input type="text" class="form-control form-control-sm" required id="banner_name" name="banner_name"
												value="<? php echo $banner_name ?>" placeholder="Banner Name">
											<span style="color:red" class="error_span" id="banner_name_error"></span>
										</div>
									</div>

									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Banner Link<span
										...
										<div class="col-sm-12	">
											<input type="text" class="form-control form-control-sm" id="link" name="link"
												value="<? php echo $link ?>" placeholder="Banner Link">
										</div>
									</div>

									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Upload Banner<span
												style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
								...
								<div class="form-group row mb-0">
									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Title 1<span
												style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control form-control-sm" id="title1" name="title1"
												value="<? php echo $title1 ?>" placeholder="First Title">

										</div>
									</div>
									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Title 2<span
												style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control form-control-sm" id="title2" name="title2"
												value="<? php echo $title2 ?>" placeholder="Second Title">

										</div>
									</div>

									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Title 3<span
												style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control form-control-sm" id="title3" name="title3"
												value="<? php echo $title3 ?>" placeholder="Third Title">

										</div>
									</div>

									<div class="col-md-3 col-sm-6">
										<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Title 4<span
												style="color:#f00;font-size: 22px;margin-top: 3px;"></span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control form-control-sm" id="title4" name="title4"
												value="<? php echo $title4 ?>" placeholder="Fourth Title">
									...
									<div class="col-md-3 col-sm-6">
										...
										<div class="col-sm-6">
											<div class="form-check" style="">
												<div class="form-group clearfix">
													<div class="icheck-success d-inline">
														<input type="radio" name="banner_for" <?  if ($banner_for == 1) {
															echo "checked";
														} ?> value="1"
															id="banner_forradioSuccess1">
								...
								<div class="card-footer">
									<center>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="submit" name="save-add-new" onclick="return redirect_type_func('save-add-new')"
											value="1" class="btn btn-default ">Save And Add New</button>
									</center>
								</div>
