                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            <? php if ($user_access->update_module == 1) { ?>
                                <a
                                    href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/edit/<? php echo $banner_data->banner_id ?>"><button
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body card-primary card-outline">
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign">
                                <tbody>
                                    <tr>
                                        <td><strong class="full">Data Base Id</strong><? php echo $banner_data->banner_id ?>
                                        </td>
                                        <td><strong class="full">Banner Name</strong><? php echo $banner_data->banner_name ?>
                                        </td>
                                        <td colspan="2"><strong class="full">Link</strong><? php echo $banner_data->link ?>
                                        </td>
                                        ...
                                        <td colspan="2"><strong class="full">Banner Image</strong>
                                            <?  if (!empty($banner_data->image)) { ?>
                                                <span class="pip"><a target="_blank"
                                                        href="<? php echo _uploaded_files_ . 'banner/' . $banner_data->image ?>"><img
                                                            class="imageThumb"
                                                            src="<? php echo _uploaded_files_ . 'banner/' . $banner_data->image ?>"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <? php echo date("d-m-Y h:i:s A", strtotime($banner_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <? php echo $banner_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?  if (!empty($banner_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($banner_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?  if (!empty($banner_data->updated_by_name)) {
                                                echo $banner_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?  if ($banner_data->status == 1) { ?> Active <i
                                        ...
                                        <td>
                                            ...
                                            <?  if ($banner_data->banner_for == 1) { ?> Desktop <i
                                                    class="fas fa-check btn-success btn-sm "></i>
                                            <?  } else { ?> Mobile <i class="fas fa-ban btn-danger btn-sm "></i>
                                            <?  } ?></
                                        td>
