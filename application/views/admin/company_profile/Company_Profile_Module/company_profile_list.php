										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
													...
													<option value='aau.name' <?  if ($field_name == 'aau.company_unique_name') {
														echo 'selected';
													} ?>>
														Company Unique Name</option>
													<option value='aau.company_name' <?  if ($field_name == 'aau.company_name') {
														echo 'selected';
													} ?>>
														Company Name</option>
													...
													<option value='aau.mobile_no' <?  if ($field_name == 'aau.mobile_no') {
														...
														No.</option>
													<option value='aau.gst_no' <?  if ($field_name == 'aau.gst_no') {
														echo 'selected';
													} ?>>GST No.
													</option>
												</select>
					...
					<div class="card">
						...
						if ($user_access->view_module == 1) {
							...
							<div class="card-body">
								...
								<? php echo form_open(MAINSITE_Admin . "$user_access->class_name/userCompanyProfile-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form')); ?>
										...
										<tbody>
											...
											foreach ($company_profile_data as $urm) {
												...
												<tr>
													...
													<?  } ?>
													<td><a
															href="<? php echo MAINSITE_Admin . $user_access->class_name . "/company-profile-view/" . $urm->company_profile_id ?>"><? php echo $urm->company_unique_name ?></a>
													</td>
