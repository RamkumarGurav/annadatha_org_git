                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="enquiry_mode"
                                                    name="enquiry_mode" style="width: 100%;">
                                                    <option value="">Select Enquiry Mode</option>
                                                    <option value="1" <? php if ($enquiry_mode == 1) {
                                                        echo "selected";
                                                    } ?>>Cash</option>
                                                    <option value="2" <? php if ($enquiry_mode == 2) {
                                                        echo "selected";
                                                    } ?>>UPI</option>
                                                    <option value="3" <? php if ($enquiry_mode == 3) {
                                                        echo "selected";
                                                    } ?>>Bank</option>
                                                </select>
                                                </select>
                                            ...
                                            <tr>
                                                ...
                                                <? php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<? php echo $count; ?>"
                                                            value="<? php echo $urm->enquiry_id; ?>" /></td>
                                                <?  } ?>
                                                <td><a
                                                        href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->enquiry_id ?>"><? php echo date("d-m-Y", strtotime($urm->added_on)) ?></a>
                                                </td>
