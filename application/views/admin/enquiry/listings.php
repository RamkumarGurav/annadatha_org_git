						...
						<div class="row">
								...
								<div class="form-group">
									...
									<select type="text" class="form-control"  id="customer_profile_id" name="customer_profile_id" style="width: 100%;">
										...
										<?php  foreach($customer_data as $cd){
											...
											?>
											<option value="<?php  echo $cd->customer_profile_id?>" <?php  echo $selected?>><?php  echo $cd->customer_name?>-<?php  echo $cd->company_name?>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select type="text" class="form-control"  id="enquiry_mode" name="enquiry_mode" style="width: 100%;">
										<option value="">Select Enquiry Mode</option>
                                        <option value="1" <?php  if($enquiry_mode == 1) { echo "selected"; } ?> >Cash</option>
                                        <option value="2" <?php  if($enquiry_mode == 2) { echo "selected"; } ?> >UPI</option>
                                        <option value="3" <?php  if($enquiry_mode == 3) { echo "selected"; } ?> >Bank</option>
									</select>
									</select>
                        	...
                        	<div class="col-md-3">
								<div class="form-group">
									...
									<select type="text" class="form-control"  id="admin_user_id" name="admin_user_id" style="width: 100%;">
										...
										<?php  foreach($employee_data as $cd){
											$selected="";
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php  } ?>
										<td><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/view/".$urm->enquiry_id?>"><?php  echo date("d-m-Y" , strtotime($urm->added_on))?></a></td>
