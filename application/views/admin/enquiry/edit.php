						...
						<div class="card-body">
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									...
									<div class="col-sm-12">
										<div class="input-group date enquiry_date_input" id="enquiry_date_input" data-target-input="nearest">
											<input type="text" readonly="readonly" value="<? php echo $enquiry_date_input ?>" name="enquiry_date"
							...
							<div class="form-group row">
								<div class="col-lg-3 col-md-4 col-sm-6">
									...
									<div class="col-sm-12">
										<select name="subject" id="subject" class="form-control" required>
											...
											<option value="Bulk Inquiry" <?  if ($subject == 'Bulk Inquiry') {
												echo "selected";
											} ?>>Bulk Inquiry
											</option>
											<option value="Export Inquiry" <?  if ($subject == 'Export Inquiry') {
												echo "selected";
											} ?>>Export Inquiry
											</option>
								...
								<div class="col-lg-3 col-md-6 col-sm-12">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Enquiry Remarks <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
										<input type="text" class="form-control form-control-sm" id="description" name="description"
											value="<? php echo $description ?>" placeholder="Enquiry Description" required>
									</div>
								</div>
