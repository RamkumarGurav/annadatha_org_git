...
$page_module_name = "Unit Of Measurement";
                    ...
                    <div class="card card-primary">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" style="">
                            <div class="card-body">
                                ...
                                <?php   echo form_open(MAINSITE_Admin . "$user_access->class_name/$user_access->function_name", array('method' => 'post', 'id' => 'search_report_form', "name" => "search_report_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form')); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.unit_of_measurement_name' <?   if ($field_name == 'urm.unit_of_measurement_name') {
                                                        echo 'selected';
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->add_module == 1) {
                                ?>
                                <a href="<?php   echo MAINSITE_Admin . $user_access->class_name ?>/unit-of-measurement-edit">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php   echo form_open(MAINSITE_Admin . "$user_access->class_name/userUnitOfMeasurement-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form')); ?>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <?   if (!empty($unit_of_measurement_master_data)) { ?>
                                    <tbody>
                                        <?  
                                        ...
                                        foreach ($unit_of_measurement_master_data as $urm) {
                                            $count++;
                                            ?>
                                            <tr>
                                                ...
                                                <?php   if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php   echo $count; ?>"
                                                            value="<?php   echo $urm->unit_of_measurement_id; ?>" /></td>
                                                <?   } ?>
                                                <td><a
                                                        href="<?php   echo MAINSITE_Admin . $user_access->class_name . "/unit-of-measurement-view/" . $urm->unit_of_measurement_id ?>"><?php   echo $urm->unit_of_measurement_name ?></a>
                                                </td>
