...
if (!empty($discount_group_data)) {
	...
	$discount_group_id = $discount_group_data->discount_group_id;
	$discount_group_name = $discount_group_data->discount_group_name;
	$discount_group_description = $discount_group_data->discount_group_description;
	$status = $discount_group_data->status;
						...
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Discount Group Name <span
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Discount Group Description <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
