                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.discount_group_name' <?php if ($field_name == 'urm.discount_group_name') {
                                                        echo 'selected';
                                                    } ?>>
                                                        Group Name</option>
                                                </select>
                                ...
                                <table id="example1" class="table table-bordered table-hover table-striped">
                                    ...
                                    <?php if (!empty($discount_group_data)) { ?>
                                        <tbody>
                                            ...
                                            foreach ($discount_group_data as $urm) {
                                                $count++;
                                                ?>
                                                <tr>
                                                    ...
                                                    <?php if ($user_access->update_module == 1) { ?>
                                                        <td><input type="checkbox" name="sel_recds[]"
                                                                ...
                                                                value="<?php echo $urm->discount_group_id; ?>" /></td>
                                                    <?php } ?>
                                                    <td><a
                                                            href="<?php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->discount_group_id ?>"><?php echo $urm->discount_group_name ?></a>
                                                    </td>
                                                    <td><?php echo $urm->discount_group_description ?></td>
