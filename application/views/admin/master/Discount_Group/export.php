...
$filename = "Discount Group-List-" . date('d-m-Y') . ".xls";
...
<head>
    ...
    <title>Discount Group List</title>
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            if (!empty($discount_group_data)) { //print_r($ptype_list);
                foreach ($discount_group_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?  echo $row->discount_group_name; ?></td>
                            <td width="*"><?  echo $row->discount_group_description; ?></td>
