                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.department_name' <?  if ($field_name == 'urm.department_name') {
                                                        echo 'selected';
                                                    } ?>>
                                                        Department</option>
                                                </select>
                ...
                <div class="card">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <? php echo form_open(MAINSITE_Admin . "$user_access->class_name/userDepartment-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <?  if (!empty($department_master_data)) { ?>
                                    <tbody>
                                        ...
                                        foreach ($department_master_data as $urm) {
                                            $count++;
                                            ?>
                                            <tr>
                                                ...
                                                <? php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<? php echo $count; ?>"
                                                            value="<? php echo $urm->department_id; ?>" /></td>
                                                <?  } ?>
                                                <td><a
                                                        href="<? php echo MAINSITE_Admin . $user_access->class_name . "/department-view/" . $urm->department_id ?>"><? php echo $urm->department_name ?></a>
                                                </td>
