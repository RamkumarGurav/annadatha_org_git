...
$filename = "Department-List-" . date('d-m-Y') . ".xls";
...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            if (!empty($department_master_data)) { //print_r($ptype_list);
                foreach ($department_master_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><?  echo $row->department_name; ?></td>
