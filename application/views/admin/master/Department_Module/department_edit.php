			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?  if (!empty($department_master_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<? php echo MAINSITE_Admin . $user_access->class_name . "/department_view/" . $department_id ?>">View</a>
							</li>
						<?  } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><? php echo $department_name ?> <small><? php echo $record_action ?></small></h3>
					</div>
					<!-- /.card-header -->
					<? php
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-sm-6 row">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control form-control-sm" required id="department_name"
											name="department_name" value="<? php echo $department_name ?>" placeholder="Department">
