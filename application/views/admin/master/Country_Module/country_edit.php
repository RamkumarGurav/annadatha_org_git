			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?  if (!empty($country_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<? php echo MAINSITE_Admin . $user_access->class_name . "/country_view/" . $country_id ?>">View</a></li>
						<?  } ?>
				...
				<div class="card">
					...
					if ($user_access->view_module == 1 || true) {
						...
						<div class="card-body">
							...
							<? php echo form_open(MAINSITE_Admin . "$user_access->class_name/userCountryDoEdit", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" required id="country_short_name"
											name="country_short_name" value="<? php echo $country_short_name ?>" placeholder="Country Short Name">
