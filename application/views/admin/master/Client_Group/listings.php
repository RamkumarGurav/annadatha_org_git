                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.group_name' <?  if ($field_name == 'urm.group_name') {
                                                        echo 'selected';
                                                    } ?>>Group
                                                        Name</option>
                                                </select>
                                ...
                                <table id="example1" class="table table-bordered table-hover table-striped">
                                    ...
                                    <?  if (!empty($client_group_data)) { ?>
                                        <tbody>
                                            ...
                                            foreach ($client_group_data as $urm) {
                                                $count++;
                                                ?>
                                                <tr>
                                                    ...
                                                    <? php if ($user_access->update_module == 1) { ?>
                                                        <td><input type="checkbox" name="sel_recds[]"
                                                                ...
                                                                value="<? php echo $urm->group_id; ?>" /></td>
                                                    <?  } ?>
                                                    <td><a
                                                            href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->group_id ?>"><? php echo $urm->group_name ?></a>
                                                    </td>
                                                    <td><? php echo $urm->group_description ?></td>
                                                    <td><? php echo $urm->minimum_order_value ?></td>
