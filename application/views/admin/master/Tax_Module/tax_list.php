                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='urm.tax_name' <?php if ($field_name == 'urm.tax_name') {
                                                        echo 'selected';
                                                    } ?>>Tax</option>
                                                    <option value='urm.tax_percentage' <?php if ($field_name == 'urm.tax_percentage') {
                                                        echo 'selected';
                                                    } ?>>Tax
                                                        Percentage</option>
                                                </select>
                ...
                <div class="card">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open(MAINSITE_Admin . "$user_access->class_name/userTax-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->tax_id; ?>" /></td>
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/tax-view/" . $urm->tax_id ?>"><?php echo $urm->tax_name ?></a>
                                                </td>
                                                <td><?php echo $urm->tax_percentage ?></td>
