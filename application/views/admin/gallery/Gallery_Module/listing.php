                                                ...
                                                <tr>
                                                    ...
                                                    <? php if ($user_access->update_module == 1) { ?>
                                                        <td><input type="checkbox" name="sel_recds[]"
                                                                id="sel_recds<? php echo $count; ?>" value="<? php echo $urm->id; ?>" />
                                                        </td>
                                                    <?  } ?>
                                                    <td><a
                                                            href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->id ?>"><? php echo $urm->name ?></a>
                                                    </td>
                                                    <td><a href="<? php echo _uploaded_files_ . 'gallery/medium/' . $urm->image; ?>"
                                                            target="_blank"><img
                                                                src="<? php echo _uploaded_files_ . 'gallery/medium/' . $urm->image; ?>"
