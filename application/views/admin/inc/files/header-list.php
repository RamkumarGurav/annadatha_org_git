...
<link rel="stylesheet" href="<?php  echo  _lte_files_?>plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <?php  echo  /*?><link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css"><?php  echo  */?>
  <!-- DataTables -->
...
<?php  echo  /*?>  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/fixedheader/3.1.2/css/fixedHeader.dataTables.min.css"><?php  echo  */?>
	...
	<link rel="stylesheet" href="<?php  echo  _lte_files_?>plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  ...
  <?php  echo  /*?><link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet"><?php  echo  */?>
  <style type="text/css">
