...
<?php  */ ?>
        ...
        <li class="nav-item dropdown user-menu ">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
            <img src="<?php  echo IMAGE ?>logo.png" class="user-image img-circle elevation-2" alt="User Image">
    ...
    border-radius: 5%;">
            ...
            <li class="user-header ">
              <img src="<?php  echo IMAGE ?>logo.png" class="img-circle elevation-2" alt="User Image">

              <p>
                <?php  echo $user_data->name ?> - <?php  echo $user_data->user_role_name ?>
       ...
       <!-- /.row -->
            ...
            <li class="user-footer">
              ...
              <a href="<?php  echo MAINSITE_Admin . 'wam/logout' ?>" class="btn btn-default float-right"><b>Logout</b></a>
            </li>
          </ul>
        </li>
        <!-- <li class="nav-item">
                      ...
                      <select type="text" class="form-control custom-select" name="sess_company_profile_id"
                        ...
                        <?php  foreach ($user_data->roles as $r) { ?>
                          <option <?php  if ($this->session->userdata('sess_company_profile_id') == $r->company_profile_id) {
                            echo "selected";
                          } ?> value="<?php  echo $r->company_profile_id ?>"><?php  echo $r->company_unique_name ?>
                          </option>
                        <?php  } ?>
                      </select>
                    </div>
