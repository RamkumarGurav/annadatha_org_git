                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/employee-edit/<? php echo $employee_data->admin_user_id ?>">
                            ...
                            <div class="divTable" style="display:none;">
                                ...
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        if (!empty($employee_data->address1)) {
                                            echo ", " . $employee_data->address2;
                                        }
                                        if (!empty($employee_data->address3)) {
                                            echo ", " . $employee_data->address3;
                                        }
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if ($employee_data->data_view == 1) { ?> Yes <i
                                ...
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if ($employee_data->status == 1) { ?> Active <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?  if (!empty($employee_data->joining_date)) {
                                                echo date("d-m-Y", strtotime($employee_data->joining_date));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                                ...
                                                <ol>
                                                    <?  foreach ($employee_data->files as $f) { ?>
                                                        <li><? php echo $f->file_title ?> &nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank"
                                                                href="<? php echo _uploaded_files_ . 'employee_file/' . $f->file_name ?>">View</a>
                                                        </li>
                                                    <?  } ?>
                                                </ol>
