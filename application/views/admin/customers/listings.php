                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="customer_profile_id"
                                                    name="customer_profile_id" style="width: 100%;">
                                                    <option value="">Select Customer</option>
                                                    <?  foreach ($customer_data as $cd) {
                                                        $selected = "";
                                                        if ($cd->customer_profile_id == $customer_profile_id) {
                                                            $selected = "selected";
                                                        }
                                                        ?>
                                                        <option value="<? php echo $cd->customer_profile_id ?>" <? php echo $selected ?>>
                                                            <? php echo $cd->customer_name ?>-<? php echo $cd->company_name ?>
                                                            <?  if ($cd->status != 1) {
                                                                echo " [Block]";
                                                            } ?>
                                                        </option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="customers_mode"
                                                    name="customers_mode" style="width: 100%;">
                                                    <option value="">Select Customers Mode</option>
                                                    <option value="1" <? php if ($customers_mode == 1) {
                                                        echo "selected";
                                                    } ?>>Cash</option>
                                                    <option value="2" <? php if ($customers_mode == 2) {
                                                        echo "selected";
                                                    } ?>>UPI</option>
                                                    <option value="3" <? php if ($customers_mode == 3) {
                                                        echo "selected";
                                                    } ?>>Bank</option>
                                                </select>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control" id="admin_user_id"
                                                    name="admin_user_id" style="width: 100%;">
                                                    <option value="">Select Employee</option>
                                                    <?  foreach ($employee_data as $cd) {
                                                        $selected = "";
                                                        if ($cd->admin_user_id == $admin_user_id) {
                                                            $selected = "selected";
                                                        }
                                                        ?>
                                                        <option value="<? php echo $cd->admin_user_id ?>" <? php echo $selected ?>><? php echo $cd->name ?>
                                                            <?  if ($cd->status != 1) {
                                                                echo " [Block]";
                                                            } ?>
                                                        </option>
                                            ...
                                            <tr>
                                                ...
                                                <? php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<? php echo $count; ?>"
                                                            value="<? php echo $urm->customers_id; ?>" /></td>
                                                <?  } ?>
                                                <td><a
                                                        href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->customers_id ?>"><? php echo $urm->name ?></a>
                                                </td>
                                                <td><? php echo $urm->email ?></td>
                                                <td><? php echo $urm->number ?></td>
