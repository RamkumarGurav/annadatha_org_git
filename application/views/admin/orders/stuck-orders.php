			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="panel">
						...
						<span style="background-color:#0F0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Order
						Successfull&nbsp;&nbsp;&nbsp;
						<span style="background-color:#0FF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Go For the Payment But Did
						not come back &nbsp;&nbsp;&nbsp;
						<span style="background-color:#F0F">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Go For the Payment But
						Payment Not Done&nbsp;&nbsp;&nbsp;
								...
								<tbody>
									...
									if (count($orders_list) != 0) {
										foreach ($orders_list as $o) {
											...
											if ($o->stuck_status == 2) {
												$color = "#0FF";
											}//Go For the Payment But Did not come back 
											if ($o->stuck_status == 3) {
												$color = "#F0F";
											}//Go For the Payment But Payment Not Done
											?>
											...
											<span class="custom-control-indicator"></span>
												...
												<td>
													<?php if (!empty($o->order_number)) { ?><a class="btn btn-default" target="_blank"
															href="<?php echo MAINSITE . "SecureRegions/orders/details/" . $o->orders_id; ?>"><?php echo $o->order_number ?></a><?php } else { ?>
														<a class="btn btn-default"
															href="<?php echo MAINSITE . "SecureRegions/orders/stuckOrderDetails/" . $o->temp_orders_id; ?>">View
															Details</a>
													<?php } ?>
												...
												<?php   /*?><td><?php   echo $o->total_prod?></td><?php   */ ?>
