...
foreach ($od->details as $odd) {
  ...
  /*$item_array[] = array(
     ...
     "brand"=> $odd->brand_name,
     "pcat"=> 'test',
     "si"=> 'test'
   );*/
  $item_array[] = array(
    "skuNumber" => $odd->ref_code,
...
$vendor_address1 = 'MPP Complex, Shop No. 14 15 Siddipet Road';
$vendor_address2 = 'Ramayampet';
$vendor_city = 'Medak';
$vendor_state = 'Telangana';
$vendor_country = 'India';
$vendor_company_name = 'Annadatha Rythu Seva Kendram';
$vendor_name = 'Annadatha Rythu Seva Kendram';
$vendor_phone = '+91 94411 78412';
$vendor_pin = '502101';
$vendor_gst = '36AKRPG7758C2ZS';
...
$arrayVar = array(
  "labelRequest" => array(
    "hdr" => array(
      ...
      "messageDateTime" => "Tue Jun 18 2023 05:34:55 GMT+0000 (UTC)",
      "accessToken" => $dtdc_Lib->dtdc_key,
      "messageVersion" => "1.0",
      "messageLanguage" => "en",
    ),
    "bd" => array(
      ...
      "hubDetails" => array(
        "hubType" => "FR",
        "hubCode" => "BF068",
        "recievingDateTime" => date("Y:m:d H:i:s"),
        "recievingRemarks" => "",
        "custCode" => "S0001223445",
      ),
      ...
      "shipmentItems" => array(
        array(
          "consigneeAddress" => array(
            "companyName" => "",
            "name" => $od->d_name,
            "address1" => $od->d_address,
            "address2" => $od->d_address2,
            "address3" => $od->d_address3,
            "city" => $od->d_city_name,
            "state" => $od->d_state_name,
            "district" => "",
            "country" => "IN",
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://firstmileapi.dtdc.com/dtdc-api/api/custOrder/addCPDPBookingOrder',
  ...
  CURLOPT_HTTPHEADER => array(
    'X-Access-Token: ' . $dtdc_Lib->dtdc_key,
