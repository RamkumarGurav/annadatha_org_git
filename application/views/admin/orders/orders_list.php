...
<div class="content-wrapper">
	<form role="form" class="form-horizontal" name="recordslistform" id="recordslistform" action="#" method="post"
		enctype="multipart/form-data">
		<div>
			<div class="content-header clearfix">
				<h1 class="pull-left">Orders</h1>

				<?php    /*?><div class="pull-right"><a class="btn bg-blue" href="<?php    echo MAINSITE."SecureRegions/wdm/tax_providers_action_page";?>"><i class="fa fa-plus-square"></i>Add New</a>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="panel">
						...
						<span style="background-color:#F00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Order
						Placed&nbsp;&nbsp;&nbsp;
						<span style="background-color:#4935FD">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> In
						Process&nbsp;&nbsp;&nbsp;
						<span style="background-color:#FF0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Out For
						Delivery&nbsp;&nbsp;&nbsp;
						<span style="background-color:#0F0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Delivered&nbsp;&nbsp;&nbsp;
						<span style="background-color:#0FF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Not
						Deliver&nbsp;&nbsp;&nbsp;
								...
								<thead>
									<tr>
										...
										<?php if ($login_type == 'admin') { ?>
											<th width="*%"><strong>Store Name</strong></th><?php } ?>
								...
								<tbody>
									...
									if (count($orders_list) != 0) {
										foreach ($orders_list as $o) {
											...
											if ($o->order_status == 1) {
												$color = "#F00";
												$color_bar = '<span style="background-color:#F00" title="Order Placed">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//Order Placed
											if ($o->order_status == 2) {
												$color = "#4935FD";
												$color_bar = '<span style="background-color:#4935FD" title="In Process">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//In Process
											if ($o->order_status == 3) {
												$color = "#FF0";
												$color_bar = '<span style="background-color:#FF0" title="Out For Delivery">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//Out For Delivery
											if ($o->order_status == 4) {
												$color = "#0F0";
												$color_bar = '<span style="background-color:#0F0" title="Delivered">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//Delivered
											if ($o->order_status == 5) {
												$color = "#0FF";
												$color_bar = '<span style="background-color:#0FF" title="Not Deliver">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//Not Deliver
											if ($o->order_status == 6) {
												$color = "#F0F";
												$color_bar = '<span style="background-color:#F0F" title="Cancel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>';
											}//Cancel
											?>
											<tr <?php    /*?>style="background-color: <?php    echo $color?>"<?php    */ ?>>
												<?php    /*?><td>
												...
												<?php if ($login_type == 'admin') { ?>
													<td><?php echo $o->store_name ?></td><?php } ?>
												<td><?php echo $o->symbol ?> 		<?php echo $o->amount ?></td>
												<td><?php echo $o->total_prod ?></td>
												<td><?php echo date('d-m-Y h:i:s A', strtotime($o->added_on)) ?></td>
												<td>
													<?php if ($o->order_status == 1) {
														...
														echo "Delivered";
													} else if ($o->order_status == 5) {
														echo "Not Deliver";
													} else if ($o->order_status == 6) {
														echo "Cancle";
													} ?>
												</td>
												<td><a class="btn btn-default"
														href="<?php echo MAINSITE . "SecureRegions/orders/details/" . $o->orders_id; ?>"><i
															class="fa fa-pencil"></i>Edit</a> &nbsp;&nbsp; <?php echo $color_bar ?></td>
