	...
	<form role="form" class="form-horizontal" name="recordslistform" id="recordslistform" action="#" method="post"
		...
		<div>
			<div class="content-header clearfix">
				<h1 class="pull-left">Orders Are Cancel</h1>
					...
					<div class="panel">
						<div class="panel-body">
								...
								<tbody>
									...
									if (count($orders_list) != 0) {
										foreach ($orders_list as $o) {
											...
											?>
											<tr style="background-color: <?php  if ($o->order_status == 1) {
												echo "#F00";
											} ?>">
												<?php  /*?><td>
						 ...
						 <span class="custom-control-indicator"></span>
												...
												<?php  /*?><td><?php  if($o->order_status==1){echo "Order placed";}else if($o->order_status==2){echo "In Process";}else if($o->order_status==3){echo "Out For Delivery";}else if($o->order_status==4){echo "Delivered";}else if($o->order_status==5){echo "Not Deliver";}else if($o->order_status==6){echo "Cancel";} ?></td><?php  */ ?>
