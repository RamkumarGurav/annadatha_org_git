				...
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="col-md-8 text-right">
							<?php   /*?><a href="<?php   echo MAINSITE."secureRegions/wdm/stores/edit/".$od->orders_id;?>" class="btn btn-primary ">Update Stores Details</a>&nbsp;<?php   */ ?>

							<?php   if (true) { ?>
								<?php   if ($od->order_status != 6 && $od->order_status != 4) { ?>
									<a href="#Modalpop" data-toggle="modal" class="btn btn-primary">Take Action</a>
								<?php   }
							} ?>

							<a href="<?php   echo MAINSITE . "secureRegions/orders/Orders_Module/orderInvoice/$od->orders_id"; ?>"
								target="_blank" class="btn btn-primary">Print Order</a>
							<?php   if (!empty($od->order_invoice)) { ?>
								<a href="<?php   echo base_url() . "assets/uploads/invoice/" . $od->order_invoice; ?>" target="_blank"
									class="btn btn-primary">Invoice</a>
							<?php   } ?>

							<?php   if ($od->courier_name == 'Bluedart' && false) {

								?>
								<a href="<?php   echo MAINSITE . "secureRegions/orders/trackOrder/$od->orders_id"; ?>" target="_blank"
									class="btn btn-primary">Track Order</a>
							<?php   } ?>

							<?php   if (!empty($od->docket_no) && $od->courier_name == 'Delhivery') { ?>
					...
					<div class="box-body">
						...
						<div class="tab-content  ">
							<ul class="nav nav-tabs " role="tablist">
								<li role="presentation" class="active"><a href="#od_details" id="od_details_a" aria-controls="messages"
										role="tab" data-toggle="tab" aria-expanded="true">Details</a></li>
								<li role="presentation" class=""><a href="#od_history" aria-controls="home" role="tab" data-toggle="tab"
										aria-expanded="false">History</a></li>
								<?php   /*if($od->courier_name == 'Bluedart'){ ?>
					...
					<?php   }*/ ?>
							...
							<div role="tabpanel" class="tab-pane fade  active in" id="od_details">
									...
									<div class="box-body">
										...
										if (!empty($od->order_status)) {
											if ($od->order_status == 2) {
												...
												<?php   if ($od->d_country_id == __const_country_id__) {# only or local in india ?>
													<?php   if (empty($od->docket_no)) {
								...
								<button type="submit" value="2" class="btn btn-danger" name="by_delhivery">Ship By Delhivery</button><?php   */ ?>
														...
														if ($domestic_shipping_type == 1) {
															...
															<form role="form" class="form-horizontal" name="ShippingForm" id="ShippingForm" action=""
																...
																<section class="content">
																	<div class="row">
																		...
																		<input type="hidden" name="orders_id" id="orders_id" value="<?php   echo $od->orders_id ?>" />
																		<!-- left column -->
																		<div class="col-md-10">
																			...
																			<div class="box box-primary">
																				...
																				<div class="box-body">
																					<div class="form-group">
																						<div class="col-md-3">
																							<div class="label-wrapper"><label class="control-label" for="Name">Package Send
																									t</label>
																								<div data-title="Total Package Weight (In Gram)." class="ico-help icon_title_box">
																						...
																						<div class="col-md-9">
																							...
																							<div class="input-group input-group-required">
																								...
																								foreach ($delivery_type_list as $dtl) {
																									?>
																									<input type="radio" class="" name="blue_dart_product_code"
																										id="blue_dart_product_code<?php   echo $dtl->slno ?>" <?php   if ($dtl->slno == 1) {
																												echo "checked";
																											} ?> value="<?php   echo $dtl->blue_dart_product_code ?>" />
																									<?php   echo $dtl->label ?> &nbsp;&nbsp;
																								<?php   } ?>
																					...
																					<div class="form-group">
																						<div class="col-md-3">
																							<div class="label-wrapper"><label class="control-label" for="Name">Package Weight
																									(In GM)</label>
																								<div data-title="Total Package Weight (In Gram)." class="ico-help icon_title_box">
																									<i class="fa fa-question-circle"></i></div>
																							</div>
																						...
																						<div class="col-md-9">
																							<div class="input-group input-group-required">
																								<input type="number" step="any" min="0.01" name="total_package_weight"
																									id="total_package_weight" placeholder="Total Package Weight"
																									class="form-control" value="<?php   echo $total_package_weight ?>">
																								<div class="input-group-btn"><span class="required">*</span>
																								</div>
																							</div><span class="field-validation-valid" data-valmsg-for="Name"
																								data-valmsg-replace="true"></span>
																					...
																					<div class="form-group">
																						<div class="col-md-3">
																							<div class="label-wrapper"><label class="control-label" for="Name">Dimension
																									(L*B*H)(In CM)</label>
																						...
																						<div class="col-md-3">
																							<div class="input-group input-group-required">
																								<input type="number" name="box_l" id="box_l" min="1" placeholder="Lenght"
																									class="form-control" value="<?php   echo $box_l ?>">
																								<div class="input-group-btn"><span class="required">*</span>
																								</div>
																							</div><span class="field-validation-valid" data-valmsg-for="Name"
																								data-valmsg-replace="true"></span>
																						...
																						<div class="col-md-3">
																							<div class="input-group input-group-required">
																								<input type="number" name="box_b" id="box_b" min="1" placeholder="Breadth"
																									class="form-control" value="<?php   echo $box_b ?>">
																								<div class="input-group-btn"><span class="required">*</span>
																								</div>
																							</div><span class="field-validation-valid" data-valmsg-for="Name"
																								data-valmsg-replace="true"></span>
																						...
																						<div class="col-md-3">
																							<div class="input-group input-group-required">
																								<input type="number" name="box_h" id="box_h" min="1" placeholder="Height"
																									class="form-control" value="<?php   echo $box_h ?>">
																								<div class="input-group-btn"><span class="required">*</span>
																								</div>
																							</div><span class="field-validation-valid" data-valmsg-for="Name"
																								data-valmsg-replace="true"></span>
																					...
																					<div class="form-group">
																						...
																						<div class="col-md-12">
																							<div class="input-group input-group-required">
																								<center>
																									<button type="button" class="btn btn-primary CalculateShippingBtn docket_btn"
																										style="display:none" onclick="generateBluedartDocketNo()" id="load1"
																										data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Calculating Shipping Price">Assign
																										Docket No.</button>
																									<?php   /*?><br>
													 <br>
												 <button type="button" class="btn btn-primary btn-lg" id="load2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Order">Submit Order</button><?php   */ ?>
														...
														<?php   } else if ($domestic_shipping_type == 2) { ?>
															<?php  
															$insurance = 2;
															$service = 2;
															$total_package_weight = $od->total_weight;
																					...
																					<div class="box-body">
																						...
																						<div class="form-group">
																							...
																							<div class="col-md-12">
																								<div class="input-group input-group-required">
																									<center>
																										<button type="button" class="btn btn-primary CalculateShippingBtn"
																											onclick="generateDocketNoDelhivery()" id="load1"
																											data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Calculating Shipping Price">Assign
																											Docket No.</button>
																									<?php   /*?><br>
													 <br>
												 <button type="button" class="btn btn-primary btn-lg" id="load2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing Order">Submit Order</button><?php   */ ?>
																...
																<script>
																	...
																	function assignShiprocketGenerateManifests() {
																		...
																		$.ajax({
																			type: "POST",
																			url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_shiprocket_order_generate_manifest_api/',
																	...
																	function assignShiprocketPrintManifests() {
																		...
																		$.ajax({
																			type: "POST",
																			url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_shiprocket_order_print_manifest_api/',
																			data: { 'orders_id': orders_id },
																			success: function (result) {
																	...
																	function assignShiprocketOrderLabel() {
																		...
																		$.ajax({
																			type: "POST",
																			url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_shiprocket_order_label_api/',
																			data: { 'orders_id': orders_id },
																			success: function (result) {
																	...
																	function assignShiprocketOrderInvoice() {
																		...
																		$.ajax({
																			type: "POST",
																			url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_shiprocket_order_invoice_api/',
																			data: { 'orders_id': orders_id },
																			success: function (result) {
														...
														<?php   } else if ($domestic_shipping_type == 3) { ?>
															<?php  
															$insurance = 2;
															$service = 2;
															$total_package_weight = $od->total_weight;
																							...
																							<div class="box-body">
																								<div class="form-group">
																									<div class="col-md-3">
																										<div class="label-wrapper"><label class="control-label" for="Name">Package Weight
																												(In GM)</label>
																											<div data-title="Total Package Weight (In Gram)."
																												class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div>
																										</div>
																									</div>
																									<div class="col-md-9">
																								...
																								<div class="form-group">
																									...
																									<div class="col-md-12">
																										<div class="input-group input-group-required">
																											<center>
																												<button type="button" class="btn btn-primary CalculateShippingBtn"
																													onclick="generateDocketNoDTDC()" id="load1"
																													data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Calculating Shipping Price">Assign
																													Docket No.</button>
																										<?php   /*?><br>
														<br>
													...
													<?php   if (empty($od->docket_no)) { ?>
														<script>
															...
															function addNewBox() {
																...
																$.ajax({
																	type: "POST",
																	url: '<?php   echo MAINSITE ?>secureRegions/orders/addNewBox/',
														...
														<form role="form" class="form-horizontal" name="ShippingForm" id="ShippingForm"
															onsubmit="generateDocketNoDHL(); return false" action="" method="post"
																		...
																		<th colspan="5">
																			<div class="form-group">
																				...
																				<div class="col-md-12">
																					<div class="input-group input-group-required">
																						<center>
																							<button type="button" onclick="addNewBox()" class="btn btn-primary addNewBoxBTN"
																								id="load3"
																								data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Adding Box">Add
																								New Box</button>
																			...
																			<div class="box-body">
																				<div class="form-group ">
																					...
																					<div class="col-md-12">
																						<div class="input-group input-group-required">
																							<center>
																								<button type="submit" class="btn btn-primary CalculateShippingBtn docket_btn"
																									id="load1"
																									data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Calculating Shipping Price">Assign
																									Docket No.</button>
																								<?php   /*?><br>
										...
										?>
										<?php   ?>
										<?php   if ($od->courier_name == "Delhivery") { ?>
											<?php   if ($od->is_courier_txn == 1) { ?>
															...
															<table class="table no-margin">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<?php   if (!empty($od->is_packing_slip_generated)) { ?>
																				<a href="<?php   echo MAINSITE . "secureRegions/orders/printPackingSlip/$od->orders_id"; ?>"
																					target="_blank"><span class="label label-success">Print Packing Slip</span></a>

																				<a style="float: right;" onclick="assignCourierPackingSlip()"
																					class="assignCourierPackingSlipBTN"><span class="label label-danger">Print Packing
																						Slip Again if Error</span></a>
																			<?php   } else { ?>
																				<button type="button" onclick="assignCourierPackingSlip()"
																					class="btn btn-primary assignCourierPackingSlipBTN">Generate Packing Slip</button>
																	...
																	<tr>
																		...
																		<td>
																			<?php   if (!empty($od->pickup_token_number)) { ?>
																				Token : <?php   echo $od->pickup_token_number ?>
																				<br>
																				Time : <?php   echo date('d-m-Y h:i:s A , l', strtotime($od->pickup_scheduled_date)); ?>
																				<br>
																				<?php   echo $od->pickup_data ?>
																			<?php   } else { ?>
																		...
																		<td>
																			...
																			<?php   } else { ?>
																				<input type="text" name="pickup_date" id="pickup_date" placeholder="Start Date"
																					readonly="readonly" class="form-control datepickerfuture"
																					value="<?php   echo date('d-m-Y', strtotime('+1 Days')) ?>" style="display:none">
																				<button type="button" onclick="assignCourierOrderPickup()"
																					class="btn btn-primary assignCourierOrderPickupBTN">Assign Pickup</button>
																	...
																	<?php   /*?>
												<?php   if($od->is_manifest_ganerated ==0){?>
												<tr>
													<td>2.</td>
													<td>Generate Manifests</td>
													<td>
													<?php   if(!empty($od->manifest_url)){ ?>
															<a href="<?php   echo $od->manifest_url?>" target="_blank">View File</a>
															<?php   }else{ ?>
													...
													<td>
														...
														<?php   }else if(!empty($od->manifest_url)){ ?>
												...
												<tr>
													...
													<td>
													<?php   if(!empty($od->label_url)){ ?>
															<a href="<?php   echo $od->label_url?>" target="_blank" class="btn btn-primary ">Print / Download Shipping Label</a>
															<?php   }else{ ?>
												...
												<tr>
													...
													<td>
													<?php   if(!empty($od->shipping_invoice_url)){ ?>
															<a href="<?php   echo $od->shipping_invoice_url?>" target="_blank" class="btn btn-primary">Print / Download Shipping Invoice</a>
															<?php   }else{ ?>
												...
												<script>
													...
													function assignCourierPackingSlip() {
														...
														$.ajax({
															type: "POST",
															url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_courier_order_packing_api/',
															data: { 'orders_id': orders_id },
															success: function (result) {
													...
													function assignCourierOrderPickup() {
														...
														$.ajax({
															type: "POST",
															url: '<?php   echo MAINSITE ?>secureRegions/orders/assign_courier_order_pickup_api/',
												...
												<td width="50%" valign="top">
													<table id="example2" class="table table-bordered table-hover">
														<tbody>
															...
															<?php   if (!empty($od->delivery_challan_no)) { ?>
																<tr>
																	<td width="20%">Delivery Challan NO.</td>
																	<td width="5%">:</td>
																	<td width="*"><strong><?php   echo $od->delivery_challan_no ?></strong></td>
																</tr>
															<?php   } ?>
															<tr>
																<td width="20%">Courier Name</td>
																<td width="5%">:</td>
																<td width="*"><strong><?php   echo $od->courier_name ?></strong></td>
															</tr>
															<tr>
																<td width="20%">Docket No.</td>
																<td width="5%">:</td>
																<td width="*"><strong><?php   echo $od->docket_no ?></strong></td>
															</tr>
															<?php   if (!empty($od->file_link)) { ?>

																<tr>
																	<td width="20%">Docket File.</td>
																	<td width="5%">:</td>
																	<td width="*"><strong><a href="<?php   echo base_url() . 'assets/docket/' . $od->file_link ?>"
																				target="_blank">View Docket File</a></strong></td>
																</tr>
															...
															<tr>
																...
																<td width="5%">:</td>
																<td width="*">
																	<strong><?php   echo date('d-m-Y h:i:s A', strtotime($od->added_on)) ?></strong></td>
															</tr>
															<?php   if (!empty($od->updated_on)) { ?>
																<tr>
																	...
																	<td width="5%">:</td>
																	<td width="*">
																		<strong><?php   echo date('d-m-Y h:i:s A', strtotime($od->updated_on)) ?></strong></td>
																</tr>
															<?php   } ?>
															<tr>
															...
															<tr>
																...
																<td width="5%">:</td>
																<td width="*">
																	<p>Total : <strong><?php   echo $od->symbol ?> <?php   echo $od->total ?></strong></p>
																	<p>Mode : <strong><?php   echo $od->mode ?></strong></p>
																	<?php   if (!empty($od->mihpayid)) { ?>
																		<p>Bank Id : <strong><?php   echo $od->mihpayid ?></strong></p><?php   } ?>
																	<?php   if (!empty($od->txnid)) { ?>
																		<p>TXN Id : <strong><?php   echo $od->txnid ?></strong></p><?php   } ?>
																</td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td width="*">
																	...
																	<p><?php   echo $od->d_city_name ?>, <?php   echo $od->d_zipcode ?></p>
																	<p><?php   echo $od->d_state_name ?></p>
															...
															<?php   /*?><tr>
																																			...
																																			<td width="5%">:</td>
																																			<td width="*">
																																				<p><strong><?php   echo $od->store_name?></strong></p>
																																					<p><?php   echo $od->store_contact_number?></p>
																																					<p><?php   echo $od->person_contact_name?></p>
																																					<p><?php   echo $od->person_contact_email?></p>
																																					<p><?php   echo $od->person_contact_number?></p>
																																					<p><?php   echo $od->person_contact_alt_number?></p>
																																			</td>
																																	</tr><?php   */ ?>
															<tr>
																...
																<td width="5%">:</td>
																<td width="*">
																	<p>#Items : <strong><?php   echo $od->total_prod ?></strong></p>
																</td>
															</tr>
														</tbody>
													</table>
														...
														<tbody>
															...
															foreach ($od->details as $odd) {
																...
																<tr>
																	...
																	<td>
																		<?php   /*?><?php   echo $odd->product_name?><br><?php   */ ?>	<?php   echo $odd->product_display_name ?><br><?php   echo $odd->combi ?>
																	</td>
																	<td><?php   echo $odd->brand_name ?></td>
															...
															<?php   if (!empty($od->coupon_code)) {
																...
																?>
																<tr>
																	<td colspan="<?php   echo $colspan ?>" style="text-align:right">Coupon
																		(<?php   echo $od->coupon_code ?>)</td>
																	<td> <?php   echo $od->discount ?> %</td>
																</tr>
															<?php   } ?>
															<tr>
																<td colspan="<?php   echo $colspan ?>" style="text-align:right">GST Charges</td>
																<td><?php   echo $od->symbol ?> <?php   echo $od->total_gst ?></td>
															</tr>
															<tr>
																<td colspan="<?php   echo $colspan ?>" style="text-align:right">Delivery Charges</td>
																<td><?php   echo $od->symbol ?> <?php   echo $od->delivery_charges ?></td>
															</tr>
															<tr>
																<td colspan="<?php   echo $colspan ?>" style="text-align:right">COD Charges</td>
																<td><?php   echo $od->symbol ?> <?php   echo $od->cod_charges ?></td>
															</tr>
															<tr>
							...
							<div role="tabpanel" class="tab-pane fade " id="od_history">
								<div class="box box-primary">
									...
									<div class="box-body">
											...
											<ul class="timeline">
												...
												foreach ($od->order_history as $fud) {
													...
													if ($f_date != $temp_date) {
														...
														<li class="time-label">
															<span class="bg-red"><?php   echo date('d M. Y', strtotime($f_date)) ?></span>
														</li>
													<?php  
													}
													?>
													...
													<li>
														<?php   echo $fud->order_status_display ?>
														<div class="timeline-item" style="margin-left: 160px;top: -25px">
															<span class="time"><i class="fas fa-clock"></i>
																<?php   echo date('d-m-Y h:i:s A', strtotime($fud->updated_on)) ?></span>
															<h3 class="timeline-header"><?php   echo $fud->caption ?>
																<?php   /*?>By : <a href="javascript:void(0)" ><?php   echo $fud->updated_by_name?></a> <?php   */ ?>
															</h3>
										...
										<?php   } else { ?>
											<div class="alert alert-warning alert-dismissible"><i class="icon fas fa-ban"></i> No Data To
												Display</div>
										<?php   } ?>
									</div>
								</div>
							...
							<div role="tabpanel" class="tab-pane fade " id="od_bluedart_tracking">
								<div class="box box-primary">
									<div class="box-header with-border">
										<h3 class="box-title">Order Tracking History</h3>
									</div><!-- /.box-header -->
									<?php   /*?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this product before adding images.</span><?php   */ ?>
									<div class="box-body">
										<?php  
										...
										?>
										<?php   if (!empty($docket_status_html)) { ?>

											<?php   echo $docket_status_html; ?>
		...
		<div class="modal-content newModalCss">
			...
			<div class="modal-body">
				<form class="" action="<?php   echo MAINSITE . 'secureRegions/orders/Orders_Module/update' ?>" method="post"
					enctype="multipart/form-data">
					<input type="hidden" name="orders_id" id="orders_id" value="<?php   echo $od->orders_id ?>" />
					<input type="hidden" name="order_number" id="order_number" value="<?php   echo $od->order_number ?>" />
					<div class="clearfix">
						<div class="clearfix form-group">
							...
							<div class="col-md-9">
								<select class="form-control" required name="order_status" id="order_status"
									...
									<option value="1" <?php   if ($od->order_status == 1) {
										echo "selected";
									} ?>>Order placed</option>
									<option value="2" <?php   if ($od->order_status == 2) {
										echo "selected";
									} ?>>In Process</option>
									<option value="3" <?php   if ($od->order_status == 3) {
										echo "selected";
									} ?>>Dispatched</option>
									<option value="4" <?php   if ($od->order_status == 4) {
										echo "selected";
									} ?>>Delivered</option>
									<option value="5" <?php   if ($od->order_status == 5) {
										echo "selected";
									} ?>>Not Delivered</option>
									<option value="6" <?php   if ($od->order_status == 6) {
										echo "selected";
									} ?>>Cancelled</option>
								</select>
							</div>
...
<script>
	...
	function getPincodeDetailDTDC() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/Orders_Module/getPincodeDetailDTDC/',
			data: { 'orders_id': orders_id },
			success: function (result) {
	...
	function getPincodeDetailDelhivery() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/getPincodeDetail/',
			data: { 'orders_id': orders_id },
			success: function (result) {
				$('#PincodeData').html(result);
			}
	...
	function getPincodeDetail() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/getPincodeDetailBluedart/',
			data: { 'orders_id': orders_id },
			success: function (result) {
				$('#PincodeData').html(result);
			}
	...
	function generateDocketNoDHL() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/generateDocketNoDHL/',
			data: $('#ShippingForm').serialize(),
			success: function (result) {
				$this.button('reset');
	...
	function generateDocketNo() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/generateDocketNo/',
	...
	function generateBluedartDocketNo() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/generateBluedartDocketNo/',
	...
	function generateDocketNoDelhivery() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/generateDocketNoDelhivery/',
	...
	function generateDocketNoDTDC() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo MAINSITE ?>secureRegions/orders/Orders_Module/generateDocketNoDTDC/',
			data: { 'orders_id': orders_id, 'total_package_weight': total_package_weight, 'box_l': box_l, 'box_b': box_b, 'box_h': box_h },
			success: function (result) {
				//$this.button('reset');
				$('#ShippingPriceData').html(result);
...
<div id="myModal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Order Tracking (<?php   echo $od->order_number ?>)</h4>
			</div>
...
<script>
	function getTrackingData() {
		...
		$.ajax({
			type: "POST",
			url: '<?php   echo base_url() ?>Ajax/getTracking',
			//dataType : "json",
			data: { 'tracking_number': '<?php   echo $od->docket_no ?>' },
			success: function (result) {
