										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
													...
													<option value='urm.order_number' <?php   if ($field_name == 'urm.order_number') {
														echo 'selected';
													} ?>>
														Order Number</option>
													<option value='urm.name' <?php   if ($field_name == 'urm.name') {
														echo 'selected';
													} ?>>Customer Name
													</option>
													<option value='urm.number' <?php   if ($field_name == 'urm.number') {
														echo 'selected';
													} ?>>Customer
														Number</option>
												</select>
									...
									<tbody>
										...
										foreach ($orders_list as $urm) {
											...
											<tr>
												...
												<?php   } ?>
												<td><a
														href="<?php   echo MAINSITE_Admin . $user_access->class_name . "/details/" . $urm->orders_id ?>"><?php   echo $urm->order_number ?></a>
												</td>
												<td><?php   echo $urm->name ?></td>
												<td><?php   echo $urm->number ?></td>
												<td><?php   echo $urm->symbol ?> 			<?php   echo $urm->total ?></td>
												<td><?php   echo $urm->total_prod ?></td>
												<td><?php   echo date("d-m-Y", strtotime($urm->added_on)) ?></td>
												<td><a class="btn btn-default"
														href="<?php   echo MAINSITE . "secureRegions/orders/Orders-Module/details/" . $urm->orders_id; ?>"><i
