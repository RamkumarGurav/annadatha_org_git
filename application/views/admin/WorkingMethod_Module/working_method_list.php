            ...
            <div class="col-12">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" style="">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="field_name" id="field_name" class="form-control" style="width: 100%;">
                                    ...
                                    <option value='urm.working_method_id' <? if ($field_name == 'urm.working_method_id') {
                                        echo 'selected';
                                    } ?>>working_method Name</option>
                                </select>
                ...
                <div class="card">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            <form
                                action="<?php echo MAINSITE_Admin . "$user_access->class_name/userworking_method-doUpdateStatus"; ?>"
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <? if (!empty($working_method_data)) { ?>
                                        <tbody>
                                            ...
                                            foreach ($working_method_data as $urm) {
                                                $count++;
                                                ?>
                                                <tr>
                                                    ...
                                                    <?php if ($user_access->update_module == 1) { ?>
                                                        <td><input type="checkbox" name="sel_recds[]"
                                                                ...
                                                                value="<?php echo $urm->working_method_id; ?>" /></td>
                                                    <? } ?>
                                                    <td><a
                                                            href="<?php echo MAINSITE_Admin . $user_access->class_name . "/working_method-view/" . $urm->working_method_id ?>"><?php echo $urm->working_method_id ?></a>
                                                    </td>
