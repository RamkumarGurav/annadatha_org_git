            ...
            <div class="col-12">
                <div id="accordion">
                    ...
                    <div class="card card-primary">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" style="">
                            <div class="card-body">
                                <form role="form" class="form-horizontal" name="search_report_form"
                                    id="search_report_form"
                                    action="<?php echo MAINSITE_Admin . $user_access->class_name . '/' . $user_access->function_name; ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="field_name" id="field_name" class="form-control"
                                                        ...
                                                        <option value='urm.testimonial_name' <? if ($field_name == 'urm.testimonial_name') {
                                                            echo 'selected';
                                                        } ?>>testimonial Name</option>
                                                    </select>
                ...
                <div class="card">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            <form
                                action="<?php echo MAINSITE_Admin . "$user_access->class_name/usertestimonial-doUpdateStatus"; ?>"
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    <? if (!empty($testimonial_data)) { ?>
                                        <tbody>
                                            ...
                                            foreach ($testimonial_data as $urm) {
                                                $count++;
                                                ?>
                                                <tr>
                                                    ...
                                                    <?php if ($user_access->update_module == 1) { ?>
                                                        <td><input type="checkbox" name="sel_recds[]"
                                                                ...
                                                                value="<?php echo $urm->testimonial_id; ?>" /></td>
                                                    <? } ?>
                                                    <td><a
                                                            href="<?php echo MAINSITE_Admin . $user_access->class_name . "/testimonial-view/" . $urm->testimonial_id ?>"><?php echo $urm->testimonial_name ?></a>
                                                    </td>
