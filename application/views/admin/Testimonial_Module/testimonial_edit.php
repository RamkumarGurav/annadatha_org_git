			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<? if (!empty($testimonial_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<?php echo MAINSITE_Admin . $user_access->class_name . "/role_manager_view/" . $testimonial_id ?>">View</a>
							</li>
						<? } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><?php echo $testimonial_name ?> <small><?php echo $record_action ?></small></h3>
					</div>
					<!-- /.card-header -->
					<?php
					if ($user_access->view_module == 1 || true) {
						...
						<div class="card-body">
							<form action="<?php echo MAINSITE_Admin . "$user_access->class_name/usertestimonialDoEdit"; ?>"
								...
								<input type="hidden" name="testimonial_id" id="testimonial_id" value="<?php echo $testimonial_id ?>" />
								...
								<div class="row">
									<div class="col-sm-10 row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control form-control-sm" required id="testimonial_name"
												name="testimonial_name" value="<?php echo $testimonial_name ?>" placeholder="testimonial">
									...
									<div class="col-sm-10 row">
										...
										<div class="col-sm-9">
											<div class="custom-file">
												<textarea name="testimonial_video" required rows="8"
													cols="80"><?php echo $testimonial_video ?></textarea>
												<span style="color:#f00;font-size: 22px;margin-top: 3px;">*Width and height should be
													320*315</span>
											</div>
