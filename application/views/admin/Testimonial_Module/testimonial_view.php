            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $testimonial_data->testimonial_name ?></h3>
                        <div class="float-right">
                            <?php
                            if ($user_access->add_module == 1) {
                                ?>
                                <a href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/testimonial-edit">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/testimonial-edit/<?php echo $testimonial_data->testimonial_id ?>">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <?php echo $testimonial_data->testimonial_id ?>
                                            </td>
                                            <td>
                                                <strong class="full">testimonial Name</strong>
                                                <?php echo $testimonial_data->testimonial_name ?>
                                            </td>
                                            <td>
                                                <strong class="full">testimonial Video</strong>
                                                <?php echo $testimonial_data->testimonial_video ?>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                ...
                                                <?php echo $testimonial_data->content ?>
                                            </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <?php echo date("d-m-Y h:i:s A", strtotime($testimonial_data->added_on)) ?>
                                            </td>
                                            <td>
                                                <strong class="full">Added By</strong>
                                                <?php echo $testimonial_data->added_by_name ?>
                                            </td>
                                            <td>
                                                <strong class="full">Updated On</strong>
                                                <? if (!empty($testimonial_data->updated_on)) {
                                                    echo date("d-m-Y h:i:s A", strtotime($testimonial_data->updated_on));
                                                } else {
                                                    echo "-";
                                                } ?>
                                            </td>
                                            <td>
                                                ...
                                                <? if (!empty($testimonial_data->updated_by_name)) {
                                                    echo $testimonial_data->updated_by_name;
                                                } else {
                                                    echo "-";
                                                } ?>
                                            </td>
                                            <td>
                                                ...
                                                <? if ($testimonial_data->status == 1) { ?> Active <i
