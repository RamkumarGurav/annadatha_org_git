...
$filename = "News-List-" . date('d-m-Y') . ".xls";
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
        <thead>
            ...
            <tr>
                ...
                <th style="background-color:#999" width="*">News Name</th>
                <th style="background-color:#999" width="*">News link</th>
                <th style="background-color:#999" width="*">News Image link</th>
                <th style="background-color:#999" width="*">News Content</th>
        ...
        <tbody>
            ...
            if (!empty($news_data)) { //print_r($ptype_list);
                foreach ($news_data as $row) {
                    //if($row->in_hand > 0 || $row->total_purchase > 0 || $row->total_sold > 0 || $row->total_returned > 0 || $row->to_receive > 0 )
                    {
                        ...
                        <tr>
                            ...
                            <td width="*"><? echo $row->news_name; ?></td>
                            <td width="*"><? echo $row->news_link; ?></td>
                            <td width="*"><? echo base_url() . 'assets/news/' . $row->news_image; ?></td>
                            <td width="*"><? echo $row->content; ?></td>
