...
<script>
    $(document).ready(function () {
        $.ajax({
            ...
            //dataType : "json", 
            data: { "product_attribute_id": <?  echo $product_attribute_id; ?>, "<? php echo $csrf['name'] ?>": "<? php echo $csrf['hash'] ?>" },
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/attribute-edit/<? php echo $product_attribute_value_detail->product_attribute_value_id ?>">
                    ...
                    if ($user_access->view_module == 1) {
                            ...
                            <div class="divTable">
                                ...
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if (!empty($product_attribute_value_detail->updated_on)) {
                                            echo date("d-m-Y h:i:s A", strtotime($product_attribute_value_detail->updated_on));
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <?  if (!empty($product_attribute_value_detail->updated_by_name)) {
                                            echo $product_attribute_value_detail->updated_by_name;
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <?  if ($product_attribute_value_detail->status == 1) { ?> Active <i
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong class="full">is Display</strong>
                                            <?  if ($product_attribute_value_detail->is_display == 1) { ?> Yes <i
                                                    class="fas fa-check btn-success btn-sm "></i>
                        ...
                        <link rel="stylesheet" href="<?  echo MAINSITE ?>assets/administrator/css/tablednd.css"
                            type="text/css" />
                        <div class="tableDemo">
                                    ...
                                    <tr>
                                        <td colspan="10">
                                            <div class="clearfix text-center">
                                                <img
                                                    src="<?  echo MAINSITE . "assets/administrator/dist/images/load.gif"; ?>" />
                                            </div>
                                        </td>
                                    </tr>
        ...
        $("#table-2").tableDnD({
            ...
            onDrop: function (table, row) {
                ...
                $.ajax({
                    ...
                    data: { "product_attribute_id": '<?  echo $product_attribute_id; ?>', 'podId': podId, "<? php echo $csrf['name'] ?>": "<? php echo $csrf['hash'] ?>" },
                    success: function (result) {
                        // alert(result);
                        $('#stateList').html(result);
