                            ...
                            <div class="divTable">
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        <label class="label_content_br">Display On List Page <span
                                                class="colen">:</span></label>
                                        <?  if ($product_attribute_detail->list_page == 1) { ?> Yes <i
                                    ...
                                    <div class="table_col">
                                        <label class="label_content_br">Display In Details Page <span
                                                class="colen">:</span></label>
                                        <?  if ($product_attribute_detail->details_page == 1) { ?> Yes <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                        <?  } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                        <?  } ?>
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if ($product_attribute_detail->search == 1) { ?> Yes <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                        <?  } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                        <?  } ?>
                                ...
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if (!empty($product_attribute_detail->updated_on)) {
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if (!empty($product_attribute_detail->updated_by_name)) {
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?  if ($product_attribute_detail->status == 1) { ?> Active <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong class="full">is Display</strong>
                                            <?  if ($product_attribute_detail->is_display == 1) { ?> Yes <i
                                                    class="fas fa-check btn-success btn-sm "></i>
                                            <?  } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                            <?  } ?></td>
