            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $product_attribute_detail->name ?></h3>
                        <div class="float-right">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/edit/<?php echo $product_attribute_detail->product_attribute_id ?>">
                    ...
                    if ($user_access->view_module == 1) {
                            ...
                            <div class="divTable">
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        <?php echo $product_attribute_detail->product_attribute_id ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Product Attribute Name <span
                                                class="colen">:</span></label>
                                        <?php echo $product_attribute_detail->name ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">No. Of Attributes Per Product<span
                                                class="colen">:</span></label>
                                        <?php echo $product_attribute_detail->condition_per_product ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Attribute Display Type<span
                                                class="colen">:</span></label>
                                        <?php echo $product_attribute_detail->attribute_name ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Display On List Page <span
                                                class="colen">:</span></label>
                                        <?php if ($product_attribute_detail->list_page == 1) { ?> Yes <i
                                    ...
                                    <div class="table_col">
                                        <label class="label_content_br">Display In Details Page <span
                                                class="colen">:</span></label>
                                        <?php if ($product_attribute_detail->details_page == 1) { ?> Yes <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                        <?php } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                        <?php } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <?php if ($product_attribute_detail->search == 1) { ?> Yes <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                        <?php } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        <?php echo date("d-m-Y h:i:s A", strtotime($product_attribute_detail->added_on)) ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Added By <span class="colen">:</span></label>
                                        <?php echo $product_attribute_detail->added_by_name ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Updated On <span class="colen">:</span></label>
                                        <?php if (!empty($product_attribute_detail->updated_on)) {
                                            echo date("d-m-Y h:i:s A", strtotime($product_attribute_detail->updated_on));
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <?php if (!empty($product_attribute_detail->updated_by_name)) {
                                            echo $product_attribute_detail->updated_by_name;
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <?php if ($product_attribute_detail->status == 1) { ?> Active <i
                                                class="fas fa-check btn-success btn-sm "></i>
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong class="full">Data Base Id</strong>
                                            <?php echo $product_attribute_detail->city_id ?></td>
                                        <td><strong class="full">Country</strong>
                                            <?php echo $product_attribute_detail->country_name ?></td>
                                        <td><strong class="full">State</strong>
                                            <?php echo $product_attribute_detail->state_name ?></td>
                                        <td><strong class="full">City</strong>
                                            <?php echo $product_attribute_detail->city_name ?></td>
                                        <td><strong class="full">City Code</strong>
                                            <?php echo $product_attribute_detail->city_code ?></td>
                                        <td><strong class="full">is Display</strong>
                                            <?php if ($product_attribute_detail->is_display == 1) { ?> Yes <i
                                                    class="fas fa-check btn-success btn-sm "></i>
                                            <?php } else { ?> No <i class="fas fa-ban btn-danger btn-sm "></i>
                                            <?php } ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><strong class="full">Added By</strong>
                                            <?php echo $product_attribute_detail->added_by_name ?></td>
                        ...
                        <link rel="stylesheet" href="<?php echo MAINSITE ?>assets/administrator/css/tablednd.css"
                            type="text/css" />
                        <div class="tableDemo">
                                    ...
                                    <tr>
                                        <td colspan="10">
                                            <div class="clearfix text-center">
                                                <img
                                                    src="<?php echo MAINSITE . "assets/administrator/dist/images/load.gif"; ?>" />
                                            </div>
                                        </td>
                                    </tr>
