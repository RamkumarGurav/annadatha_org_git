            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/view/".$product_attribute_id?>">View</a></li>
						<?php  } ?>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
							...
							<input type="hidden" name="product_attribute_id" id="product_attribute_id" value="<?php  echo $product_attribute_id?>" />
							<input type="hidden" name="redirect_type" id="redirect_type" value="" />
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm" required id="name" name="name" value="<?php  echo $name?>" placeholder="Product Attribute Name">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control form-control-sm" required id="condition_per_product" name="condition_per_product" value="<?php  echo $condition_per_product?>" placeholder="No. Of Attributes Per Product">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group input-group-required">
                                                ...
                                                <option value="<?php  echo $col->attributes_input_id; ?>" <?php  if($attributes_input_id== $col->attributes_input_id){echo "selected";} ?>><?php  echo $col->name; ?></option>
                                                <?php  } ?>
                                                </select>
