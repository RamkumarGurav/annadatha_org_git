...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-2 text-dark"><? php echo $page_module_name ?> <small>List</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                if (!empty($product_attribute_data)) { ?>
                                    <tbody>
                                        ...
                                        foreach ($product_attribute_data as $urm) {
                                            $count++;
                                            ...
                                            <tr>
                                                ...
                                                <? php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<? php echo $count; ?>"
                                                            value="<? php echo $urm->product_attribute_id; ?>" /></td>
                                                <?  } ?>
                                                <td><a
                                                        href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->product_attribute_id ?>"><? php echo $urm->name ?></a>
                                                </td>
                                                <td><? php echo $urm->attribute_name ?></td>
                                                <td><? php echo $urm->condition_per_product ?></td>
                                                <td><? php echo $urm->product_attribute_value_count ?></td>
                                                ...
                                                <? php } else { ?>
                                                    <td align='center'><i class='fa fa-close false-icon'></i><span
                                                            style='display:none'>Un Publish</span></td>
                                                <? php } ?>
                                            </tr>
                                        <?  } ?>
                                    </tbody>
