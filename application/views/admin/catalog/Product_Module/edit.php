            ...
            <div class="col-sm-6">
               ...
               <ol class="breadcrumb float-sm-right">
                  ...
                  <?php  if (!empty($product_detail)) { ?>
                     ...
                     <li class="breadcrumb-item"><a
                           href="<?php  echo  MAINSITE_Admin . $user_access->class_name . "/view/" . $product_id ?>">View</a></li>
         ...
         <div class="col-md-12">
            ...
            <div class="row align-items-center bg-white tabb">
               ...
               <ul class="nav nav-tabs admin-tab1   col-md-9" role="tablist">
                  ...
                  <li role="presentation" class="<?php  if ($active_tab == "INFORMATION") {
                     echo "active";
                  } ?>"><a href="#INFORMATION" class="<?php  if ($active_tab == "INFORMATION") {
                      echo "active";
                   } ?>" aria-controls="home" role="tab" data-toggle="tab">INFORMATION</a></li>

                  <li role="presentation" class=" <?php  if ($active_tab == "COMBINATIONS") {
                     echo " active ";
                  } ?>"><a href="#COMBINATIONS" class="<?php  if ($active_tab == "COMBINATIONS") {
                      echo "active";
                   } ?>" aria-controls="profile" role="tab" data-toggle="tab">COMBINATIONS</a></li>

                  <li role="presentation" class=" <?php  if ($active_tab == "COMBINATIONS_POS") {
                     echo " active ";
                  } ?>"><a href="#COMBINATIONS_POS" class="<?php  if ($active_tab == "COMBINATIONS_POS") {
                      echo "active";
                   } ?>" aria-controls="profile" role="tab" data-toggle="tab"> POSITION</a></li>

                  <li role="presentation" class=" <?php  if ($active_tab == "images") {
                     echo " active ";
                  } ?>"><a href="#images" class="<?php  if ($active_tab == "images") {
                      echo "active";
...
<?php  */ ?>
                  ...
                  <?php  if (!empty($user_access_seo)) {
                     if ($user_access_seo->update_module == 1) { ?>
                        <li role="presentation" class=" <?php  if ($active_tab == "settings") {
                           echo " active ";
                        } ?>"><a href="#settings" class="<?php  if ($active_tab == "settings") {
                            echo "active";
                  ...
                  <li role="presentation" class=" <?php  if ($active_tab == "add_review") {
                     echo " active ";
                  } ?>"><a href="#add_review" class="<?php  if ($active_tab == "add_review") {
                      echo "active";
         ...
         <div class="col-md-12">
            ...
            <?php  if ($alert == "success" || $alert == "update" || $alert == "fail" || $alert == "imageUpdate" || $alert == "wrongimageformat" || $alert == "imageDelete" || $alert == "combiSuccess") { ?><span
                  style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  if ($alert == "success") {
                     echo "Record Inserted Successfully.";
                  } else if ($alert == "update") {
                     echo "Record Updated Successfully.";
                  } else if ($alert == "fail") {
                     echo "Error in updating this input.";
                  } else if ($alert == "imageUpdate") {
                     echo "Image Inserted Seccessfully.";
                  } else if ($alert == "wrongimageformat") {
                     echo "Wrong Image format. Only .jpg , .jpeg or .png image is allowed.";
                  } else if ($alert == "imageDelete") {
            ...
            <div class="tab-content  admin-tab-cont1">
               ...
               <div role="tabpanel" class="tab-pane show fade <?php  if ($active_tab == "INFORMATION") {
                  echo "in active show ";
               } ?>" id="INFORMATION">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                           ...
                           <div class="form-group  col-md-8">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <label class="control-label" for="Name">
                                       Product Name
                                       <div data-title="The name of the Product." class="ico-help icon_title_box">
                                 ...
                                 <?php  if ($product_id <= 0) { ?>
                                    <div class="col-md-6">
                                       <label class="control-label col-sm-3" for="Name">
                                          Image
                                          <div data-title="Product Images." class="ico-help icon_title_box"><i
                              ...
                              <div class="col-md-12">
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                       <label class="control-label" for="Name">
                                          Brands/Manufacturer <?php  echo $brand_id; ?>
                                    ...
                                    <div class="col-md-4">
                                       <label class="control-label" for="Name">
                                          Reference Code
                                          <div data-title="Reference Code." class="ico-help icon_title_box"><i
                                                class="fa fa-question-circle"></i></div>
                                          <span class="required">*</span>
                                       </label>
                                       <input type="text" name="ref_code" id="ref_code" placeholder="Reference Code"
                                          class="form-control" value="<?php  echo $ref_code; ?>" required>
                                       <span class="field-validation-valid" data-valmsg-for="Name"
                                          data-valmsg-replace="true"></span>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                       <label class="control-label" for="Name">
                                          HSN Code
                                          <div data-title="HSN Code." class="ico-help icon_title_box"><i
                                                class="fa fa-question-circle"></i></div>
                                          <span class="required">*</span>
                                       </label>
                                       <input type="text" name="hsn_code" id="hsn_code" placeholder="HSN Code"
                                          class="form-control" value="<?php  echo $hsn_code; ?>" required><span
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                       <label class="control-label" for="Name">
                                          Tax Category
                                          <div data-title="Select The Tax Category." class="ico-help icon_title_box"><i
                                                class="fa fa-question-circle"></i></div>
                                          <span class="required">*</span>
                                       </label>

                                       <select name="tax_categories_id" id="tax_categories_id" class="form-control"
                                          required onchange="getTaxProvider(this)">
                                          <option value="">Please Select</option>
                                          <?php 
                                          foreach ($tax_list as $row) { ?>
                                             <option <?php  if ($tax_id == $row->tax_id) {
                                                echo "selected";
                                             } ?>
                                                value="<?php  echo $row->tax_id; ?>"><?php  echo $row->tax_name; ?></option>
                                          <?php  } ?>
                                       </select>
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <div class="label-wrapper">
                                          ...
                                          <div data-title="Is product available for bulk enquiry?"
                                             class="ico-help icon_title_box"> &nbsp;<i
                                                class="fa fa-question-circle"></i> </div>
                                          <span class="required">*</span>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <label class="control-label" for="Name">
                                    ...
                                    <div data-title="Short Description Of Product." class="ico-help icon_title_box"><i
                                          class="fa fa-question-circle"></i></div>
                                 ...
                                 <textarea class="search_textbox form-control" rows="8" name="short_description"
                                    id="short_description"><?php  echo $short_description; ?></textarea>
                                                ...
                                                if ($row1->super_category_id == 0) { ?>
                                                   ...
                                                   <ul>
                                                      ...
                                                      foreach ($category_list as $row2) {
                                                         if (in_array($row2->category_id, $category_id_arr))
                                                      ...
                                                      <li class="<?php  echo $liClass . " " . $liClassExpend; ?> "
                                                         title="Parent Category">

                                                         <i class="fa fa-angle-right"></i>

                                                         <?php  /*?> <a href="0" target="super_category_id,<?php  echo $row1['category_id']; ?>,false" ><?php  echo $row1['name']; ?></a>

                                                                                 <a href="0" target="category_id[],<?php  echo $row1['category_id']; ?>,false" ><?php  echo $row1['name']; ?></a><?php  */ ?>

                                                         <a href="0" target="category_id[],<?php  echo $row1->category_id; ?>,<?php  if (in_array($row1->category_id, $category_id_arr)) {
                                                               echo 'true';
                                                            } else {
                                                               echo "false";
                                                            } ?>"><?php  echo $row1->name; ?></a>

                                                         <?php  foreach ($category_list as $row3) {
                                                            ...
                                                            if ($row3->super_category_id == $row1->category_id) {
                                                               ...
                                                               <ul>
                                                                  ...
                                                                  foreach ($category_list as $row4) {
                                                                     if ($row4->super_category_id == $row3->category_id)
                                                                        $liFolderCount++;
                                                                  }
                                                                  if ($liFolderCount > 0) {
                                                                     $liClass = 'isFolder';
                                                                     if (in_array($row3->category_id, $category_id_arr))
                                                                        $liClassExpend = 'isExpanded';
                                                                  } ?>
                                                                  ...
                                                                  <li class="<?php  echo $liClass . " " . $liClassExpend; ?>  "
                                                                     ...
                                                                     <a href="0" target="category_id[],<?php  echo $row3->category_id; ?>,<?php  if (in_array($row3->category_id, $category_id_arr)) {
                                                                           echo 'true';
                                                                        } else {
                                                                           echo "false";
                                                                     ...
                                                                     <ul>
                                                                        ...
                                                                        <?php  foreach ($category_list as $row5) {

                                                                           if ($row5->super_category_id == $row3->category_id) { ?>

                                                                              <li class="" title="Super Sub Category"><a href="0"
                                                                                    target="category_id[],<?php  echo $row5->category_id; ?>,<?php  if (in_array($row5->category_id, $category_id_arr)) {
                                                                                          echo 'true';
                                                                                       } else {
                                                                                          echo "false";
                                                                                       } ?>"><?php  echo $row5->name; ?></a>
                                                                              </li>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-12">
                              ...
                              <label class="control-label" for="Name">
                                 ...
                                 <div data-title="Complete Product Description." class="ico-help icon_title_box"><i
                                       class="fa fa-question-circle"></i></div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-12">
                              ...
                              <label class="control-label" for="Name">
                                 ...
                                 <div data-title="Complete Product Application." class="ico-help icon_title_box"><i
                                       class="fa fa-question-circle"></i></div>
                              ...
                              <textarea class="search_textbox ckeditor" name="application" id="application"
                                 style="width: 576px; height: 200px;"><?php  echo $application; ?></textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-2">
                                 ...
                                 <div class="label-wrapper">
                                    ...
                                    <div data-title="Determines whether this Product is published."
                                       class="ico-help icon_title_box"> &nbsp;<i class="fa fa-question-circle"></i></div>
                              ...
                              <div class="col-md-2">
                                 ...
                                 <div class="label-wrapper">
                                    ...
                                    <div data-title="Added By." class="ico-help icon_title_box"><i
                                          class="fa fa-question-circle"></i></div>
                              ...
                              <div class="col-md-2">
                                 ...
                                 <div class="label-wrapper">
                                    ...
                                    <div data-title="Updated By." class="ico-help icon_title_box"><i
                                          class="fa fa-question-circle"></i></div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-2">
                                 ...
                                 <div class="label-wrapper">
                                    ...
                                    <div data-title="Added On." class="ico-help icon_title_box"><i
                                          class="fa fa-question-circle"></i></div>
                              ...
                              <div class="col-md-2">
                                 ...
                                 <div class="label-wrapper">
                                    ...
                                    <div data-title="Updated On." class="ico-help icon_title_box"><i
                                          class="fa fa-question-circle"></i></div>
                        ...
                        <div class="col-md-12 text-center">
                           ...
                           <button type="submit" onclick="return productValidation('save')" class="btn btn-primary"><i
                                 class="fa fa-floppy-o"></i>Save</button>

                           <button type="submit" onclick="return productValidation('save-edit')"
                              class="btn btn-default"><i class="fa fa-floppy-o"></i>Save and Continue Edit</button>
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if ($active_tab == "COMBINATIONS") {
                  echo " in active show ";
               } ?>" id="COMBINATIONS">
                           ...
                           <div class="card">
                              <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                 ...
                                 <div class="card-body">
                                    ...
                                    <?php  echo form_open(
                                       MAINSITE_Admin . 'catalog/Product-Module/doAddProductCombination',
                                       array('method' => 'post', 'name' => 'ProductAttributeForm', 'id' => 'ProductAttributeForm', 'style' => '', 'class' => 'form-horizontal', "enctype" => "multipart/form-data")
                                    ); ?>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Product Display Name." class="ico-help icon_title_box"><i
                                          ...
                                          <input type="text" name="product_display_name" id="product_display_name"
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Combinations Reference Code."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                             <span class="required" style="margin-left:0">*</span>
                                          </label>

                                          <input type="text" name="ref_code" id="combref_code"
                                             placeholder="Reference Code" class="form-control" value="" required>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Unit of Measurement for this Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <select name="uom_id" id="uom_id" class="form-control" required>
                                             ...
                                             <?php  foreach ($uom_list as $col) { ?>

                                                <option value="<?php  echo $col->unit_of_measurement_id; ?>">
                                                   <?php  echo $col->unit_of_measurement_name; ?>
                                                </option>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="The Name Of The Product Attribute."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>

                                          </label>

                                          <select type="text" name="select_product_attribute_id"
                                             id="select_product_attribute_id" class="form-control"
                                             onchange="getAttributeVal(this.value)">

                                             <option value="">Select Attribute</option>

                                             <?php  foreach ($product_attribute_list as $col) { ?>

                                                <option value="<?php  echo $col->product_attribute_id; ?>">
                                                   <?php  echo $col->name; ?>
                                                </option>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="The Value Of The Selected Attribute."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <div class="input-group input-group-required" id="showAttributeValue">
                                             ...
                                             <?php  //echo "<pre>"; print_r($attribute_value_list);echo "</pre>"; ?>
                                             ...
                                             <select name="select_product_attribute_value_id"
                                                ...
                                                <?php  foreach ($attribute_value_list as $col) { ?>

                                                   <option value="<?php  echo $col->product_attribute_value_id; ?>">
                                                      <?php  echo $col->name; ?>
                                                   </option>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="The Value Of The Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>

                                          </label>

                                          <input type="text" name="combination_values" id="combination_values"
                                             class="form-control" />
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Create Combination." class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                    ...
                                    <div class="row mt-2">
                                       ...
                                       <div class="col-md-12">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Created Combinations." class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-3" id="do_not_update">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Quantity Of This Combination"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <input type="text" name="quantity" id="quantity" pattern="[0-9]{1,10}"
                                             title="Enter Only Number" placeholder="Combination Quantity"
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Price Of This Combination. Price Excluding GST"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <input type="text" name="price" id="price" pattern="[0-9]{1,10}"
                                             title="Enter Only Number" placeholder="Combination Price"
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div
                                                data-title="Enter Discounted Price to calculate discount Percentage. Discounted Price Excluding GST"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <input type="number" name="discounted_price" id="discounted_price"
                                             onchange="discountByPrice()" onkeyup="discountByPrice()"
                                             onclick="discountByPrice()" step="any" title="Enter Only Number"
                                             placeholder="Discounted Price" class="form-control" value="">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Discount Of This Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>

                                          </label>

                                          <input type="text" name="discount" id="discount" pattern="[0-9]{1,10}"
                                             title="Enter Only Number" placeholder="Combination Discount"
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Discount Variable for This Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             Final Price
                                             <div data-title="Final Price Of This Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <div class="input-group">
                                             ...
                                             <input type="text" readonly="readonly" name="final_price" id="final_price"
                                                placeholder="Combination Final Price" class="form-control" value=""
                                                required>

                                             <div class="input-group-btn">

                                                <button type="button" class="btn btn-default btn-xs"
                                                   onclick="combinationValidation(1)"><i
                                                      class="fa fa-refresh text-danger"
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Product Weight For Internal Use."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <input type="text" name="product_weight" id="product_weight"
                                             pattern="[0-9]{1,10}" title="Enter Only Number"
                                             placeholder="Product Weight" class="form-control" value="">
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Product Dimension In CM For Internal Use."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="number" name="product_l" id="product_l" step="any"
                                                   pattern="[0-9]{1,10}" title="Enter Only Number" placeholder="Length"
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="number" name="product_b" id="product_b" step="any"
                                                   pattern="[0-9]{1,10}" title="Enter Only Number" placeholder="Breadth"
                                                   class="form-control" value="">
                                             ...
                                             <div class="col-md-4">
                                                ...
                                                <input type="number" name="product_h" id="product_h" step="any"
                                                   pattern="[0-9]{1,10}" title="Enter Only Number" placeholder="Height"
                                                   class="form-control" value="">
                                       ...
                                       <div class="col-md-3">
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Is Trending Now." class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Is Hot Selling Now" class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Is Best Sellers" class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Is New Product" class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Delivery Charges For This Product."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                          ...
                                          <input type="text" name="delivery_charges" id="delivery_charges"
                                             pattern="[0-9]{1,10}" title="Enter Only Number"
                                             placeholder="Delivery Charges" class="form-control" value="0" required>
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Sold In Last  7 Days (In Number)"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>

                                          </label>

                                          <input type="number" name="current_sold_msg" id="current_sold_msg"
                                             placeholder="Sold In Last  7 Days (In Number)" class="form-control"
                                             value="">
                                       ...
                                       <div class="col-md-12">
                                          ...
                                          <label class="control-label" for="Name">
                                             ...
                                             <div data-title="Price Of This Combination."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                                ...
                                                <div class="img-checkbox demo-radio-button">
                                                   <div class="icheck-success d-inline">
                                                      ...
                                                      <input class="radio-col-green" <?php  echo  ($col->default_image == 1) ? 'checked' : '' ?> name="product_image_id"
                                                         id="product_image_id_<?php  echo $col->product_image_id; ?>"
                                                         value="<?php  echo $col->product_image_id; ?>" <?php  if ($pid_count == 1) {
                                                               echo "selected";
                                                            } ?> required type="radio" />

                                                      <label for="product_image_id_<?php  echo $col->product_image_id; ?>">

                                                         <img id="img_product_image_id_<?php  echo $col->product_image_id ?>"
                                                            src="<?php  echo  _uploaded_files_ ?>product/small/<?php  echo $col->product_image_name; ?>"
                                                            width="80" />
                                                      </label>
                                                   </div>
                                                </div>
...
<?php  echo MAINSITE.$slug_url.'-';?> <input type="text" name="comb_slug_url" id="comb_slug_url" style="width:200px" placeholder="Combinations Slug Url" class="form-control" value="" required >
...
<?php  */ ?>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-md-1">
                                          ...
                                          <div class="label-wrapper">
                                             ...
                                             <div data-title="Is display on Google merchant?"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                       ...
                                       <div class="col-md-2">
                                          ...
                                          <div class="demo-radio-button">
                                             <div class="icheck-success d-inline">
                                                ...
                                                <input type="radio" class="radio-col-green is_google_product"
                                                   name="is_google_product" id="is_google_product1" value="1" />

                                                <label for="is_google_product1">Yes &nbsp;&nbsp;</label>
                                             </div>
                                             <div class="icheck-danger d-inline">

                                                <input type="radio" class="radio-col-red is_google_product"
                                                   checked="checked" name="is_google_product" id="is_google_product2"
                                                   value="0" />
                                       ...
                                       <div class="col-md-1 gtin_class">
                                          ...
                                          <div class="label-wrapper">
                                             ...
                                             <div data-title="A Global Trade Item Number (GTIN) "
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                       ...
                                       <div class="col-md-2 gtin_class">
                                          ...
                                          <div class="input-group input-group-required">
                                             ...
                                             <input type="text" name="gtin" id="gtin" maxlength="255"
                                                placeholder="Global Trade Item Number (GTIN)" class="form-control"
                                                value="">
                                       ...
                                       <div class="col-md-2">
                                          ...
                                          <div class="label-wrapper">
                                             ...
                                             <div data-title="Edit SEO Tags." class="ico-help icon_title_box"><i
                                                   class="fa fa-question-circle"></i></div>
                                          ...
                                          <div class="input-group input-group-required">
                                             ...
                                             <div class="demo-radio-button">
                                                <div class="icheck-success d-inline">
                                                   ...
                                                   <input type="radio" class="radio-col-green" name="is_seo_tag"
                                                      id="is_seo_tag1" value="1" checked="checked" />

                                                   <label for="is_seo_tag1">Yes &nbsp;&nbsp;</label>
                                                </div>
                                                <div class="icheck-danger d-inline">

                                                   <input type="radio" class="radio-col-red" name="is_seo_tag"
                                                      id="is_seo_tag2" value="0" />
                                       ...
                                       <div class="col-md-2 auto_seo_combi_tags">
                                          ...
                                          <button type="button" class="btn bg-blue"
                                             onclick="combinationValidation('generateMeta')">Generate SEO Tags</button>
                                    ...
                                    <div class="form-group" style="display:none">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="label-wrapper">
                                             ...
                                             <div data-title="Current Viewers Message. Only Number"
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="input-group input-group-required">
                                             ...
                                             <input type="text" name="current_viewers_msg" id="current_viewers_msg"
                                                maxlength="450" placeholder="Current Viewers Message"
                                                class="form-control" value="">
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="input-group input-group-required">
                                             <div class="icheck-success d-inline">
                                                ...
                                                <input type="radio" class="" name="is_msg_dynamic" id="is_msg_dynamic1"
                                                   value="1" required /> Yes &nbsp;&nbsp;
                                             </div>

                                             <input type="radio" class="" name="is_msg_dynamic" id="is_msg_dynamic2"
                                    ...
                                    <div class="form-group" style="display:none">
                                       ...
                                       <div class="col-md-3">
                                          ...
                                          <div class="label-wrapper">
                                             ...
                                             <label class="control-label" for="Name">Add/Update Combination IN
                                                Store</label>

                                             <div data-title="Add/Update Combination IN Store."
                                                class="ico-help icon_title_box"><i class="fa fa-question-circle"></i>
                                             </div>
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="input-group input-group-required">
                                             ...
                                             <input type="radio" class="" name="is_update_store" id="is_update_store1"
                                                value="1" checked required /> Yes &nbsp;&nbsp;

                                             <input type="radio" class="" name="is_update_store" id="is_update_store2"
                                                value="0" /> No
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-md-2">
                                             ...
                                             <div class="label-wrapper">
                                                ...
                                                <div data-title="Slug URL." class="ico-help icon_title_box"><i
                                                      class="fa fa-question-circle"></i></div>
                                          ...
                                          <div class="col-md-4">
                                             ...
                                             <div class="input-group input-group-required">
                                                ...
                                                <input type="text" name="slug_url" id="auto_slug_url"
                                                   placeholder="Slug URL" class="form-control auto_seo_combi_tags_input"
                                                   value="" required>
                                          ...
                                          <div class="col-md-2">
                                             ...
                                             <div class="label-wrapper">
                                                ...
                                                <div data-title="Meta Tite." class="ico-help icon_title_box"><i
                                                      class="fa fa-question-circle"></i></div>
                                          ...
                                          <div class="col-md-4">
                                             ...
                                             <div class="input-group input-group-required">
                                                ...
                                                <input type="text" name="meta_title" maxlength="60" id="auto_meta_title"
                                                   placeholder="Page Tite"
                                                   class="form-control auto_seo_combi_tags_input" value="" required>
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-md-2">
                                             ...
                                             <div class="label-wrapper">
                                                ...
                                                <div data-title="Meta Description." class="ico-help icon_title_box"><i
                                                      class="fa fa-question-circle"></i></div>
                                          ...
                                          <div class="col-md-4">
                                             ...
                                             <div class="input-group input-group-required">
                                                ...
                                                <input type="text" name="meta_description" maxlength="160"
                                                   id="auto_meta_description" placeholder="Meta Description"
                                                   class="form-control auto_seo_combi_tags_input" value="" required>
                                          ...
                                          <div class="col-md-2">
                                             ...
                                             <div class="label-wrapper">
                                                ...
                                                <div data-title="Meta Keywords." class="ico-help icon_title_box"><i
                                                      class="fa fa-question-circle"></i></div>
                                          ...
                                          <div class="col-md-4">
                                             ...
                                             <div class="input-group input-group-required">
                                                ...
                                                <input type="text" name="meta_keywords" id="auto_meta_keywords"
                                    ...
                                    <div class="row text-center">
                                       ...
                                       <button type="reset" onclick="combinationFormReset()" class="btn bg-blue"
                                          style="margin-right: 10px"><i class="fa fa-refresh"></i>&nbsp;Reset</button>





                                       <button type="button" onclick="return combinationValidation()"
                                          class="btn bg-blue normal_field"><i class="fa fa-floppy-o"></i>&nbsp;Save and
                                          Continue Edit</button>



                                       <button type="button" style="display:none" onclick="combinationCloneValidation()"
                                          class="btn bg-blue clone_field"><i class="fa fa-clone"></i>&nbsp; Clone and
                                          Continue Edit</button>
                     ...
                     <?php  if ($product_id <= 0) { ?><span
                           style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this
                           product before adding product combinations.</span><?php  } ?>

                     <?php  if (empty($product_image_detail)) { ?><span
                           style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save the
                           atleast one image of this product before adding product combinations.</span><?php  } ?>

                     <div class="box-body">

                        <?php  if ($product_id >= 1 && !empty($product_image_detail)) { ?>
                           ...
                           <script>
                              ...
                              function setProductDefaultCombination(id, productId) {
                                 ...
                                 $.ajax({
                                    ...
                                    url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/setProductDefaultCombination',
                              ...
                              function editCombination(id) {
                                 ...
                                 <?php  foreach ($product_combination_detail as $row) {
                                    ...
                                    if (id == <?php  echo $row['product_combination_id'] ?>) {

                                       //alert(id);

                                       document.getElementById('product_combination_id').value = '<?php  echo $row['product_combination_id'] ?>';

                                       document.getElementById('combref_code').value = '<?php  echo addslashes($row['ref_code']) ?>';

                                       document.getElementById('quantity').value = '<?php  echo $row['quantity'] ?>';

                                       document.getElementById('uom_id').value = '<?php  echo $row['uom_id'] ?>';

                                       document.getElementById('price').value = '<?php  echo $row['price'] ?>';

                                       document.getElementById('discount').value = '<?php  echo $row['discount'] ?>';

                                       document.getElementById('final_price').value = '<?php  echo $row['final_price'] ?>';

                                       document.getElementById('discounted_price').value = '<?php  echo $row['final_price'] ?>';

                                       <?php  /*?>document.getElementById('comb_slug_url').value = '<?php  echo $row['comb_slug_url'] ?>';<?php  */ ?>

                                       document.getElementById('product_l').value = '<?php  echo $row['product_l'] ?>';

                                       document.getElementById('product_b').value = '<?php  echo $row['product_b'] ?>';

                                       document.getElementById('product_h').value = '<?php  echo $row['product_h'] ?>';

                                       document.getElementById('product_weight').value = '<?php  echo $row['product_weight'] ?>';

                                       document.getElementById('product_display_name').value = '<?php  echo addslashes($row['product_display_name']) ?>';

                                       document.getElementById('delivery_charges').value = '<?php  echo $row['delivery_charges'] ?>';

                                       document.getElementById('current_viewers_msg').value = '<?php  echo $row['current_viewers_msg'] ?>';

                                       document.getElementById('gtin').value = '<?php  echo $row['gtin'] ?>';

                                       <?php  if (empty($row['product_seo_id'])) {
                                          $row['product_seo_id'] = 0;
                                       } ?>

                                       document.getElementById('auto_product_seo_id').value = '<?php  echo $row['product_seo_id'] ?>';

                                       document.getElementById('auto_slug_url').value = '<?php  echo $row['slug_url'] ?>';

                                       document.getElementById('auto_meta_title').value = '<?php  echo $row['meta_title'] ?>';

                                       document.getElementById('auto_meta_description').value = '<?php  echo $row['meta_description'] ?>';

                                       document.getElementById('auto_meta_keywords').value = '<?php  echo $row['meta_keywords'] ?>';



                                       document.getElementById('current_sold_msg').value = '<?php  echo $row['current_sold_msg'] ?>';

                                       if (<?php  echo $row['is_msg_dynamic'] ?>== 1) { document.getElementById('is_msg_dynamic1').checked = true; }

                                       else { document.getElementById('is_msg_dynamic2').checked = true; }

                                       if (<?php  echo $row['trending_now'] ?>== 1) { document.getElementById('trending_now1').checked = true; }

                                       else { document.getElementById('trending_now2').checked = true; }

                                       if (<?php  echo $row['hot_selling_now'] ?>== 1) { document.getElementById('hot_selling_now1').checked = true; }

                                       else { document.getElementById('hot_selling_now2').checked = true; }

                                       if (<?php  echo $row['best_sellers'] ?>== 1) { document.getElementById('best_sellers1').checked = true; }

                                       else { document.getElementById('best_sellers2').checked = true; }

                                       if (<?php  echo $row['new_product'] ?>== 1) { document.getElementById('new_product1').checked = true; }

                                       else { document.getElementById('new_product2').checked = true; }

                                       if (<?php  echo $row['status'] ?>== 1) { document.getElementById('combstatus1').checked = true; }

                                       else { document.getElementById('combstatus2').checked = true; }



                                       if (<?php  echo $row['is_google_product'] ?>== 1) { document.getElementById('is_google_product1').checked = true; }
                                       ...
                                       if (<?php  echo $row['product_image_id'] ?>> 0) {

                                          document.getElementById('product_image_id_<?php  echo $row['product_image_id'] ?>').checked = true;

                                          document.getElementById('img_product_image_id_<?php  echo $row['product_image_id'] ?>').border = "5px !important";

                                       }

                                       if ('<?php  echo $row['discount_var'] ?>' == 'Rs')

                                          document.getElementById('discount_var').getElementsByTagName('option')[1].selected = 'selected';

                                       if ('<?php  echo $row['discount_var'] ?>' == '%')
                                          ...
                                          if ($col['product_combination_id'] == $row['product_combination_id']) {
                                             ...
                                             foreach ($product_attribute_list as $col1) {
                                                ...
                                                if ($col1['product_attribute_id'] == $col['product_attribute_id']) {
                                                   $attribute = $col1['name'];
                                                   $product_attribute_id = $col1['product_attribute_id'];
                                                }
                                             }
                                             ...
                                             foreach ($attribute_value_list as $col1) {
                                                ...
                                                if ($col1['product_attribute_value_id'] == $col['product_attribute_value_id']) {
                                                   ...
                                                   $product_attribute_value_id = $col1['product_attribute_value_id'];
                                                }
                                             }
                                             ...
                                             li.appendChild(document.createTextNode('<?php  echo $attribute; ?>'));

                                             li.innerHTML = '<?php  echo addslashes("$attribute : $combination_value $attribute_val"); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img width="22px" height="22px" src="<?php  echo  _admin_files_ . "images/cancel.png" ?>" /> <input type="hidden" name="product_attribute_id[]" value="<?php  echo $product_attribute_id ?>" /><input type="hidden" name="combination_value[]" value="<?php  echo addslashes($combination_value) ?>" /><input type="hidden" name="product_attribute_value_id[]" value="<?php  echo $product_attribute_value_id ?>"  />';
                           ...
                           <script>
                              ...
                              function setCombinationFormHeader(task, pName = '') {
                                 ...
                                 if (task == 3) {
                                    ...
                                    <?php  /*?>//document.getElementById('product_image_id_<?php  echo $row['product_image_id'] ?>').checked = true;<?php  */ ?>

                                    <?php  /*?>//document.getElementById('img_product_image_id_<?php  echo $row['product_image_id'] ?>').border = "5px !important";<?php  */ ?>
                        ...
                        <script>
                           ...
                           function combinationValidation(val = '') {
                              ...
                              $.ajax({
                                 ...
                                 url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/checkProductCombinationCombiRefCode',
               ...
               <div role="tabpanel" class="tab-pane fade images-sec <?php  if ($active_tab == "COMBINATIONS_POS") {
                  echo " in active show ";
               } ?>" id="COMBINATIONS_POS">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if (count($product_combination_detail) <= 0) { ?><span
                           style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must add the
                           product combination.</span><?php  } ?>

                     <div class="box-body">

                        <?php  if (count($product_combination_detail) > 0) { ?>
                           ...
                           <div class="tableDemo">
                              ...
                              <table class="table table-striped" id="table-3">
                                 ...
                                 <tr style="display:none">
                                    ...
                                    <td><img src="<?php  echo MAINSITE ?>images/service-8.jpg" width="200" /></td>
                                    ...
                                    <td class="text-right"><a target="_blank" class="btn btn-default"
                                          onclick="javascript:location.href='';"><i class="fa fa-eye"></i>View This
                                          Image</a></td>
                           ...
                           <script>
                              ...
                              function setProductDefaultImage(id, productId) {
                                 ...
                                 $.ajax({
                                    ...
                                    url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/setProductDefaultImage',
               ...
               <div role="tabpanel" class="tab-pane fade images-sec <?php  if ($active_tab == "images") {
                  echo " in active show ";
               } ?>" id="images">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if ($product_id <= 0) { ?><span
                           style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this
                           product before adding images.</span><?php  } ?>
                        ...
                        <?php  if ($product_id >= 1) { ?>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-2 ">
                                 ...
                                 <div data-title="Add More Images To This Product" class="ico-help icon_title_box"><i
                                       class="fa fa-question-circle"></i></div>
                              ...
                              <div class="col-md-3">
                                 ...
                                 <button type="submit" class="btn bg-blue"><i class="fa fa-floppy-o"></i>Add
                                    Images</button>
                                 ...
                                 $("#table-2").tableDnD({
                                    ...
                                    onDrop: function (table, row) {
                                       ...
                                       $.ajax({
                                          ...
                                          url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/GetCompleteProductImageListNewPos',

                                          //dataType : "json",

                                          data: { "product_id": <?php  echo $product_id; ?> , 'podId': podId, "<?php  echo  $csrf['name'] ?>": "<?php  echo  $csrf['hash'] ?>" },
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if ($active_tab == "settings") {
                  echo " in active show ";
               } ?>" id="settings">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if ($alert == "success" || $alert == "fail") { ?><span
                           style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  if ($alert == "success") {
                              echo "Record Updated Successfully.";
                           } else if ($alert == "fail") {
                              echo "Error in updating this input.";
                     ...
                     <div class="box-body">
                        ...
                        <?php  if ($product_id <= 0) { ?><span
                              style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this
                              product before adding SEO Settings.</span><?php  } ?>

                        <?php  if ($product_id >= 1) { ?>

                           <?php  if (!empty($product_combination_detail)) { ?>
                                 ...
                                 <div class="panel-group" id="accordion">
                                    ...
                                    foreach ($product_combination_detail as $pcd) {
                                       ...
                                       <div class="panel panel-default">
                                          ...
                                          <div class="panel-heading">
                                             ...
                                             <h4 class="panel-title">
                                                ...
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                                   href="#seo_setting_<?php  echo $ss_count; ?>">

                                                   <?php  echo $pcd['product_display_name']; ?> - <?php  echo $show; ?> <br>
                                          ...
                                          <div id="seo_setting_<?php  echo $ss_count; ?>" class="panel-collapse collapse <?php  if ($ss_count == 1) {
                                                echo ' in';
                                             } ?> ">
                                             ...
                                             <div class="panel-body">
                                                ...
                                                <?php  /*?>
                                                                                                                                                               ...
                                                                                                                                                               <pre><?php  print_r($product_seo_detail) ?></pre>
                                                ...
                                                <form role="form" class="form-horizontal"
                                                   name="ProductFormSEO_<?php  echo $ss_count ?>"
                                                   id="ProductFormSEO_<?php  echo $ss_count ?>"
                                                   action="<?php  echo MAINSITE_Admin . 'products/doAddProductSEO'; ?>"
                                                   method="post" enctype="multipart/form-data">

                                                   <input type="hidden" name="action" id="action_info_<?php  echo $ss_count ?>"
                                                      value="" />

                                                   <input type="hidden" name="product_id" id="product_id_<?php  echo $ss_count ?>"
                                                      value="<?php  echo $product_id; ?>" /><br />

                                                   <input type="hidden" name="product_combination_id"
                                                      id="product_combination_id_<?php  echo $ss_count ?>"
                                                      value="<?php  echo $pcd['product_combination_id']; ?>" /><br />

                                                   <input type="hidden" name="product_seo_id"
                                                      id="product_seo_id_<?php  echo $ss_count ?>"
                                                      value="<?php  echo $product_seo_id ?>" /><br />
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Final Price." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" placeholder="Category" class="form-control"
                                                               value="<?php  echo $pcd['final_price'] ?>">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Category." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="slug_url" id="slug_url_<?php  echo $ss_count ?>"
                                                               placeholder="Slug URL" class="form-control"
                                                               value="<?php  echo $slug_url ?>" required>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="meta_title" maxlength="60"
                                                               id="meta_title_<?php  echo $ss_count ?>" placeholder="Page Tite"
                                                               class="form-control" value="<?php  echo $meta_title ?>" required>
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="meta_description" maxlength="160"
                                                               id="meta_description_<?php  echo $ss_count ?>"
                                                               placeholder="Meta Description" class="form-control"
                                                               value="<?php  echo $meta_description ?>" required>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="meta_keywords"
                                                               id="meta_keywords_<?php  echo $ss_count ?>"
                                                               placeholder="Meta Keywords" class="form-control"
                                                               value="<?php  echo $meta_keywords ?>" required>
                                                   ...
                                                   <div class="form-group" style="display:none">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Others Tags." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <textarea class="search_textbox " name="others"
                                                               id="others_<?php  echo $ss_count ?>" placeholder="Others Tags"
                                                               style="width: 576px; height: 200px;"><?php  echo $others ?></textarea>
                                                   ...
                                                   <div class="pull-right">
                                                      ...
                                                      <button type="submit"
                                                         onclick="return productSEOValidation('save' , <?php  echo $ss_count ?>)"
                                                         class="btn bg-blue"><i class="fa fa-floppy-o"></i>Save</button>

                                                      <button type="submit"
                                                         onclick="return productSEOValidation('save-edit' , <?php  echo $ss_count ?>)"
                                 ...
                                 <script>
                                    ...
                                    function productSEOValidation(submitAction, id) {
                                       ...
                                       $.ajax({
                                          ...
                                          url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/checkProductSEOSlugUrl',
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if ($active_tab == "add_review") {
                  echo " in active show ";
               } ?>" id="add_review">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                        ...
                        <?php  if ($product_id <= 0) { ?><span
                              style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this
                              product before adding New Review.</span><?php  } ?>
                                       ...
                                       <div class="panel panel-default">
                                          ...
                                          <div class="panel-heading">
                                             ...
                                             <h4 class="panel-title">
                                                ...
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                                   href="#add_review_<?php  echo $ss_count; ?>">

                                                   <?php  echo $pcd['product_display_name']; ?> - <?php  echo $show; ?>
                                          ...
                                          <div id="add_review_<?php  echo $ss_count; ?>" class="panel-collapse collapse <?php  if ($ss_count == 1) {
                                                echo ' in';
                                             } ?> ">
                                             ...
                                             <div class="panel-body">
                                                ...
                                                <form role="form" class="form-horizontal"
                                                   name="ProductFormAddReview_<?php  echo $ss_count ?>"
                                                   id="ProductFormAddReview_<?php  echo $ss_count ?>"
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Name To Display." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="customer_name"
                                                               id="customer_name_<?php  echo $ss_count ?>" placeholder="Name"
                                                               class="form-control" value="" required>
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Review Title." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <input type="text" name="review_title"
                                                               id="review_title_<?php  echo $ss_count ?>" placeholder="Review Title"
                                                               class="form-control" value="" required>
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-3">
                                                         ...
                                                         <div class="label-wrapper">
                                                            ...
                                                            <div data-title="Review." class="ico-help icon_title_box"><i
                                                                  class="fa fa-question-circle"></i></div>
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <textarea type="text" name="review" id="review_<?php  echo $ss_count ?>"
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div class="col-md-9">
                                                         ...
                                                         <div class="input-group input-group-required">
                                                            ...
                                                            <select name="rating" id="rating_<?php  echo $ss_count ?>"
                                                               class="form-control" required>
                                                   ...
                                                   <div class="pull-right">
                                                      ...
                                                      <button type="submit" name="action" value="" class="btn bg-blue"><i
                                                            class="fa fa-floppy-o"></i>Save</button>

                                                      <button type="submit" name="action" value="save-edit"
                                                         class="btn bg-blue"><i class="fa fa-floppy-o"></i>Save and Add
                                                         New</button>
...
<script>
   ...
   $(document).ready(function () {
      ...
      $.ajax({
         ...
         url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/GetCompleteProductImageList',

         //dataType : "json",

         data: { "product_id": <?php  echo $product_id; ?> , "<?php  echo  $csrf['name'] ?>": "<?php  echo  $csrf['hash'] ?>" },
      ...
      $.ajax({
         ...
         url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/GetCompleteProductCombinationListPOS',
      ...
      $.ajax({
         ...
         url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/GetCompleteProductCombinationList',
...
<script>
   ...
   function getAttributeVal(attribute_value) {
      ...
      <?php  foreach ($attribute_value_list as $col) { ?>
         ...
         if (attribute_value ==<?php  echo $col->product_attribute_id; ?>)

            optionText += '<option value="<?php  echo $col->product_attribute_value_id; ?>"><?php  echo $col->name; ?></option>'
   ...
   function getAttributePerProduct(attribute_value) {
      ...
      <?php  foreach ($product_attribute_list as $col) { ?>
         ...
         if (attribute_value ==<?php  echo $col->product_attribute_id; ?>)
            ...
            return "<?php  echo $col->condition_per_product; ?>";
...
<script>
      ...
      /*if(document.getElementById('how_to_use').validationMessage!='')
   {
      ...
      $.ajax({
         ...
         url: '<?php  echo MAINSITE_Admin ?>catalog/Product-Module/checkProductRefCode',
         dataType: "json",
