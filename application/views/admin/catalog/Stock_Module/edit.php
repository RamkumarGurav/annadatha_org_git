         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               ...
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/view/".$product_id?>">View</a></li>
   ...
   <section class="content">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="row align-items-center bg-white tabb">
               ...
               <ul class="nav nav-tabs admin-tab1   col-md-9" role="tablist">
                  ...
                  <li role="presentation" class="<?php  if($active_tab == "INFORMATION"){ echo "active";} ?>"><a href="#INFORMATION" class="<?php  if($active_tab == "INFORMATION"){ echo "active";} ?>" aria-controls="home" role="tab" data-toggle="tab">INFORMATION</a></li>

                  <li role="presentation" class=" <?php  if($active_tab == "COMBINATIONS"){ echo " active ";} ?>"><a href="#COMBINATIONS" class="<?php  if($active_tab == "COMBINATIONS"){ echo "active";} ?>" aria-controls="profile" role="tab" data-toggle="tab">COMBINATIONS</a></li>

                  <li role="presentation" class=" <?php  if($active_tab == "COMBINATIONS_POS"){ echo " active ";} ?>"><a href="#COMBINATIONS_POS" class="<?php  if($active_tab == "COMBINATIONS_POS"){ echo "active";} ?>" aria-controls="profile" role="tab" data-toggle="tab"> POSITION</a></li>

                  <li role="presentation" class=" <?php  if($active_tab == "images"){ echo " active ";} ?>"><a href="#images" class="<?php  if($active_tab == "images"){ echo "active";} ?>" aria-controls="messages" role="tab" data-toggle="tab">IMAGES</a></li>
                  ...
                  <li role="presentation" class=" <?php  if($active_tab == "settings"){ echo " active ";} ?>"><a href="#settings" class="<?php  if($active_tab == "settings"){ echo "active";} ?>" aria-controls="settings" role="tab" data-toggle="tab">SEO Settings</a></li>

                  <?php  }} ?>

                  <li role="presentation" class=" <?php  if($active_tab == "add_review"){ echo " active ";} ?>"><a href="#add_review" class="<?php  if($active_tab == "add_review"){ echo "active";} ?>" aria-controls="add_review" role="tab" data-toggle="tab">Add Review</a></li>

               </ul>

               <div class="col-md-3 text-right" >

                  <a href="<?php  echo MAINSITE."SecureRegions/wdm/products/list"; ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>&nbsp; Back To Product List</a>
         ...
         <div class="col-md-12">
            ...
            <?php  if($alert == "success" || $alert == "update" || $alert == "fail" || $alert == "imageUpdate" || $alert == "wrongimageformat" || $alert == "imageDelete" || $alert == "combiSuccess"){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  if($alert == "success") {echo "Record Inserted Successfully.";}else if($alert == "update") {echo "Record Updated Successfully.";}else if($alert == "fail"){echo "Error in updating this input.";}else if($alert == "imageUpdate"){echo "Image Inserted Seccessfully.";}else if($alert == "wrongimageformat"){echo "Wrong Image format. Only .jpg , .jpeg or .png image is allowed.";}else if($alert == "imageDelete"){echo "Image Deleted Seccessfully.";}else if($alert == "combiSuccess"){
            ...
            <div class="tab-content  admin-tab-cont1">
               ...
               <div role="tabpanel" class="tab-pane show fade <?php  if($active_tab == "INFORMATION"){ echo "in active show ";} ?>" id="INFORMATION">
                     ...
                     <div class="box-body">
                           ...
                           <div class="form-group  col-md-8">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Product Name" class="form-control" value="<?php  echo $name;?>" required >
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="text" name="ref_code" id="ref_code" placeholder="Reference Code" class="form-control" value="<?php  echo $ref_code;?>" required >
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <input type="text" name="hsn_code" id="hsn_code" placeholder="HSN Code" class="form-control" value="<?php  echo $hsn_code;?>" required ><span class="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <select  name="tax_categories_id" id="tax_categories_id" class="form-control" required onchange="getTaxProvider(this)">
                                          ...
                                          <option <?php  if($tax_id==$row->tax_id){echo "selected";} ?> value="<?php  echo $row->tax_id; ?>"><?php  echo $row->tax_name; ?></option>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <textarea  class="search_textbox form-control" rows="8"  name="short_description" id="short_description" ><?php  echo $short_description;?></textarea>
                                       ...
                                       <ul >
                                          ...
                                          <li class="isFolder isExpanded" title="New Parent Category">
                                             ...
                                             <ul >
                                                ...
                                                <?php  $liClassExpend='';$liClass = ''; $liFolderCount=0;foreach($category_list as $row2){if(in_array($row2->category_id , $category_id_arr ))$liClassExpend = 'isExpanded';if($row2->super_category_id==$row1->category_id)$liFolderCount++;}if($liFolderCount>0){$liClass = 'isFolder';} ?>

                                                <li class="<?php  echo $liClass." ".$liClassExpend; ?> " title="Parent Category">
                                                   ...
                                                   <a href="0" target="category_id[],<?php  echo $row1->category_id; ?>,<?php  if(in_array($row1->category_id , $category_id_arr )){echo 'true';}else {echo "false";} ?>"><?php  echo $row1->name; ?></a>
                                                   ...
                                                   <ul>
                                                      ...
                                                      <?php  $liClassExpend='';$liClass = ''; $liFolderCount=0;foreach($category_list as $row4){if($row4->super_category_id ==$row3->category_id)$liFolderCount++;}if($liFolderCount>0){$liClass = 'isFolder';if(in_array($row3->category_id , $category_id_arr ))$liClassExpend = 'isExpanded';} ?>

                                                      <li class="<?php  echo $liClass." ".$liClassExpend; ?>  " title="Sub Category">

                                                         <a href="0" target="category_id[],<?php  echo $row3->category_id; ?>,<?php  if(in_array($row3->category_id , $category_id_arr )){echo 'true';}else {echo "false";} ?>"><?php  echo $row3->name; ?></a>
                                                         ...
                                                         <ul>
                                                            ...
                                                            <li class="" title="Super Sub Category"><a href="0" target="category_id[],<?php  echo $row5->category_id; ?>,<?php  if(in_array($row5->category_id , $category_id_arr )){echo 'true';}else {echo "false";} ?>"><?php  echo $row5->name; ?></a></li>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-12">
                              ...
                              <textarea  class="search_textbox ckeditor"  name="description" id="description" style="width: 576px; height: 200px;"><?php  echo $description;?></textarea>
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if($active_tab == "COMBINATIONS"){ echo " in active show ";} ?>" id="COMBINATIONS">
                  ...
                  <div class="box box-primary">
                                 ...
                                 <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-md-3">
                                             ...
                                             <select name="uom_id" id="uom_id"  class="form-control" required >
                                                ...
                                                <option value="<?php  echo $col->unit_of_measurement_id; ?>"><?php  echo $col->unit_of_measurement_name; ?></option>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-md-3">
                                             ...
                                             <select type="text" name="select_product_attribute_id" id="select_product_attribute_id" class="form-control"  onchange="getAttributeVal(this.value)">
                                                ...
                                                <option value="<?php  echo $col->product_attribute_id; ?>"><?php  echo $col->name; ?></option>
                                          ...
                                          <div class="col-md-3">
                                             ...
                                             <div class="input-group input-group-required" id="showAttributeValue">
                                                ...
                                                <select name="select_product_attribute_value_id" id="select_product_attribute_value_id" class="form-control" >
                                                   ...
                                                   <option value="<?php  echo $col->product_attribute_value_id; ?>"><?php  echo $col->name; ?></option>
                                          ...
                                          <div class="col-md-3">
                                             ...
                                             <div class="input-group input-group-required" id="showAttributeValue"><?php  //echo "<pre>"; print_r($attribute_value_list);echo "</pre>"; ?>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-3" id="do_not_update" style="display:none">
                                          ...
                                          <div class="col-md-12">
                                             ...
                                             <article class="row">
                                                ...
                                                <div class="img-checkbox demo-radio-button">
                                                   ...
                                                   <?php  echo ($col->default_image==1)? 'checked' : ''?>
                                                    name="product_image_id" id="product_image_id_<?php  echo $col->product_image_id; ?>" value="<?php  echo $col->product_image_id; ?>" <?php  if($pid_count==1){echo "selected";} ?> required type="radio" />

                                                   <label  for="product_image_id_<?php  echo $col->product_image_id; ?>">

                                                   <img id="img_product_image_id_<?php  echo $col->product_image_id ?>" src="<?php  echo _uploaded_files_?>product/small/<?php  echo $col->product_image_name; ?>" width="80" />
                                                   </label>
</div>
                                                </div>
                                      ...
                                      <!-- <div class="row">
                                       ...
                                       <div class="row text-center">
                                          ...
                                          <button type="submit" onclick="return combinationValidation()" class="btn bg-blue normal_field"><i class="fa fa-floppy-o"></i>&nbsp;Save and Continue Edit</button>

                                       

                                          <button type="submit" style="display:none" onclick="combinationCloneValidation()" class="btn bg-blue clone_field"><i class="fa fa-clone"></i>&nbsp; Clone and Continue Edit</button>
                     ...
                     <?php  if($product_id<=0){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this product before adding product combinations.</span><?php  }?>

                     <?php  if(empty($product_image_detail)){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save the atleast one image of this product before adding product combinations.</span><?php  }?>
                        ...
                        <script>    
...

                           {
                            ...
                            url:'<?php  echo MAINSITE_Admin ?>catalog/Product-Module/setProductDefaultCombination',
                              ...
                              <?php  foreach($product_combination_detail as $row){$row = (array)$row; ?>
...

                                {
                                  ...
                                  <?php  if(empty($row['product_seo_id'])){$row['product_seo_id']=0;} ?>
                                  ...
                                  if(<?php  echo $row['is_msg_dynamic'] ?>==1)
                                  ...
                                  if(<?php  echo $row['trending_now'] ?>==1)
                                  ...
                                  if(<?php  echo $row['hot_selling_now'] ?>==1)
                                  ...
                                  if(<?php  echo $row['best_sellers'] ?>==1)
                                  ...
                                  if(<?php  echo $row['is_google_product'] ?>==1)
               ...
               <div role="tabpanel" class="tab-pane fade images-sec <?php  if($active_tab == "COMBINATIONS_POS"){ echo " in active show ";} ?>" id="COMBINATIONS_POS">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if(count($product_combination_detail)<=0){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must add the product combination.</span><?php  }?>
               ...
               <div role="tabpanel" class="tab-pane fade images-sec <?php  if($active_tab == "images"){ echo " in active show ";} ?>" id="images">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if($product_id<=0){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this product before adding images.</span><?php  }?>
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if($active_tab == "settings"){ echo " in active show ";} ?>" id="settings">
                  ...
                  <div class="box box-primary">
                     ...
                     <?php  if($alert == "success" || $alert == "fail"){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  if($alert == "success") {echo "Record Updated Successfully.";}else if($alert == "fail"){echo "Error in updating this input.";}?></span><?php  }?>

                     <div class="box-body">

                        <?php  if($product_id<=0){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this product before adding SEO Settings.</span><?php  }?>
                        ...
                        <div class = "container col-md-12">
                           ...
                           <div class="panel-group" id="accordion">
                              ...
                              <?php  $ss_count=0; foreach($product_combination_detail as $pcd){$ss_count++; ?>
                              ...
                              <div class="panel panel-default">
                                 ...
                                 <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">
                                       ...
                                       <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#seo_setting_<?php  echo $ss_count; ?>">
                                 ...
                                 <div id="seo_setting_<?php  echo $ss_count; ?>" class="panel-collapse collapse <?php  if($ss_count==1){echo ' in';} ?> ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form role="form" class="form-horizontal" name="ProductFormSEO_<?php  echo $ss_count ?>" id="ProductFormSEO_<?php  echo $ss_count ?>" action="<?php  echo MAINSITE_Admin.'products/doAddProductSEO';?>" method="post" enctype="multipart/form-data">

                                          <input type="hidden" name="action" id="action_info_<?php  echo $ss_count ?>" value="" />

                                          <input type="hidden" name="product_id"  id="product_id_<?php  echo $ss_count ?>" value="<?php  echo $product_id; ?>" /><br />

                                          <input type="hidden" name="product_combination_id"  id="product_combination_id_<?php  echo $ss_count ?>" value="<?php  echo $pcd['product_combination_id']; ?>" /><br />

                                          <input type="hidden" name="product_seo_id"  id="product_seo_id_<?php  echo $ss_count ?>" value="<?php  echo $product_seo_id ?>" /><br />
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" placeholder="Category" class="form-control" value="<?php  echo $pcd['final_price']?>">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" placeholder="Category" class="form-control" value="<?php  echo $category?>">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="slug_url" id="slug_url_<?php  echo $ss_count ?>" placeholder="Slug URL" class="form-control" value="<?php  echo $slug_url ?>" required >
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="meta_title"  maxlength="60" id="meta_title_<?php  echo $ss_count ?>" placeholder="Page Tite" class="form-control" value="<?php  echo $meta_title ?>" required >
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="meta_description" maxlength="160" id="meta_description_<?php  echo $ss_count ?>" placeholder="Meta Description" class="form-control" value="<?php  echo $meta_description ?>" required >
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="meta_keywords" id="meta_keywords_<?php  echo $ss_count ?>" placeholder="Meta Keywords" class="form-control" value="<?php  echo $meta_keywords ?>" required >
                                          ...
                                          <div class="form-group" style="display:none">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <textarea  class="search_textbox "  name="others" id="others_<?php  echo $ss_count ?>" placeholder="Others Tags" style="width: 576px; height: 200px;"><?php  echo $others ?></textarea>
                                          ...
                                          <div class="pull-right">
                                             ...
                                             <button type="submit" onclick="return productSEOValidation('save' , <?php  echo $ss_count ?>)"  class="btn bg-blue"><i class="fa fa-floppy-o"></i>Save</button>

                                             <button type="submit" onclick="return productSEOValidation('save-edit' , <?php  echo $ss_count ?>)" class="btn bg-blue"><i class="fa fa-floppy-o"></i>Save and Continue Edit</button>
               ...
               <div role="tabpanel" class="tab-pane fade <?php  if($active_tab == "add_review"){ echo " in active show ";} ?>" id="add_review">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                        ...
                        <?php  if($product_id<=0){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;You must save this product before adding New Review.</span><?php  }?>
                              ...
                              <div class="panel panel-default">
                                 ...
                                 <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">
                                       ...
                                       <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#add_review_<?php  echo $ss_count; ?>">
                                 ...
                                 <div id="add_review_<?php  echo $ss_count; ?>" class="panel-collapse collapse <?php  if($ss_count==1){echo ' in';} ?> ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form role="form" class="form-horizontal" name="ProductFormAddReview_<?php  echo $ss_count ?>" id="ProductFormAddReview_<?php  echo $ss_count ?>" action="<?php  echo MAINSITE_Admin.'products/doAddProductReview';?>" method="post" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="customer_name" id="customer_name_<?php  echo $ss_count ?>" placeholder="Name" class="form-control" value="" required >
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <input type="text" name="review_title" id="review_title_<?php  echo $ss_count ?>" placeholder="Review Title" class="form-control" value="" required >
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <textarea type="text" name="review" id="review_<?php  echo $ss_count ?>" placeholder="Review" class="form-control" required ></textarea>
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                                ...
                                                <div class="input-group input-group-required">
                                                   ...
                                                   <select name="rating" id="rating_<?php  echo $ss_count ?>" class="form-control"  required >
