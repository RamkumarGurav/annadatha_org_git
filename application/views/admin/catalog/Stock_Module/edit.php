            ...
            <div class="row align-items-center bg-white tabb">
             ...
             <? php */ ?>
               ...
               <div class="col-md-3 text-right">
                  ...
                  <a href="<?  echo MAINSITE . "SecureRegions/wdm/products/list"; ?>" class="btn btn-primary"><i
                        class="fa fa-arrow-left"></i>&nbsp; Back To Product List</a>
                                 ...
                                 <div class="card-body">
                                  ...
                                  <? php */ ?>
                                    ...
                                    <div class="row text-center">
                                       ...
                                       <button type="submit" onclick="return combinationValidation()"
                                          class="btn bg-blue normal_field"><i class="fa fa-floppy-o"></i>&nbsp;Save and
                                          Continue Edit</button>



                                       <button type="submit" style="display:none" onclick="combinationCloneValidation()"
