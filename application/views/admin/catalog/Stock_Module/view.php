         ...
         <div class="col-md-12">
            ...
            <div class="row align-items-center bg-white tabb">
               ...
               <div class="col-md-6">
                  ...
                  <a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/".$user_access->function_name?>" class="btn btn-warning" ><?php  echo $user_access->module_name?> Back To Product List</a>

                  <?php  if($product_id>0){ ?>

                  <?php   if($user_access->update_module==1) { ?>

                  <a href="<?php  echo MAINSITE_Admin?>catalog/Product-Module/edit/<?php  echo $product_id ?>" class="btn btn-info" >Update Product</a>

                  <a href="<?php  echo MAINSITE_Admin?>catalog/Product-Module/product_clone/<?php  echo $product_id ?>" onclick="return confirm('Do you really want to clone this product? ')" class="btn bg-danger" ><i class="fa fa-clone"></i>Clone and Continue Edit</a>
            ...
            <div class="tab-content  admin-tab-cont1">
                     ...
                     <div class="box-body ">
                        ...
                        <form role="form" class="form-horizontal" name="ProductForm" id="ProductForm" action="<?php  echo MAINSITE_Admin.'products/doAddProduct';?>" method="post" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <p> <?php  foreach($brand_list as $row){ ?>
                                       ...
                                       <?php  if($brand_id==$row->brand_id){ echo $row->brand_name; } ?>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <p> <?php  foreach($tax_list as $row){ ?>
                                       ...
                                       <?php  if($tax_id==$row->tax_id){echo $row->tax_name;} ?>
                           ...
                           <div class="col-md-6">
                              ...
                              <p> <?php  if($is_sell_local==1){echo "Seasonkart Location";}else if($is_sell_local==1){echo "All India";}?></p>
                           ...
                           <div class="col-md-6">
                              ...
                              <p> <?php  if($is_bulk_enquiry==1){echo "Yes";}else {echo "No";}?></p>
                                 ...
                                 <li class="isFolder isExpanded" title="New Parent Category">
                                    ...
                                    <ul >
                                       ...
                                       <li class="<?php  echo $liClass." ".$liClassExpend; ?> " title="Parent Category">
                                          ...
                                          <?php  /*?><a href="0" target="super_category_id,<?php  echo $row1['category_id']; ?>,false" ><?php  */?><?php  echo $row1->name; ?><?php  /*?></a><?php  */?>
               ...
               <div role="tabpanel" class="tab-pane fade" id="settings">
                  ...
                  <div class="box box-primary">
					 ...
					 if($alert == "success" || $alert == "fail"){?><span style="color:#FF0000; font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  if($alert == "success") {echo "Record Updated Successfully.";}else if($alert == "fail"){echo "Error in updating this input.";}?></span><?php  }?>
                     ...
                     <div class="box-body">
                        ...
                        <div class = "container col-md-12">
                           ...
                           <div class="panel-group" id="accordion">
                              ...
                              <?php  $ss_count=0; foreach($product_combination_detail as $pcd){$ss_count++;$pcd = (array)$pcd; ?>
                                 ...
                                 <div id="seo_setting_<?php  echo $ss_count; ?>" class="panel-collapse collapse <?php  if($ss_count==1){echo ' in';} ?> ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form role="form" class="form-horizontal" name="ProductFormSEO_<?php  echo $ss_count ?>" id="ProductFormSEO_<?php  echo $ss_count ?>" action="<?php  echo MAINSITE_Admin.'products/doAddProductSEO';?>" method="post" enctype="multipart/form-data">
                                          ...
                                          <input type="hidden" name="product_id"  id="product_id_<?php  echo $ss_count ?>" value="<?php  echo $product_id; ?>" />

                                          <input type="hidden" name="product_combination_id"  id="product_combination_id_<?php  echo $ss_count ?>" value="<?php  echo $pcd['product_combination_id']; ?>" />

                                          <input type="hidden" name="product_seo_id"  id="product_seo_id_<?php  echo $ss_count ?>" value="<?php  echo $product_seo_id ?>" />
