                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <?  if (!empty($category_data)) { ?>
                                    <tbody>
                                        ...
                                        foreach ($category_data as $urm) {
                                            $count++;
                                            if ($urm->super_category_name == '') {
                                                $urm->super_category_name == 'Parent';
                                            }
                                            ...
                                            <tr>
                                                ...
                                                <? php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<? php echo $count; ?>"
                                                            value="<? php echo $urm->category_id; ?>" /></td>
                                                <?  } ?>
                                                <td><a
                                                        href="<? php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->category_id ?>"><? php echo $urm->name ?></a>
                                                </td>
                                                <td><? php echo $urm->super_category_name ?></td>
                                                <td><? php echo date("d-m-Y", strtotime($urm->added_on)) ?></td>
                                                <td><? php echo $urm->added_by_name ?></td>

                                                <td><? php if (!empty($urm->updated_on)) {
                                                    echo date("d-m-Y", strtotime($urm->updated_on));
                                                } ?>
                                                </td>
