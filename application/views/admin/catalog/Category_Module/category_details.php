    ...
    <? php if ($user_access->view_module == 1) { ?>
        $(document).ready(function () {
            $.ajax({
                ...
                //dataType : "json", 
                data: { "super_category_id": '<?  echo $category_id; ?>', "withPosition": 1, 'sortByPosition': 1, "<? php echo $csrf['name'] ?>": "<? php echo $csrf['hash'] ?>" },
        ...
        <div class="col-md-12 card-body ">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Category Details <?  if ($category_id != 'parents') { ?>
                            <? php if ($user_access->update_module == 1) { ?>
                                <a href="<? php echo MAINSITE_Admin . $user_access->class_name ?>/edit/<? php echo $category_id ?>"
                                    class="btn btn-primary" style="float :right;margin-top: -5px">Update Category Details
                                </a>
                            <?  } ?>
                        <?  } ?><
                    /h3>
                ...
                <div class="box-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <? php if ($is_dropdown == "0") {
                                                            echo "No";
                                                        } else if ($is_dropdown == "1") {
                                                            echo "Yes";
                                                        } ?>
                                                    </td>
                                                    <td>
                                                        <strong class="full">Display on Homepage</strong>
                                                        <? php if ($is_display_home_page == "0") {
                                                            echo "No";
                                                        } else if ($is_display_home_page == "1") {
                                                            echo "Yes";
                                                        } ?>
                                                    </td>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <?  if (!empty($category_icon)) { ?><a
                                                                ...
                                                                target="_blank"><img width="150"
                                                                    src="<? php echo _uploaded_files_ . 'category/' . $category_icon; ?>" /></a><?  } ?><
                                                    /td>
                                                    <td>
                                                        ...
                                                        <?  if (!empty($cover_image)) { ?><a
                                                                ...
                                                                target="_blank"><img width="150"
                                                                    src="<? php echo _uploaded_files_ . 'category/' . $cover_image; ?>" /></a><?  } ?><
                                                    /td>
                                                ...
                                                <tr>
                                                    <td colspan="1">
                                                        ...
                                                        <?  if (!empty($cover_image)) { ?><a
                                                                ...
                                                                target="_blank"><img width="150"
                                                                    src="<? php echo _uploaded_files_ . 'category/' . $header_1_img; ?>"" /></a><?  } ?></td>
                                        <td colspan=" 3">
                    ...
                    <script src="<?  echo MAINSITE ?>assets/administrator/js/jquery.tablednd.js"
                            ...
                            $("#table-2").tableDnD({
                                ...
                                onDrop: function (table, row) {
                                    ...
                                    $.ajax({
                                        ...
                                        //dataType : "json", 
                                        data: { "super_category_id": '<?  echo $category_id; ?>', 'podId': podId, "<? php echo $csrf['name'] ?>": "<? php echo $csrf['hash'] ?>" },
                                        success: function (result) {
                                            // alert(result);
                                            $('#stateList').html(result);
