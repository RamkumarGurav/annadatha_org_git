...
function checkSlugUrl()
{
	...
	$.ajax({
	   type: "POST",
		...
		url:'<?php  echo ADMIN ?>checkCategorySlugUrl',
	   //dataType : "json", 
                ...
                <section class="content">
                   ...
                   <input type="hidden" name="action" id="action" value="" />
                    <input type="hidden" name="category_id" id="category_id" value="<?php  echo $category_id; ?>" />
                        ...
                        <?php  if($alert == "success" || $alert == "fail" || $alert == "update"){?><?php  if($alert == "success") {echo "<div class='alert alert-success'>Record Inseted Successfully.</div>";}else if($alert == "fail"){echo "<div class='alert alert-danger'>Error in updating this input.</div>";}else if($alert == "update"){echo "<div class='alert alert-info'>Record updated Successfully.</div>";}?></span><?php  }?>
                            <div class="box box-primary">
                                ...
                                <div class="box-header with-border row" style="padding:5px;">
                                    ...
                                    <div class="col-md-3 text-right">
                                    	<a href="<?php  echo ADMIN."categories/list"; ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back To Category List</a>
                                    </div> 
                                    <div class="box-body"> 
                                    <div class="">
                                        ...
                                        <?php  echo $this->session->flashdata('alert_message');?>
                                            <div class="row">
                                                <div class="col-md-12"> 
                                                    ...
                                                    <input type="text" name="name" id="name" placeholder="Category Name" class="form-control" value="<?php  echo $name;?>" required > 												<span class="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"></span>
                                                </div>
                                                <div class="form-group" id="is_dropdown_req1" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                        	...
                                        	<input type="radio" class="" name="is_dropdown" id="is_dropdown2" value="0" <?php  if(!$is_dropdown) echo ' checked'; ?> /> No
                                    			...
                                    			<div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:block <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Category Icon <div data-title="Category Icon." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($category_icon)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$category_icon; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$category_icon; ?>" class="img-preview" /></a>
														<?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                         <?php  if(!empty($category_icon) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='category_icon' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                                    </div>
                                    ...
                                    <div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Ads Image Upper <div data-title="Ads Image Upper." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($ads_image)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$ads_image; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$ads_image; ?>" class="img-preview" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                        
                                                        <?php  if(!empty($ads_image) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='ads_image' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                        ...
                                        <input type="text" class="form-control" name="ads_image_url" id="ads_image_url" value="<?php  echo $ads_image_url?>" />        	
                                                    </div>
                                    ...
                                    <div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Ads Image Lower <div data-title="Ads Image Lower." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <mute><em>Image Size : 320 X 190</em></mute>
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($ads_image_lower)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$ads_image_lower; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$ads_image_lower; ?>" class="img-preview" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                        
                                                        <?php  if(!empty($ads_image_lower) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='ads_image_lower' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                        ...
                                        <div class="col-md-6">
                                            <label class="control-label" for="Name">Ads Url Upper <div data-title="Ads Url Upper ." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                        <input type="text" class="form-control" name="ads_image_lower_url" id="ads_image_lower_url" value="<?php  echo $ads_image_lower_url?>" />        	
                                                    </div>
                                    ...
                                    <div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Ads Image 1 <div data-title="Ads Image For Sub Category." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($ads_image_sub_cat)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$ads_image_sub_cat; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$ads_image_sub_cat; ?>" class="img-preview" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                        
                                                        <?php  if(!empty($ads_image_sub_cat) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='ads_image_sub_cat' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                        ...
                                        <input type="text" class="form-control" name="ads_image_sub_cat_url" id="ads_image_sub_cat_url" value="<?php  echo $ads_image_sub_cat_url?>" />        	
                                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group is_parent_field" style=" <?php  if(empty($super_category_id)){ ?> display:none <?php  }else{ ?> display:none <?php  } ?>" >
                                        ...
                                        <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Ads Image 2<div data-title="Ads Image Super Sub Category." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <mute><em>Image Size : 225 X 408</em></mute>
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($ads_image_super_sub_cat)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$ads_image_super_sub_cat; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$ads_image_super_sub_cat; ?>" class="img-preview" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                        
                                                        <?php  if(!empty($ads_image_super_sub_cat) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='ads_image_super_sub_cat' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                        ...
                                        <input type="text" class="form-control" name="ads_image_super_sub_cat_url" id="ads_image_super_sub_cat_url" value="<?php  echo $ads_image_sub_cat_url?>" />        	
                                                    </div>
                                                ...
                                                <div class="col-md-6"> 
                                                    <label class="control-label" for="Name">Cover Image <div data-title="Cover Image." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>
                                                     <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn" style="border:1px solid #ddd"> <?php  if(!empty($cover_image)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$cover_image; ?>" target="_blank"><img width="70" src="<?php  echo _uploaded_files_.'category/'.$cover_image; ?>" class="img-preview" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>  </div>
                                                        <?php  if(!empty($cover_image) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='cover_image' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                                    </div>
                                                ...
                                                <label class="control-label" for="Name">Header Image <div data-title="Header Image." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>  
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                         <?php  if(!empty($header_1_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$header_1_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$header_1_img; ?>" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>
                                                        </div>
                                                        <?php  if(!empty($header_1_img) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='header_1_img' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                                    </div>
                                                </div> 
                                        ...
                                        <input type="text" class="form-control" name="header_1_url" id="header_1_url" value="<?php  echo $header_1_url?>" />
                                                ...
                                                <label class="control-label" for="Name">Footer Image <div data-title="Footer Image1." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>  
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                         <?php  if(!empty($footer_1_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$footer_1_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$footer_1_img; ?>" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>
                                                        </div>
                                                        <?php  if(!empty($footer_1_img) && !empty($category_id)){ ?>
                                                        <a style="margin-left:20px;color:#F00;font-size:18px" onclick="deleteImage(this)" data-table='category' data-column='footer_1_img' data-id='<?php  echo $category_id?>' ><i class="fa fa-trash"></i></a>
                                                        <?php  } ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" style="display:none">
                                        ...
                                        <input type="text" class="form-control" name="footer_1_url" id="footer_1_url" value="<?php  echo $footer_1_url?>" />
                                                ...
                                                <label class="control-label" for="Name">Footer Image 2 <div data-title="Footer Image2." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>  
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                          <?php  if(!empty($footer_2_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$footer_2_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$footer_2_img; ?>" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6"  style="display:none">
                                        ...
                                        <input type="text" class="form-control" name="footer_2_url" id="footer_2_url" value="<?php  echo $footer_2_url?>" />
                                                ...
                                                <label class="control-label" for="Name">Footer Image 3 <div data-title="Footer Image3." class="ico-help icon_title_box"><i class="fa fa-question-circle"></i></div></label>  
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn">
                                                          <?php  if(!empty($footer_3_img)){ ?><a href="<?php  echo MAINSITE_uploaded_files_.'category/'.$footer_3_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$footer_3_img; ?>" /></a><?php  } else{ ?> <img width="70" src="<?php  echo _uploaded_files_.'no-img.png'; ?>" class="img-preview" /> <?php  } ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6"  style="display:none">
                                        ...
                                        <input type="text" class="form-control" name="footer_3_url" id="footer_3_url" value="<?php  echo $footer_3_url?>" />
                                        ...
                                        <div class="col-md-4"> 
                                            ...
                                            <div id="demo1_menu">
                                                <ul>
                                                    <li class="isFolder isExpanded" title="New Parent Category"><a href="0" target="super_category_id,0,<?php  if($super_category_id==0)echo "true";else echo "false"; ?>" > New Parent Category</a>
                                                    <?php  foreach($category_list as $row1){
                                                        if($row1['super_category_id']==0){ ?>
                                                        
                                                        <ul >
                                                        <?php  $liClassExpend='';$liClass = ''; $liFolderCount=0;foreach($category_list as $row2){if($super_category_id==$row2['category_id'])$liClassExpend = 'isExpanded';if($row2['super_category_id']==$row1['category_id'])$liFolderCount++;}if($liFolderCount>0){$liClass = 'isFolder';} ?>
                                                        <?php   ?>
                                                            <li class="<?php  echo $liClass." ".$liClassExpend; ?> " title="Parent Category">
                                                            <a href="0" target="super_category_id,<?php  echo $row1['category_id']; ?>,<?php  if($super_category_id==$row1['category_id'])echo "true";else echo "false"; ?>" ><?php  echo $row1['name']; ?></a>
                                                                <?php  foreach($category_list as $row3){
                                                                    if($row3['super_category_id']==$row1['category_id']){
                                                                     ?>                
                                                                <ul>
                                                                    <?php  $liClassExpend='';$liClass = ''; $liFolderCount=0;foreach($category_list as $row4){if($super_category_id==$row4['category_id'])$liClassExpend = 'isExpanded';if($row4['super_category_id']==$row3['category_id'])$liFolderCount++;}if($liFolderCount>0){$liClass = 'isFolder';} ?>
                                                                    <
                                                                    <li class="<?php  echo $liClass." ".$liClassExpend; ?> " title="Sub Category"><a href="0" target="super_category_id,<?php  echo $row3['category_id']; ?>,<?php  if($super_category_id==$row3['category_id'])echo "true";else echo "false"; ?>"><?php  echo $row3['name']; ?></a>
                                                                        <ul>
                                                                        <?php  foreach($category_list as $row5){
                                                                        if($row5['super_category_id']==$row3['category_id']){ ?>
                                                                            <li class="" title="Super Sub Category"><?php  /*?><a href="0" target="super_category_id,<?php  echo $row5['category_id']; ?>,false"><?php  */?><?php  echo $row5['name']; ?><?php  /*?></a><?php  */?></li>
                                ...
                                <div style="display:none">  
                                    <div class="col-md-12"><p><center><strong>Left Images</strong> size(400px X 250px)</center></p></div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-1">
                                            <?php  if(!empty($left_1_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_1_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_1_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_1_url" id="left_1_url" value="<?php  echo $left_1_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-1">
                                            <?php  if(!empty($left_2_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_2_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_2_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_2_url" id="left_2_url" value="<?php  echo $left_2_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-1">
                                            <?php  if(!empty($left_3_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_3_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_3_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_3_url" id="left_3_url" value="<?php  echo $left_3_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-1">
                                            <?php  if(!empty($left_4_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_4_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_4_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_4_url" id="left_4_url" value="<?php  echo $left_4_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-1">
                                            <?php  if(!empty($left_5_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_5_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_5_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_5_url" id="left_5_url" value="<?php  echo $left_5_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="col-md-8">
                                            <?php  if(!empty($left_6_img)){ ?><a href="<?php  echo _uploaded_files_.'category/'.$left_6_img; ?>" target="_blank"><img width="40" src="<?php  echo _uploaded_files_.'category/'.$left_6_img; ?>" /></a><?php  } ?></div>
                                        </div>                                        
                                        <div class="form-group" >
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                    <div class="input-group input-group-required">
                                                        <input type="text" class="form-control" name="left_6_url" id="left_6_url" value="<?php  echo $left_6_url?>" />
                                                        <div class="input-group-btn">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div style="clear:both"></div>
                                        ...
                                        <div class="demo-radio-button">
                                            ...
                                            <label for="is_display_home_page2">No &nbsp;&nbsp;</label> 
                                                    ...
                                                    <textarea name="short_description" id="short_description" placeholder="Short Description" class="form-control" ><?php  echo $short_description;?></textarea>
                                                	</div>
                                                    ...
                                                    <textarea name="description" id="description" placeholder="Description" class="form-control ckeditor" ><?php  echo $description;?></textarea>
                                                	</div>
                                    ...
                                    <hr>	
                                        ...
                                        <input type="text" class="form-control" required name="slug_url" id="slug_url" value="<?php  echo $slug_url?>" />
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control"  maxlength="60" required name="meta_title" id="meta_title" value="<?php  echo $meta_title?>" />
                                        </div>  
                                        <div class="col-md-3"> 
                                            ...
                                            <input type="text" class="form-control"  maxlength="160" required name="meta_description" id="meta_description" value="<?php  echo $meta_description?>" />
                                        ...
                                        <div class="col-md-3"> 
                                            ...
                                            <input type="text" class="form-control" required name="meta_keyword" id="meta_keyword" value="<?php  echo $meta_keyword?>" />
                                        </div>
                                      </div>
                                    ...
                                    <div class="form-group"  style="display:none">
                                        ...
                                        <div class="col-md-9">
                                                <div class="input-group input-group-required">
                                                    <textarea class="form-control" name="others" id="others" ><?php  echo $others?></textarea>
                                                    <div class="input-group-btn">
                                                    </div>
                                                </div>
                                            </div>
	...
	if(confirm('Do you really want to delete the image?'))
	{
		...
		$.ajax({
		   type: "POST",
			...
			url:'<?php  echo ADMIN ?>catalog/Category-Module/deleteImagesForCategory',
		   //dataType : "json", 
