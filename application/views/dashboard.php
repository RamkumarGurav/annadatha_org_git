							...
							<div class="pddng-24-32">
								<div class="mrgn-bt-56">
									<div class="pddng-bt-24">
										...
										<form class="mt-3" name="personal_info_form" id="personal_info_form"
											onsubmit="update_personal_info()">
											<div id="edit_personal_info_err_msg"></div>
											<div class="pddg-bt-2 row">
												<div class="input1">
													<div class="input2">
														<input type="text" class="inner-inp _2mFmU7 edit_personal_info_field" name="first_name"
															id="first_name" required="" autocomplete="name" tabindex="1"
															value="<?php  echo $profile->first_name ?>" disabled>
													</div>
												</div>
												<div class="input1">
													<div class="input2">
														<input type="text" class="inner-inp _2mFmU7 edit_personal_info_field" name="last_name"
															id="last_name" autocomplete="name" tabindex="1" value="<?php  echo $profile->last_name ?>"
															disabled>
													</div>
												</div>

												<button class="btn-save" type="submit" id="edit_personal_info_btn" style="display:none"
										...
										<script>
											var sess_first_name = '<?php  echo $profile->first_name ?>';
											var sess_last_name = '<?php  echo $profile->last_name ?>';
										...
										<div>
											...
											<label for="Male" class="inner-radio">
												<input type="radio" class="update_profile_gender" <?php  echo ($profile->gender == 'Male') ? "checked" : "" ?> value="Male" name="gender" readonly="" id="Male">

												<!--  <span class="radio-circle"> </span> -->
												<span tabindex="3">Male</span>
											</label>
											<label for="Female" class="inner-radio">
												<input type="radio" class="update_profile_gender" <?php  echo ($profile->gender == 'Female') ? "checked" : "" ?> value="Female" name="gender" readonly=""
													id="Female">
										...
										<div id="hide1">
											<form class="mt-3" name="email_info_form" id="email_info_form" onsubmit="update_email_info()">
												...
												<span class="personal-inf">Email Address</span><span class="edit-2"
													id="edit_email_info">Edit</span>
												<div class="pddg-bt-2 row">
													<div class="input1">
														<div class="input2">
															<input type="email" class="inner-inp _2mFmU7 edit_email_info_field" name="email"
																id="email" required="" tabindex="1" value="<?php  echo $profile->email ?>" disabled>
														</div>
													</div>


													<button class="btn-save" type="submit" id="edit_email_info_btn" style="display:none"
														tabindex="5">SAVE</button>
											...
											<script>
												var sess_email = '<?php  echo $profile->email ?>';
												$(document).ready(function () {
											...
											<form class="mt-4" name="number_info_form" id="number_info_form" onsubmit="update_number_info()">
												...
												<div class="paddng-12"> </div>
												<span class="personal-inf">Mobile Number</span><span class="edit-2"
													id="edit_number_info">Edit</span>
												<div class="pddg-bt-2 row">
													<div class="input1">
														<div class="input2">
															<input type="number" class="inner-inp _2mFmU7 edit_number_info_field" name="number"
																required="" tabindex="1" value="<?php  echo $profile->number ?>"
																style="input[type=number] {-moz-appearance: textfield;}" disabled>
														</div>
													</div>


													<button class="btn-save" type="submit" id="edit_number_info_btn" style="display:none"
														tabindex="5">SAVE</button>
												</div>
											</form>
											<script>
												var sess_number = '<?php  echo $profile->number ?>';
												$(document).ready(function () {
										...
										<div>
											...
											<div>
												...
												<h6>When will my <?php  echo _brand_name_ ?> account be updated with the new email address (or
													mobile number)?</h6>
												<p>It happens as soon as you confirm the verification code sent to your email (or mobile) and
													save the changes.</p>
												<h6>What happens to my existing <?php  echo _brand_name_ ?> account when I update my email address
													(or mobile number)?</h6>
					...
					<div class="manage-class-inner">
						<div class="mng-form-div1">
							<div class="mng-form-inner mng-form-inner11">
								<input type="text" name="name" value="" id="name0" class="mng-form-inpt" autofocus="autofocus"
									required="required">
