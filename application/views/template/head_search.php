<center>
  <div class="row">
            ...
            <div class="thumbnail-container reviews-loading">
              <div class="ttproduct-image ttpc-parent">
                ...
                <div class="ttproducthover ">
                  ...
                  <?php  /*?><?  if (!empty($discount) && $discount>0) { ?><span class="dis_section"> <span><?php  echo $discounted_price?></span><div class="clearfix"></div>OFF</span><?php  } ?><?php  */ ?>
                  <?  if (!empty($discount) && $discount > 0) { ?><span class="dis_section">
                      <span><?php  echo $discount ?></span>
                      <div class="clearfix"></div>OFF
                    </span><?php  } ?>
                  <div class="wishlist">
            ...
            <div class="ttproduct-desc text-center">
              <a href="<?php  echo $product_link ?>" title="<?  echo $product_name; ?> ">
                <div class="product-description">
                  <h2 class="h3 product-title  product-card__title" style="font-size: 13px"><?  echo $product_name; ?>
                    -<?php  echo $combi ?></h2>
                  <div class="product-desc-short"></div>
                  <div class="product-price-and-shipping">
                    <span class="price">₹ <?  echo number_format($final_price) ?></span>
                    <?  if (!empty($discount) && $discount > 0) { ?><span class="sr-only">Price</span>&nbsp;<strike><i
                          class="fa fa-inr"></i> <?  echo number_format($price) ?></strike>&nbsp;<span class="pdisc">Save <i
                          class="fa fa-inr"></i> <?php  echo number_format($discounted_price) ?> Off</span><?php  } ?>
              ...
              <?php  if ($in_store_quantity > 0) { ?>
                ...
                <div class=" productAddShow_<?  echo $product_in_store_id; ?>" <?  if (!empty($prod_in_cart) || $prod_in_cart > 0) { ?> style="display:none;" <?  } ?>>
                  <button type="button"
                    ...
                    data-val="<?  echo $product_in_store_id; ?>,<?  echo $product_id; ?>,<?  echo $product_combination_id; ?>,2">Add
                    to cart</button>
                </div>
                ...
                <div class=" go_to_cart qty_increDecre_<?  echo $product_in_store_id; ?>"
                  ...
                  <button class="adtocart selected_c" <?php  /*?>href="<?php  echo __cart__?>"<?php  */ ?> onclick="cartopenNav()"
                    target="_blank" title="Go to cart">Go to cart</button>
                </div>
    ...
    <?  } else { ?>
      ...
      <div class="row "
        style="clear: both;padding: 20px;font-weight: 600;font-size: 18px;text-shadow: 1px 4px 6px #b1b1b1;">
