...
<div class="manage-address">
  <div class="manage-address-inner">
    ...
    echo form_input($attributes); ?>
    <span class="manage-add"><?php  echo ($customers_address_id > 0) ? "UPDATE ADDRESS" : "ADD A NEW ADDRESS" ?></span>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="mng-form-inner">
          ...
          <script>getState(document.getElementById('country_id<?php  echo $customers_address_id ?>'), 'state_id', '<?php  echo $value ?>', ''); </script>
      ...
      <div class="col-lg-6">
        <div class="mng-form-inner">
          ...
          if (!empty($value)) {
            ?>
            <script> getCity("<?php  echo $state_id ?>", 'city_id', <?php  echo $value ?>)</script>
    ...
    <div class="radio-btn-manage">
      ...
      <div class="inner-gap">
        <div>
          ...
          <?php  $attributes = array('for' => 'address_type');
          echo form_label('', 'address_type', $attributes); ?>
          <?php  $attributes = array('class' => 'inner-radio');
          echo form_label('Home', 'home', $attributes); ?>
          ...
          echo form_label('', 'address_type', $attributes); ?>
          <?php  $attributes = array('class' => 'inner-radio');
          echo form_label('Work', 'work', $attributes); ?>
    ...
    <div class="save-btns">
      <button type="submit" id="submit" name="AddressSaveBTN" value="1" class="save-btn btn">Save and Deliver here
      </button>
      <button class="cancel-btn cancelBTN" type="button" tabindex="11"
        data-id="<?php  echo $customers_address_id ?>">CANCEL</button>
    </div>
  </div>
  <?php  echo form_close() ?>
</div>
