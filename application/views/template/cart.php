									...
									<div class="LazyLoad is-visible">
										<picture class="image-base-imgResponsive">
											<img src="<?php echo $SimagePath . $product_image_name ?>" alt="<?php echo $product_name ?>"
												title="<?php echo $product_name ?>" class="image-base-imgResponsive">
										</picture>
						...
						<div class="itemContainer-base-itemRight ">
							<div class="itemContainer-base-details">
								<div class="row mb-4">
									<div class="col-md-7">
										<div>
											<div class="itemContainer-base-brand"><a
													href="<?php echo $product_link ?>"><?php echo $product_display_name ?></a></div>
											<a class="itemContainer-base-itemLink aClick_1"
												href="<?php echo $product_link ?>"><?php echo $combi ?></a>
										</div>
									...
									<div class="col-md-5">
															...
															<div class="input-group">
																<? if ($in_store_quantity > 0) { ?>
																	<div class="cart_quantiy">
																		<a class="input-group-prepend input-group-addon incToCartListBTNCART"
																			data-val='<?php echo $product_in_store_id ?>,<?php echo $product_id ?>,<?php echo $product_combination_id ?>,1'><span
																				class="glyphicon glyphicon-minus"></a></span>
																		<span
																			class="cart_quntity input-number inptbx cart_increment_<?php echo $product_in_store_id ?>"
																			data-pisd="<?php echo $product_in_store_id ?>"
																			data-pcid="<?php echo $product_combination_id ?>"
																			data-pid="<?php echo $product_id ?>"><?php echo $prod_in_cart ?></span>
																		<a class="input-group-prepend input-group-addon incToCartListBTNCART right"
										...
										<a class=" btn btn1 btn-danger delete incToCartListBTNCART btn btn-danger"
											data-val='<?php echo $product_in_store_id ?>,<?php echo $product_id ?>, <?php echo $product_combination_id ?>,3'>Delete
											<i class="fa fa-trash"></i></a>
										<a class="btn btn1 btn-warning save-for-later cart_wishlist_<? echo $product_in_store_id; ?> addToWishlistListBTNCART"
											data-val="<? echo $product_in_store_id; ?>,<? echo $product_id; ?>,<? echo $product_combination_id; ?>,3">Save
											for Later</a>
		...
		<div class="sticky-price-section">
			<div class="itemContainer-base-item itemContainer-base-item1 ">
				<div class="priceBlock-base-container">
					<div class="priceBlock-base-priceHeader">PRICE DETAILS
						<hr>
					</div>
					<div class="priceBreakUp-base-orderSummary" id="priceBlock">
						<div class="priceDetail-base-row">
							<span>Price (<?php echo $total_prod ?> Items)</span>
							<span class="priceDetail-base-value ">
								<span></span>

								<span> <?php echo $currency->symbol ?> 	<?php echo $total_mrp_price ?></span>
							</span>
						</div>
						<? if (!empty($total_dicount_price)) { ?>
							<div class="priceDetail-base-row">
								...
								<span class="priceDetail-base-value priceDetail-base-discount">
									<span>-</span>
									<span><?php echo $currency->symbol ?> 		<?php echo $total_dicount_price ?></span>
								</span>
							</div>
						<? } ?>
						<? if (!empty($total_packing_charges)) { ?>
							<div class="priceDetail-base-row">
								...
								<span class="priceDetail-base-value priceDetail-base-discount">
									<span>-</span>
									<span><?php echo $currency->symbol ?> 		<?php echo $total_packing_charges ?></span>
								</span>
							</div>
						<? } ?>
						...
						<? if (_is_coupon_required == 1) { ?>
							<? if (!empty($cart_coupon_discount) && !empty($cart_coupon_code)) { ?>
								<div class="priceDetail-base-row">
									...
									?>
									<span>Discount (<?php echo $cart_coupon_code ?> at <?php echo $cart_coupon_discount_value_var ?>)</span>
									<span class="priceDetail-base-value priceDetail-base-discount">
										<span>-</span>
										<span><?php echo $currency->symbol ?>
											<? echo $cart_coupon_discount_value;
											$total -= $cart_coupon_discount_value; ?><a href="<?php echo base_url() . __removeCoupon__ ?>"
												class="close lnr lnr-cross" title="Remove Discount" data-toggle="tooltip" data-placement="bottom"><i
								...
								<div class="priceDetail-base-row">
									...
									<span class="priceDetail-base-value priceDetail-base-discount">
										...
										<div class="cart_tots_2" style="float: right;">
											<form action="<?php echo base_url() . __cart__ ?>" method="post" class="promoform1">
												<input class="custom_form" type="text" id="coupon" name="coupon" required
						...
						<div class="priceDetail-base-total">
							...
							<span class="priceDetail-base-value ">
								<span></span>
								<span><?php echo $currency->symbol ?> 	<?php echo $total + $total_packing_charges ?></span>
							</span>
						</div>
					</div>
				</div>
				<div>
					<a href="<?php echo base_url() ?>all-products" class="aClick_1"><button type="button"
							class="button-base-button" title="Continue Shopping">Continue Shopping <i
								class="fa fa-shopping-cart"></i></button></a>
					<? if (!empty($total) && $total > 0) { ?>
						<a href="<?php echo base_url() . __payment__ ?>" class="aClick_1" title="Checkout"><button type="button"
								class="cart_buton3 btn-chechout">Checkout <span class="glyphicon glyphicon-play"></span></button></a>
					<? } ?>
				</div>
			</div>
		</div>
