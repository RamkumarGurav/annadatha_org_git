					...
					<div class="col-lg-8 col-8">
						<div class="CartItem__Info">
							<h2 class="CartItem__Title Heading">
								<a href="<?php echo $product_link ?>"><?php echo $product_display_name ?> - <?php echo $combi ?></a>
							</h2>
							<div class="CartItem__Meta Heading Text--subdued">
								<div class="CartItem__PriceList"><span class="CartItem__Price Price"
										data-money-convertible=""><?php echo $currency->symbol . ' ' . $final_price ?></span></div>

								<? if (!empty($discount) && $discount > 0) { ?>
									<div class="">
										&nbsp;&nbsp;<strike class="strike"> <i class="fa fa-inr"></i> <? echo $price ?></strike>&nbsp;<span
											class="pdisc1"><span class="pdisc disc-price">You Save: <span><span><i class="fa fa-inr"></i>
														<?php echo $discounted_price ?></span></span></span></span>


									</div>
								<? } ?>
								<? if (!empty($packing_charges)) { ?>
									<p style="color:#12abc3"> Packing charges <?php echo $currency->symbol . ' ' . $packing_charges ?></p>
								<? } ?>
							</div>
									...
									<div class="col-lg-8 col-8">
										...
										<? if ($in_store_quantity > 0) { ?>
											<span class="QtyincreDecre list_detail">
												<button class=" btn-default btn-number incToCartListBTNC"
													data-val='<?php echo $product_in_store_id ?>,<?php echo $product_id ?>,<?php echo $product_combination_id ?>,1'><span
														class="glyphicon glyphicon-minus"></span></button>
												<input type="hidden" class="cart_increment_<?php echo $product_in_store_id ?>"
													value="<?php echo $prod_in_cart ?>"></input>

												<span class="cart_quntity cart_increment_<?php echo $product_in_store_id ?>" style="padding: 10px;"
													data-pisd="<?php echo $product_in_store_id ?>" data-pcid="<?php echo $product_combination_id ?>"
													data-pid="<?php echo $product_id ?>"><?php echo $prod_in_cart ?></span>
												<button class=" btn-default btn-number incToCartListBTNC"
													data-val='<?php echo $product_in_store_id ?>,<?php echo $product_id ?>,<?php echo $product_combination_id ?>,2'><span
														class="glyphicon glyphicon-plus"></span></button>
											</span>
										<? } else { ?>
											<?php echo $stock_out_msg ?><br>Remove Product From Cart
										<? } ?>
									</div>
									<div class="col-lg-4 col-4">
										<a class="cart-remove incToCartListBTNC"
											data-val='<?php echo $product_in_store_id ?>,<?php echo $product_id ?>, <?php echo $product_combination_id ?>,3'>Remove</a>
									</div>
								</div>
							</div>
						</div>
				...
				<?php  /*?><div class="item-base-item">
											<div class="itemContainer-base-item ">
												 <div class="itemContainer-base-itemLeft">
														<a href="<?php  echo $product_link?>" class="aClick_1">
															 <div class="cartbx">
																	<div class="LazyLoad is-visible">
																		 <picture class="image-base-imgResponsive" >
																				<img src="<?php  echo $SimagePath.$product_image_name?>" alt="<?php  echo $product_name?>" title="<?php  echo $product_name?>" class="image-base-imgResponsive"  >
																		 </picture>
												 ...
												 <div class="itemContainer-base-itemRight ">
														<div class="itemContainer-base-details">
															 <div class="row mb-4">
																	<div class="col-md-7">
																		 <div>
																				<div class="itemContainer-base-brand"><a href="<?php  echo $product_link?>"><?php  echo $product_display_name?></a></div>
																				<a class="itemContainer-base-itemLink aClick_1" href="<?php  echo $product_link?>" ><?php  echo $combi?></a>
																		 </div>
																		 <div class="itemComponents-base-sellerContainer">
																				<div class="itemComponents-base-sellerData">Sold by: <?php  echo $brand_name?></div>
																		 </div>
																		 <div class="itemContainer-base-price">
																				...
																				<div class="itemComponents-base-price itemComponents-base-bold ">
																					 ...
																					 <div class="price">
																							<?php  echo $currency->symbol.' '.$final_price?>
																					 </div>
																				</div>
																				 <?  if(!empty($discount) && $discount>0){ ?>
																				<div class="">
																					&nbsp;&nbsp;<strike class="strike"> <i class="fa fa-inr"></i> <?  echo $price ?></strike>&nbsp;<span class="pdisc1"><span class="pdisc disc-price">You Save: <span><span ><i class="fa fa-inr"></i> <?php  echo $discounted_price?></span></span></span></span>
																									...
																									<!--  <div class="input-group">
																										...
																										<?  if($in_store_quantity>0){ ?>
																											<div class="cart_quantiy">
																													<a class="input-group-prepend input-group-addon incToCartListBTNCART" data-val='<?php  echo $product_in_store_id?>,<?php  echo $product_id?>,<?php  echo $product_combination_id?>,1'><span class="glyphicon glyphicon-minus"></a></span>
																														<span class="cart_quntity input-number inptbx cart_increment_<?php  echo $product_in_store_id?>" data-pisd="<?php  echo $product_in_store_id?>" data-pcid="<?php  echo $product_combination_id?>" data-pid="<?php  echo $product_id?>" ><?php  echo $prod_in_cart?></span>
																														<a  class="input-group-prepend input-group-addon incToCartListBTNCART right" data-val='<?php  echo $product_in_store_id?>,<?php  echo $product_id?>,<?php  echo $product_combination_id?>,2'><span class="glyphicon glyphicon-plus"></a></span>
																											 </div>
																	<?  }else{ ?>
																											<?php  echo $stock_out_msg?><br>Remove Product From Cart
														<?  } ?>
																		 ...
																		 <a class=" btn btn1 btn-danger delete incToCartListBTNCART btn btn-danger" data-val='<?php  echo $product_in_store_id?>,<?php  echo $product_id?>, <?php  echo $product_combination_id?>,3'>Delete <i class="fa fa-trash"></i></a>
...
">
				...
				<div class="Form__Item ">
					<textarea name="customer_order_note" id="customer_order_note_sc" class=""
						placeholder="Add a Note"><?php echo $this->session->userdata('application_sess_customer_order_note'); ?></textarea>
				</div>
		...
		<div class="ccc">
			<? if (!empty($total) && $total > 0) { ?>
				<a href="<?php echo base_url() . 'payment' //__payment__ ?>" class="aClick_1" title="Checkout">
					<button type="button" name="checkout" class="cart_buton3 btn-chechout1 ccc">
						<span>Checkout - <?php echo $currency->symbol ?> 		<?php echo $total + $total_packing_charges ?></span>
					</button>
				</a>
			<?php } ?>
		</div>
...
<? } else { ?>
	<article class="cart_tabs_1 clearfix col-lg-12 cart-indi">
		<img src="<?php echo __scriptFilePath__ ?>images/emptycart.png" class="empty_notif_2">

		<!--  <span class="empty_notif_1">your cart is empty</span> -->
		<a href="<?php echo base_url() ?>all-products" class="empty_notif_3" title="Continue Shopping"><button
				class="proceed_ckt"><i class="fa fa-shopping-cart"></i> <span> Continue Shopping</button></a>
	</article>
<? } ?>
