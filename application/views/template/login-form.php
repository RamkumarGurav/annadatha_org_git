...
<a class="Forgotp" id="ex1-tab-3"  data-bs-toggle="pill" href="#ex1-pills-3" role="tab" aria-controls="ex1-pills-3"aria-selected="false"
 ><span>Forgot?</span></a>
                         ...
                         <div class="privacy-text">By continuing, you agree to <?php  echo _project_name_?>
                           <a class="privacy-link" target="_blank" href="<?php  echo base_url(__terms_conditions__);?>">Terms of Use</a> and
                            <a class="privacy-link" target="_blank" href="<?php  echo base_url(__privacy_policy__);?>">Privacy Policy</a>.</div>
...
>
                          ...
                          <!--  <p class="text-center">Didn't Have An Account?</p>
                           <div class="d-flex justify-content-between">
                             <a href="<?php  echo base_url(__forgotPassword__);?>" class="btn common-btn aClick_1">Forgot Password</a>
                               <a href="<?php  echo base_url(__signup__);?>" class="btn common-btn aClick_1">Sign Up Now</a> -->
             </div><br><div class="bottom-txt text-center" style="padding:25px">
             New to <?php  echo _project_name_?>? <a class="bottom-link " href="<?php  echo base_url(__signup__);?>">Create an account</a>
           </div>
                         <?php  echo form_close() ?>
                   <?php  */ ?>
    ...
    <?  if (!empty($username)) { ?>
      ...
      <div class="login-otp">
        ...
        <div><span class="m-number"><?php  echo $username ?>.</span><a class="m-link" onclick="update_username()">Change</a>
        </div>
          ...
          <button class="mb-btn-inner mb-btn-inner1 mb-btn-inner2" type="submit">
            <div class="mb-btn-inner-content mb-btn-inner-content1">
              <svg class="" viewBox="25 25 50 50">
                <circle stroke="#fff" class="" cx="50" cy="50" r="20" fill="none" stroke-width="5" stroke-miterlimit="10">
                </circle>
              </svg>
            </div>
            <span>Verify</span>
     ...
     <label class="mb-input-label">
       <span>Set Password</span>
        ...
        <div class="mb-btn-code">
          ...
          <div class="privacy-text">By continuing, you agree to <?php  echo _project_name_ ?>
            <a class="privacy-link" target="_blank" href="<?php  echo base_url(__terms_conditions__); ?>">Terms of Use</a>
            and
            <a class="privacy-link" target="_blank" href="<?php  echo base_url(__privacy_policy__); ?>">Privacy Policy</a>.
          </div>
          <a href="<?php  echo base_url(__signup__); ?>"><button type="button"
              class=" mb-btn-inner1 mb-btn1-inner-content"><span>New to <?php  echo _project_name_ ?>? Create an
                account</span></button></a>
        </div>
