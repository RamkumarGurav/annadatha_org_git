  ...
  <div class="hide-div-label1">
    <label class="row ">
      <div class="col-lg-1 col-1">
        <input type="radio" checked="checked" class="hide-div-radio" name="payment_type" id="payment_type_1" value="1"
          readonly="">
      </div>
      <div class="col-lg-11 col-11">
        <div class="hide-div-address-pay-options">
          ...
          <span>Credit / Debit / ATM Card (<?php echo $currency->symbol ?> <?php echo $final_payable_amount ?>
            )</span>
...
<div class="hide-div-label1">
  <center><button type="submit" id="payNowBTN" name="orderBTN" value="1" class="subscribe_btn proceed_ckt"> <i
        class="fa fa-credit-card"></i>&nbsp; Pay Now</button></center> <br>
</div>