					...
					<div class="priceBreakUp-base-orderSummary" id="priceBlock">
						<div class="priceDetail-base-row">
							...
							<span class="priceDetail-base-value ">
								...
								<span> <?php  echo $currency->symbol ?> 	<?php  echo round($total_mrp_price) ?></span>
							</span>
						</div>
						...
						<?  if (!empty($total_packing_charges)) { ?>
							<div class="priceDetail-base-row">
								...
								<span class="priceDetail-base-value priceDetail-base-discount">
									<span>-</span>
									<span><?php  echo $currency->symbol ?> 		<?php  echo round($total_packing_charges) ?></span>
								</span>
							</div>
						<?  } ?>
						<?  if (!empty($total_packing_charges)) { ?>
							<div class="priceDetail-base-row">
								...
								<span class="priceDetail-base-value priceDetail-base-discount">
									<span>-</span>
									<span><?php  echo $currency->symbol ?> 		<?php  echo number_format($delivery_charges) ?></span>
								</span>
							</div>
						<?  } ?>
						...
						<?  if (_is_coupon_required == 1) { ?>
								...
								<div class="priceDetail-base-row">
									...
									<span class="priceDetail-base-value priceDetail-base-discount">
										...
										<span><?php  echo $currency->symbol ?>
											...
											$total -= $cart_coupon_discount_value; ?><a
												href="<?php  echo base_url() . __removeCoupon__ ?>" class="close lnr lnr-cross" title="Remove Discount"
												data-toggle="tooltip" data-placement="bottom"><i class="fa fa-trash"></i></a></span>
									</span>
								</div>
							<?  } ?>
							<?php 
							...
							<div class="priceDetail-base-row">
								...
								<span>Shipping <i class="fa fa-info-circle help-tip" aria-hidden="true"
										style="color: #737d11;font-size: 16px;" onclick="$('#ship_modal').modal()"> <span>Shipping will be free
											on order <?php  echo __free_shipping_above__ ?> and above.</span></i></span>
								<span class="priceDetail-base-value priceDetail-base-discount">
									<!--  <span>-</span> -->
									<span> <?php  echo $currency->symbol ?> 		<?php  echo number_format($delivery_charges) ?></span>
								</span>
						...
						<div class="priceDetail-base-total">
							...
							<span class="priceDetail-base-value ">
								<span></span>
								<span><?php  echo $currency->symbol ?>
									<?php  echo round($total + $total_packing_charges + $delivery_charges) ?></span>
							</span>
						</div>
					</div>
				</div>
