									...
									<div class="col-7">
										...
										<div class="itemContainer-base-price">
											...
											<div class="itemComponents-base-price itemComponents-base-bold ">
												<div>
													<?php echo $currency->symbol . ' ' . round($final_price) ?>
												</div>
											</div>
											<? if (!empty($discount) && $discount > 0) { ?>
												<div class="">
													&nbsp;&nbsp;<strike class="strike"> <i class="fa fa-inr"></i>
														<? echo round($price) ?></strike>&nbsp;<span class="pdisc1"><span class="disc-price">You Save:
															<span><span class="itemComponents-base-itemDiscount"><i class="fa fa-inr"></i>
										...
										<? if (!empty($packing_charges)) { ?>
											<p style="color:#12abc3"> Packing charges
												<?php echo $currency->symbol ?> 				<?php echo round($packing_charges) ?>
											</p>
										<? } ?>
									</div>
									<div class="col-5">
														...
														<div class="center">
															<div class="">
																...
																<span class="QtyincreDecre list_detail">
																	<button class="btn btn-default btn-number incToCartListBTNCART"
																	...
																	<input type="hidden" class="cart_increment_<? echo $product_in_store_id; ?>"
																		value="<?php echo $prod_in_cart ?>">
																	<button class="btn btn-default btn-number incToCartListBTNCART"
															...
															<!-- <div class="input-group">
																									<input type="hidden" class="cart_increment_<?php echo $product_in_store_id ?>" value="<?php echo $prod_in_cart ?>">
