    ...
    <div class="card-header">
      ...
      <div class="dropdown drp-dwm-custom show" style="float:right">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          <a class="dropdown-item manageGstInfo" data-id="<?php echo $address->gst_info_id ?>">Edit</a>
          <?php  /*?> <a class="dropdown-item" href="#">Delete</a><?php  */ ?>
        </div>
      </div>
    </div>
    <div class="card-body">
      <h5 class="card-title"><?php echo $address->gst_number ?></h5>
      <p class="card-text"><?php echo $address->company_name ?></p>
      <div class="add_edit_address_cl add_edit_address_<?php echo $address->gst_info_id ?>"></div>
    </div>
  </div>
<? } ?>