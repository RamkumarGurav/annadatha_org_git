<div class="">
                ...
                <div style="margin-top:10px">
                    <label class="row ">
                        <div class="col-lg-1 col-1">
                            <input type="radio" class="hide-div-radio payment_gst_info_radio" <?  if ($gst_info->selected_for_order == 1) {
                                echo "checked";
                            } ?>
                                data-id='<?php  echo $gst_info->gst_info_id ?>' data-idval='<?php  echo $gst_info->gst_info_id ?>'
                                id="<?php  echo $gst_info->gst_info_id ?>" name="address" readonly="" <?  if ($gst_info->gst_info_id == $this->session->userdata('application_sess_cart_page_selected_address_id')) { ?>
                                    checked <?  } ?>>
                        </div>
                        <div class="col-lg-11 col-11">
                            <div class="select-delivery">
                                <div class="select-delivery-inner">
                                    <div class="delivery-username"><?php  echo $gst_info->gst_number ?> |
                                        <?php  echo $gst_info->company_name ?></div>
                                </div>
                            </div>
                        </div>
                    </label>
    ...
    <div class="manage-class-inner row paymentGSTDiv" style="display:none">
        ...
        <div class="save-btns">
            ...
            <button class="cancel-btn cancelBTN" onclick="paymentGSTBtnFunc()" type="button"
                tabindex="11">CANCEL</button>
        </div>
    </div>
    <?php  echo form_close() ?>
</div>
