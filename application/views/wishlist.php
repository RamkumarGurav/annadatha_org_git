...
<div class="container">
         <div class="row ">
            ...
            <div class="col-md-9">
               <h4 class="form_headr1">My Wishlist <?php  if($this->session->userdata('application_sess_wishlist_count') > 0) { ?><span class="wishlist_counts sess_wishlist_count">(<?php  echo $profileWishlistCount->counts?>)</span><?php  } ?></h4>
          ...
          ?>
					...
					<img src="<?php  echo __scriptFilePath__?>images/empty-wishlist.png">
					
                    <a href="<?php  echo base_url()?>all-products" class="empty_notif_3">
