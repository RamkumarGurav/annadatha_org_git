  ...
  foreach ($col['product_combination'] as $row) {
    ...
    if (!empty($cart_coupon_code) && !empty($cart_coupon_discount) && _is_coupon_applicable_on_mrp == 1) {
      if ($row['discount_var'] == 'Rs') {
        ...
        $discount = $currency->symbol . ' ' . $row['discount'];
...
if ($final_cart_amount <= __free_shipping_above__) {
  $delivery_charges = 90;
} else {
  $delivery_charges = 0;
}
...
<div class="deta_prodct">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
        ...
        <div class="l-c-head changeLogin" <? if (empty($temp_name)) { ?> style="display:none" <? } ?>>
          <h3 class="l-c-h3">
            <span class="l-c-span"><?php echo $tab_count ?></span>
          </h3>
          <div class="l-c-div">
            <div class="l-c-login">
              Login
            ...
            <div class="l-c-phone">
              <div>
                <? if (!empty($temp_name)) {
                  ?>
                  <span class="l-c-phone-span" style="font-weight: 600"><?php echo $user->name ?> </span>

                  <span class="l-c-phone-span"><?php echo $user->number ?></span>
              ...
              <? if (!empty($temp_name)) { ?>
                <div class="hide-div-left-content-inner row" <? if (empty($temp_name)) { ?> style="display:none" <? } ?>>
                  <div class="col col-lg-5">
                    <div class="hide-div-left">
                      <div class="hide-div-left-inner">
                        ...
                        <span class="hide-div-phone"><?php echo $user->number ?></span>
                      </div>
                      <div class="hide-div-btn">
                        <a class="hide-div-link" href="<?php echo base_url() . __logout__ ?>"><span>Logout &amp; Sign in
                            to
                            another account</span></a>
                      </div>
                      <div class="hide-div-checkout">
                        <button class="hide-div-checkout-btn changeLoginDivBackBtn"><span>Continue
                  ...
                  <div class="hide-div-please-note row">
                    <span>Please note that upon clicking "Logout" you will lose all items in cart and will be redirected
                      to Bionovastore home page.</span>
                  </div>
                </div>
              <?
              }
                    ...
                    <h3 class="l-c-h3">
                      ...
                      <div class="l-c-div">
                        ...
                        <div class="l-c-phone"><div>
                          <span class="l-c-phone-span" style="font-weight: 600"><?php  echo (!empty($user->name))?$user->name:''?></span>
                          <span class="l-c-phone-span">+91<?php  echo (!empty($user->number))?$user->number:''?></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="hide-div-left-content-inner row">
                      <div class="col col-5-12">
                        <div class="hide-div-left">
                          <div class="hide-div-left-inner">
                            <span class="hide-div-phone-h">Phone</span>
                            <span class="hide-div-phone">+91<?php  echo $user->number?></span>
                          </div>
                          <div class="hide-div-btn">
                      ...
                      <div class="hide-div-right-content col col-7-12">
                        ...
                        <div class="hide-div-please-note row">
                          <span>Please note that upon clicking "Logout" you will lose all items in cart and will be redirected to <?php  echo _brand_name_?> home page.</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="leftside-checkout-inner">
              <div class="lefside-checkout-content">
                <div class="l-c-head tab2_head" style="display:none">
                  <h3 class="l-c-h3">
                    <span class="l-c-span"><? $tab_count++; ?><?php echo $tab_count ?></span>
                  </h3>
                  <div class="l-c-div">
                ...
                <div class="l-c-head changeAddress tab2_selected" style="display:none">
                  <h3 class="l-c-h3">
                    <span class="l-c-span">2</span>
                  </h3>
                  <div class="l-c-div">
                    <div class="l-c-login">DELIVERY ADDRESS
                      <svg height="10" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="_1t8m48">
                        <path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" stroke="#859212"></path>
                      </svg>
                    </div>
                    <div class="l-c-phone">
                      <div>
                ...
                <div class="hide-div changeAddressDiv tab2_selection">
                  <h3 class="hide-div-heading">
                    <span class="hide-div-span1"><?php echo $tab_count ?></span>
              ...
              <div class="l-c-head tab3_head">
                ...
                <div class="l-c-div">
                  ...
                  <div class="l-c-div">
                    ...
                    <div class="l-c-phone">
                      <div>
                        <span class="l-c-phone-span"><?php echo $total_prod ?> Items</span>
                      </div>
                    </div>
                  </div>
                ...
                <a href="<?php echo base_url(__cart__) ?>" class="l-c-change-btn" id="show">Change</a>
              </div>
                ...
                <div class="hide-div tab3_selection" style="display: none;">
                  <div class="hide-div-content1">
                    ...
                    <div class="hide-div-label">
                      <div class="row ">
                        <a href="" data-bs-toggle="modal" data-bs-target="#func_gst_info_modal_icon"
                          class="delivery-pincode1">
                          <input type="checkbox"> Use This GST</a>
                        <div class="gst-no"> <? if (!empty($user->gst_info)) { ?>
                            <? foreach ($user->gst_info as $gi) { ?>
                              <? if ($gi->is_selected == 1) { ?>
                                <span><input type="checkbox" class="gst_info_cl" id="_gst_info" <? if ($gi->selected_for_order == 1) {
                                  echo "checked";
                                } ?>
                                    data-id="<?php echo $gi->gst_info_id ?>" /></span>
                                <?
                    ...
                    <div class="hide-div-label">
                      <div class="row ">
                        ...
                        <span id="func_update_email_info_modal_span">
                          ...
                          if (!empty($user->email)) {
                            ?>
                            Email goes to <?php echo $user->email ?>
                          <?
                          } else {
                            ?>
                        ...
                        <?php  /*?><button class="l-c-change-btn" id="show">Change</button><?php  */ ?>
                        <a href="" data-bs-toggle="modal" data-bs-target="#func_update_email_info_modal"
                          id="func_update_email_info_modal_a" onclick="changeEmail()" class="delivery-pincode">
                          <?php echo (!empty($user->email)) ? "Update" : "Add" ?> Your email</a>
            ...
            <div class="leftside-checkout-inner">
              <div class="lefside-checkout-content">
                ...
                <div class="hide-div tab4_selection" style="display:none">
                  <h3 class="hide-div-heading">
                    <span class="hide-div-span1"><? $tab_count++; ?><?php echo $tab_count ?></span>
                    <span class="hide-div-span2">PAYMENT OPTIONS</span>
                  </h3>
                  <form action="<?php echo base_url() . 'pay-now' ?>" id="pay-now" onsubmit="myFunction()" method="post">
                    <div class="hide-div-content1">

                      <div class="hide-div-label1">
                        <label class="row ">
                          <div class="col-lg-1 col-1">
                            <input type="radio" checked="checked" class="hide-div-radio" name="payment_type"
                              id="payment_type_1" value="1" readonly="">
                          </div>
                          <div class="col-lg-11 col-11">
                            <div class="hide-div-address-pay-options">


                              <span>Credit / Debit / ATM Card (<?php echo $currency->symbol ?>
                                <?php echo $final_payable_amount ?> )</span>
                    ...
                    <? if (!empty($ship_details) && $ship_details->is_cod_available == 1) {
                      ...
                      <? if (_is_cod == 1 && $cart_value <= _cod_max_cart_value) { ?>
                        <?php  /*?><a onclick="order_cod_func()" class="subscribe_btn proceed_cod"><i class="fa fa-money"></i>&nbsp; COD (<?php  echo $currency->symbol?> <?php  echo number_format($total + $ship_details->cod_charges)?>)</a><?php  */ ?>
                        ...
                        <div class="hide-div-content1">
                          ...
                          <div class="hide-div-label1">
                            <label class="row ">
                              <div class="col-lg-1 col-1">
                                <input type="radio" class="hide-div-radio" name="payment_type" id="payment_type_2" value="2"
                                  readonly="">
                              </div>
                              <div class="col-lg-11 col-11">
                                <div class="hide-div-address-pay-options">
                                  ...
                                  ?>
                                  <span>Cash on Delivery (<?php echo $currency->symbol ?>       <?php echo $cod_total ?>)</span>
                                  <span class="span-cus">COD Charges : <?php echo $ship_details->cod_charges ?></span>
                    ...
                    <div class="hide-div-label1">
                      <center><button type="submit" id="payNowBTN" name="orderBTN" value="1"
                          class="subscribe_btn proceed_ckt"> <i class="fa fa-credit-card"></i>&nbsp; Pay Now</button>
                      </center> <br>
                    </div>
                  </form><br>
                </div>
    ...
    <?php  /*?><form action="<?php  echo base_url().'pay-now'?>" onsubmit="myFunction()"  method="post">
            <div class="paymentBtn-flex">
  <a href="<?php  echo base_url().__cart__?>" class="payment-ship-link1"><em class="fa fa-angle-double-left"></em> Update cart</a>
    ...
    else
    {
     ...
     ?>
                   <?  if(_is_cod == 1 && $cart_value >= _cod_min_cart_value && $cart_value <= _cod_max_cart_value){ ?>
              <a onclick="order_cod_func()" class="subscribe_btn proceed_cod"><i class="fa fa-money"></i>&nbsp; COD (<?php  echo $currency->symbol?> <?php  echo number_format($total + $ship_details->cod_charges)?>)</a>
                <?  } ?>
              <?  } ?>


  <button type="submit" id="payNowBTN" name="orderBTN" value="1" class="subscribe_btn proceed_ckt">  <i class="fa fa-credit-card"></i>&nbsp; Pay Now (<?php  echo $currency->symbol?> <?php  echo $total?>)</button>
...
<script type="text/javascript">
  ...
  function editDeliverHereAddress(id) {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url() ?>dashboard/editDeliverHereAddress',
      dataType: "json",
  ...
  function editAddress(id) {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url() ?>dashboard/editUpdateAddressPayment',
      //dataType : "json",
      data: { 'customers_address_id': id },
      success: function (result) {
        $('.loader').hide();
  ...
  function do_ship_address(id) {
    $("#ship_address").submit(function () {
      ...
      $.ajax({
        type: "POST",
        url: '<?php echo base_url() ?>dashboard/do_ship_address_payment',
        dataType: "json",
...
<div class="modal fade" id="func_gst_info_modal_icon" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
...
<div class="modal fade" id="func_update_email_info_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-custom1 ">
    <div class="modal-content">
      <div class="modal-header modal-header2">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><?php echo (!empty($user->email)) ? "Update" : "Add" ?>
          Your
          email</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">✕</button>
      </div>
      <form name="update_email_form" id="update_email_form" onsubmit="func_update_email_form()">
          ...
          <div class="modal-body modal-body2 func_update_email_info_modal_body">
            <div class="manage-class-inner row">
              ...
              <div class="mng-form-inner">
                <input type="text" name="email" id="email" value="<?php echo $user->email ?>" class="mng-form-inpt">
                <label for="Email" class=" mng-form-label">&nbsp;&nbsp;Email</label>
              </div>


            </div>
            <!--  <input type="email" required name="email" id="email" value="<?php echo $user->email ?>" /> -->
        ...
        <div class="emailOTPInput" id="emailOTPInput" style="display:none">
          OTP sent to <span id="email_send_to"></span> <button type="button" class="btn btn-info"
            onclick="changeEmail()"> Change</button>
          <input type="number" pattern="[0-9]{6,6}" class="mng-form-inpt mt-2" title="Enter 6 digit OTP" name="otp"
            id="otp_email_e" value="" / style="padding:0 !important">
          <label for="name" class=" mng-form-label">Enter OTP</label>
        </div>

        <a class="resend_otp" id="otp_func_e" style="display:none" onclick="password_change_otp_func_e()">
          <div class="otp-text-last">Not received your code? <span>Resend code</span></div>
        </a>
          ...
          <button class=" continue2" type="submit">
            <div class="mb-btn-inner-content mb-btn-inner-content1">
              <svg class="" viewBox="25 25 50 50">
                <circle stroke="#fff" class="" cx="50" cy="50" r="20" fill="none" stroke-width="5"
...
<script>
  function func_update_email_form() {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo MAINSITE ?>Dashboard/doUpdateEmailForm/',
  ...
  window.addEventListener('load', function () {
    $("#func_gst_info_modal_icon").on('show.bs.modal', function () {
      ...
      $.ajax({
        type: "POST",
        url: '<?php echo MAINSITE ?>Dashboard/getPaymentpageGstInfo/',
        data: {},
        success: function (result) {
          $('.loader').hide();
    ...
    $(document).on('change', '.payment_gst_info_radio', function () {
      ...
      $.ajax({
        type: "POST",
        url: '<?php echo base_url() ?>dashboard/editSelectedGstInfo',
        dataType: "json",
    ...
    $(document).on('change', '#_gst_info', function () {
      ...
      $.ajax({
        type: "POST",
        url: '<?php echo base_url() ?>dashboard/editSelectedGstInfoForOrder',
        dataType: "json",
  ...
  window.addEventListener("load", function () {
    ...
    <? if (empty($user->number) && !empty($temp_name)) { ?>
      ...
      $("#updateContactForm").submit(function (e) {
        ...
        $.ajax({
          url: "<?php echo base_url() . 'updateContact' ?>",
          type: 'post',
          dataType: 'json',
...
<script>
  ...
  function setRegisterForm() {
    $("#registration_form").submit(function (event) {
      ...
      $.ajax({
        type: "POST",
        //url:$('.siteUrl').val()+'products/loadMoreProduct',
        url: '<?php echo base_url(__signup__) . '/auth' ?>',
        /*dataType : "json",*/
  ...
  function gst_info_form_submit() {
    ...
    $.ajax({
      type: "POST",
      url: '<?php echo base_url() ?>dashboard/do_gst_info_payment_form',
      dataType: "json",
