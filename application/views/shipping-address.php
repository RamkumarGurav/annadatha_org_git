            ...
            <div class="pddng-24-32">
              <div class="pddng-bt-56">
                <div class="pddng-bt-24 allAddressCl">
                  ...
                  <?php  if (!empty($customer_address_data->address)) { ?>
                    <?php  $this->load->view('template/customers_address', $this->data); ?>
                  <?php  } else { ?>
                        ...
                        <div class="shipping-address">
                          <div class="shipping-address-inner">
                            <div class="shipping-address-center">
                              ...
                              <?php  /*?><span class="add-delivery">Add a delivery address.</span><?php  */ ?>
                              <button class="add-addr-btn manageAddress noAddress" type="button" data-id="0" id="hide">ADD
                                ADDRESSES</button>
                            </div>
                          </div>
                        </div>
                    ...
                    <?php  //$this->load->view('template/cart' , $this->data); ?>
                  <?php  } ?>
...
<div id="smartblog_block" class="block products_block hb-animate-element bottom-to-top hb-in-viewport">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="editmodal_body">
            <form action="#" method="post" onSubmit="submitAddressForm()" id="user_address_form"
              name="user_address_form" style="display:block;" class="shping-add" accept-charset="utf-8">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      ...
                      <input type="text" name="name" value="" id="name" placeholder="Full Name" class="form-control"
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      ...
                      <input type="text" name="number" value="" id="number" class="form-control"
                        placeholder="Contact Number" pattern="[0-9]{10,10}" title="Enter only number between 0-9"
                        required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" name="address3" value="" id="address3" class="form-control"
                        placeholder="Address Line 3" required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <select name="state_id" id="state_id" value="" class="form-control" type="text"
                        onChange="getCity(this , 'city_id' , 0)" required="required">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-3">
                      <input type="text" name="zipcode" value="" id="zipcode" class="form-control" placeholder="Pincode"
                        pattern="[0-9]{6,6}" title="Enter only number between 0-9" required="required">
  ...
  <script type="text/javascript">
    ...
    function editAddress(id) {
      ...
      $.ajax({
        type: "POST",
        url: '<?php  echo base_url() ?>dashboard/editUpdateAddress',
        //dataType : "json",
    ...
    function do_ship_address(id) {
      ...
      $("#ship_address").submit(function () {
        ...
        $.ajax({
          type: "POST",
          url: '<?php  echo base_url() ?>dashboard/do_ship_address',
          dataType: "json",
