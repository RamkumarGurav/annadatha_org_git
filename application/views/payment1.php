         ...
         <div class="col-lg-7 pddng0">
            <div class="leftside ">
               <div class="text-center">
                  <img src="http://mars-500/xampp/MARS1/greenfieldeco/assets/front/images/logo.jpg"
                     alt="<?php echo _project_name_ ?>" title="<?php echo _project_name_ ?>" class="img-fluid"
                     style="width: 100px;margin-top: 20px">
                  <nav class="breadcrumb mt-3 mb-3" style="    ">
                     <ol>
                        <li><span>Home &nbsp;<i class="fa fa-angle-right"></i>&nbsp; Cart &nbsp;<i
                                 class="fa fa-angle-right"></i>&nbsp; Information &nbsp;<i
                                 class="fa fa-angle-right"></i>&nbsp; Shipping &nbsp;<i
                                 class="fa fa-angle-right"></i>&nbsp; Payment</span></li>
                     </ol>
                  </nav>
               </div>
               <div class="row">
                  ...
                  <div class="col-lg-6"><span class="_19gi7yt0 _19gi7ytf _1fragem1i">Already have an account? <a
                           href="#">Log in</a></span></div>
               </div>
               <div class="form-group">
                  <input id="email" name="email" placeholder="Enter an email or phone number" type="text"
               ...
               <div class="form-group">
                  ...
                  <label for="Select0" class="QOQ2V NKh24"><span class="KBYKh"><span
                           class="rermvf1 _1fragem7i _1fragem7k _1fragem14">Saved addresses</span></span></label>
                  <select name="countryCode" id="Select0" placeholder="country" required=""
                     autocomplete="shipping country" class="form-control ct-inp">
                     <option value="IN">India</option>
                  </select>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-6">
                     <input id="TextField0" name="firstName" placeholder="First Name" required="" type="text"
                        class="form-control ct-inp">
                  </div>
                  <div class="col-lg-6">
                     <input id="TextField0" name="firstName" placeholder="Last Name" required="" type="text"
                        class="form-control ct-inp">
                  </div>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-12">
                     <input id="TextField0" name="firstName" placeholder="Company Name and GSTIN (Optional)" required=""
                        type="text" class="form-control ct-inp">
                  </div>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-12">
                     <input id="TextField0" name="firstName" placeholder="Address Line 1" required="" type="text"
                        class="form-control ct-inp">
                  </div>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-12">
                     <input id="TextField0" name="firstName" placeholder="Address Line 2 (Apt, Flat Number)" required=""
                        type="text" class="form-control ct-inp">
                  </div>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-4">
                     <input id="TextField0" name="firstName" placeholder="City" required="" type="text"
                        class="form-control ct-inp">
                  </div>
                  <div class="col-lg-4">
                     <select name="zone" id="Select1" placeholder="City" class="form-control ct-inp" required=""
                        autocomplete="shipping address-level1" class="_b6uH RR8sg vYo81 RGaKd">
                  ...
                  <div class="col-lg-4">
                     <input id="TextField0" name="firstName" placeholder="PIN code" required="" type="text"
                        class="form-control ct-inp">
                  </div>
               </div>
               <div class="form-group row mt-2">
                  <div class="col-lg-12">
                     <input id="TextField0" name="firstName" placeholder="Phone Number" required="" type="text"
                        class="form-control ct-inp">
                  </div>
               </div>
               <div class="mt-2 mb-4">
               ...
               <div class="row mt-3 align-items-center justify-content-center">
                  <div class="col-lg-6">
                     <a href="#" class="QT4by eVFmT j6D1f janiy adBMs"><i class="fa fa-angle-left"></i> Return to
                        cart</a>
                  </div>
                  <div class="col-lg-6">
            ...
            <div class="rightside mt-5">
                     ...
                     foreach ($col['product_combination'] as $row) {
                        ...
                        if (empty($temp_currency_id) || $temp_currency_id == 1) {
                           if (!empty($cart_coupon_code) && !empty($cart_coupon_discount) && _is_coupon_applicable_on_mrp == 1) {
                              if ($row['discount_var'] == 'Rs') {
                                 ...
                                 $discount = round($row['discount']) . ' ' . $row['discount_var'];
                                 $discount = trim($discount);
                              }
                              $discount = '';
                              $price = $row['price'];
                           ...
                           if (!empty($coupon_discount) && !empty($coupon_code)) {
                              if ($row['discount_var'] == 'Rs') {
                                 ...
                                 $discount = $currency->symbol . ' ' . $row['other_discount'];
                                 $discount = trim($discount);
                              } else {
                        ...
                        <div class="row  align-items-center justify-content-center">
                           <div class="col-lg-2 col-3">
                              <img src="<?php echo $SimagePath . $product_image_name ?>" alt="<?php echo $product_name ?>"
                                 title="<?php echo $product_name ?>" style="width:50px">
                              <span class="prod-count"><?php echo $prod_in_cart ?></span>
                           </div>
                           <div class="col-lg-5 col-8 pddng-lr">
                              <div class="CartItem__Info">
                                 <h2 class="CartItem__Title Heading">
                                    <a href="<?php echo $product_link ?>"><?php echo $product_display_name ?> -
                                       <?php echo $combi ?></a>
                                 </h2>
                              </div>
                           </div>
                           <div class="col-lg-5 col-4">
                              <div class="price1">
                                 <h3><?php echo $currency->symbol . ' ' . ($final_price * $prod_in_cart) ?></h3>
                              </div>
                           </div>
                        </div>
                     <? }
               ...
               <div class="form-group row align-items-center justify-content-center">
                  <div class="col-lg-7 col-7">
                     <input id="email" name="email" placeholder="Gift card or discount code" type="text"
                        class="form-control ct-inp">
                  </div>
               ...
               <div class="form-group row align-items-center justify-content-center mt-2">
                  <div class="col-lg-6">
                     <p class="price-d">Shipping <a href="" data-bs-toggle="modal" data-bs-target="#myModal"><i
                              class="fa fa-question-circle-o"></i></a></p>
                  </div>
                  <div class="col-lg-6">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <body class="page-policies default-background text-container">
                  <p><strong>[These terms form part of the Terms &amp; Conditions relating to access of the website
                        including the mobile applications. For other terms, kindly refer to Terms &amp; Conditions’
                        section]</strong></p>
                  <p><em>ModernQuests.com and its mobile applications are defined as
                        "Website"<span>&nbsp;</span><br>Quests Creative Private Limited is defined as “Company”, “We”,
                        “Our” or “Us”<br></em><em>User of website/mobile applications is defined as “You” or “Your”</em>
                  </p>
                  <p>For the time being, We only process orders for delivery within India.</p>
                  <p>Your shipping address, city, state and pin code will be verified before shipping the product. If
                     Your order cannot be delivered by Our delivery partners, We shall request You to provide Us with a
                     different shipping address that can be serviced by Our delivery partners. If there is any dispute
                     regarding the delivery of any order to the shipping address specified by You that is not covered by
                     Our delivery partners, the Company shall not be held responsible for not delivering the products.
                     If the order has already been paid for, the refund will be processed directly back to Your credit
                     card, debit card or bank account or any other payment method used for the transaction. For Cash On
                     Delivery orders, no refund shall be given as no payment has been collected by the Company.</p>
                  <p>Depending on the value of the order placed by You, the product(s) may have to be shipped in
                     different batches or consignments, for which an intimation shall be sent to You.</p>
                  <p>Before processing, dispatching or delivering any product or service to You, the Company may request
                     You to provide documents supporting Your identity. These documents may include, but are not limited
                     to, an identification or residence proof issued by the Government of India, to establish the
                     ownership of the instrument of payment used by You for the purchase of a product or service.</p>
                  <p><span>We usually get most orders delivered within 2 to 8 working days from the date of Order
                        Acceptance. Based on Your location, an estimate of delivery period is provided when completing
                        the checkout process. The estimated days mentioned regarding dispatch and delivery times are for
                        guidance only. The Website or the Company shall not be held liable to meet such estimated
                        dispatch and delivery guidelines. In case of any delays in delivery of a product that occur
                        because of reasons beyond Our control, We shall not be held responsible for the same.</span></p>
