               ...
               <div class=" footer__item--40cc8690-9f76-4648-82d9-1632b26486a0 footer-logo">
                  <div class="text-start">
                     <div class="footerlogo">
                        <h1 class="site-title"><a class="navbar-brand home-link" href="<?php echo base_url() ?>"><span
                                 class="themestek-sc-logo themestek-sc-logo-type-image"><img
                                    src="<?php echo IMAGE ?>logo.jpg" alt="<?php echo _project_complete_name_ ?>"
                                    title="<?php echo _project_complete_name_ ?>"></span></a></h1>
                     </div>
                     <div class="footer-content-p">
                        <p>With a rich legacy spanning over three decades, we've been a trusted name in providing
                           farmers with the finest quality pesticides, seeds, and fertilizers.</p>
                     </div>
                     ...
                     <div class="text-start">
                        <ul class="dt-sc-social-icons dt-sc-list-inline">
                           ...
                           <?php if (_TWITTER_ != '') { ?>
                              <li><a class="icon-fallback-text twitt hexagon" target="blank" href="<?php echo _TWITTER_ ?>"
                                    title="Twitter"><i class="fa fa-twitter" aria-hidden="true"></i><span
                                       class="icon__fallback-text">Twitter</span></a></li><?php } ?>
                           <?php if (_FACEBOOK_ != '') { ?>
                              <li><a class="icon-fallback-text fb hexagon" target="blank" href="<?php echo _FACEBOOK_ ?>"
                                    title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i><span
                                       class="icon__fallback-text">Facebook</span></a></li><?php } ?>
                           <?php if (_INSTAGRAM_ != '') { ?>
                              <li><a class="icon-fallback-text ins" target="blank" href="<?php echo _INSTAGRAM_ ?>"
                                    title="Instagram"><i class="fa fa-instagram" aria-hidden="true"></i><span
                                       class="icon__fallback-text">Instagram</span></a></li><?php } ?>
                           <?php if (_LINKEDIN_ != '') { ?>
                              <li><a class="icon-fallback-text linked-in" target="blank" href="<?php echo _LINKEDIN_ ?>"
                                    title="Linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i><span
                                       class="icon__fallback-text">Linkedin</span></a></li><?php } ?>
                           <?php if (_YOUTUBE_ != '') { ?>
                              <li><a class="icon-fallback-text youtube" target="blank" href="<?php echo _YOUTUBE_ ?>"
                                    title="Youtube"><i class="fa fa-youtube" aria-hidden="true"></i><span
                                       class="icon__fallback-text">Youtube</span></a></li><?php } ?>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class=" footer__item--28a557d9-cccb-40c8-a425-5693a91b930e footer-links">
                  <div class="text-start">
                     ...
                     <ul class="footer_menu dt-sc-list">
                        ...
                        <li><a href="<?php echo base_url() . __contactUs__ ?>">Contact Us</a></li>
                        ...
                        <li><a href="<?php echo base_url(__all_category__); ?>">All Categories</a></li>
                     </ul>
                  </div>
               </div>
               ...
               <div class=" footer__item--0473b0bd-2277-48da-92bb-02945f481fa5 footer-newsletter">
                  <div class="text-start">
                     ...
                     <ul class="contact-info">
                        <li class="address">
                           <address> <i class="fa fa-map-marker"></i><?php echo _project_address_ ?></address>
                        </li>
                        <li class="contact-phone"><i class="fa fa-phone"></i><?php echo _project_contact_ ?></li>
                        <li class="office-mail"><a href="mailto:<?php echo _project_email_ ?>"><i
                                 class="fa fa-envelope"></i><?php echo _project_email_ ?></a></li>
                     </ul>
         ...
         <div class="row">
            <div class="dt-sc-flex-space-between">
               <div
                  ...
                  <p>©
                     <script>document.write(new Date().getFullYear())</script> - <?php echo _project_name_ ?></a>
...
<div class="message productUpdateShow" id="fix-content">
   <p id="popMsg">Your cart has Updated </p><span class="fa fa-times message-cross" onclick="hidePOpOver()"></span>
</div>
<div class="pc_whatsapp"><a
      href="https://api.whatsapp.com/send?phone=<?php echo _project_contact_whatsapp_without_space_ ?>&amp;text=<?php echo _project_contact_whatsapp_message_ ?>"
      target="_blank" class="whatsapp"><img src="<?php echo IMAGE ?>whatsapp.png" alt="Connect Us"></a></div>
...
<script src="<?php echo JS ?>footer.js"></script>
<?php if (!empty($js)) {
   foreach ($js as $j) {
...
<a id="btn-back-to-top" onclick="topFunction()" class="dt-sc-to-top dt-sc-btn" style="display: block;"><i
...
<div role="alert" aria-live="assertive" aria-atomic="true" id="toast_id" class="toast toast-success"
   data-autohide="false" style="    position: fixed;
    top: 11px;
    right: 10px;
    float: right;
    z-index: 9999999;">
