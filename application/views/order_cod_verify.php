<div class="main_banner prodct_sec1 container">
	<div class="row">
		...
		<div class="prodct_det2 product_cnt">
			<form action="<?php echo base_url() . 'place-cod-order' ?>" name="place_cod_order_form" id="place_cod_order_form"
				method="post" onsubmit='return  verify_otp()'>
				<div class="form-group position-R">
					<input type="number" name="o_otp" id="o_otp" class="profil_form" minlength="6" maxlength="6"
						autofocus="autofocus" placeholder="Enter OTP" required="required">
					<span class="placeholder_label">Enter OTP</span>
				</div>
				<button class="login_butn1" name="o_otp_btn" id="o_otp_btn" value="1" type="submit"
					style="margin-bottom:10px;">Verify OTP and Place Order</button>

			</form>


			<button class="login_butn1" style="display:none" name="resend_otp_btn" id="resend_otp_btn" value="1" type="button"
				onclick="resend_otp()">Re-Send OTP</button>
