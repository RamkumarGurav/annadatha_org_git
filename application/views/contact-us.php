<section class="brdcrm-bck">
	<div class="container"><a href="<?php  echo base_url(); ?>" title="Back to the frontpage">Home</a><span
			aria-hidden="true" class="breadcrumb__sep"> / </span><span>Contact Us</span></div>
</section>
				...
				<ul class="dt-contact-iconblock-section ">
					<li class="dt-contact-icon-block">
						...
						<div class="dt-contact-icon-content">
							<h4>Phone</h4>
							<p> <b>Toll-Free: </b> <?php  echo _project_contact_ ?> </p>
						</div>
					</li>
					<li class="dt-contact-icon-block">
					...
					<li class="dt-contact-icon-block">
						...
						<div class="dt-contact-icon-content">
							<h4>Address</h4>
							<p><?php  echo _project_address_ ?></p>
						</div>
					</li>
				</ul>
			</div>
			<div class="col-lg-4">
				<div id="map mt-3"><iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887150.3253291342!2d75.30627358359817!3d17.930043778181616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcc69d4bbcd1f19%3A0xc5363cbd4f4f4875!2sSri%20annadatha%20rythu%20seva%20kendram!5e0!3m2!1sen!2sin!4v1693946883138!5m2!1sen!2sin"
						referrerpolicy="no-referrer-when-downgrade" width="1920" height="550" style="border:0;" allowfullscreen=""
