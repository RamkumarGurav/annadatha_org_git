							...
							<div class="user-area">
								...
								<div class="user-item">
									...
									<div class="d-flex justify-content-between">
										<h5><span>
												<a class="resend_otp" style="cursor: pointer" id="otp_func"
													onclick="password_change_otp_func()">Click to get OTP</a>
												<a class="resend_otp" id="otp_func_count" style="display:none"></a>

											</span><br><br> </h5>
										<button name="changePasswordInfoBTN" id="changePasswordInfoBTN" value="1" type="submit"
											class="btn common-btn">Update</button>
