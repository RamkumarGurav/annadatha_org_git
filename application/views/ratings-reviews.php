                    ...
                    <div class="add_edit_address_0" id="show1" style="display:none">
                      ...
                      <div class="manage-address">
                        <div class="manage-address-inner">
                          <form action="http://mars-500/xampp/MARS1/greenfieldeco/shipping-address" method="post"
                            id="ship_address" style="display:block;" class="shping-add" accept-charset="utf-8">
                            ...
                            <div class="manage-class-inner manage-class-inner2">
                              ...
                              <div class="save-btns">
                                <button type="submit" id="submit" name="AddressSaveBTN" value="1" class="save-btn">Save
                                </button>
                              </div>
                            </div>
                          </form>
