            ...
            <div class="empty1 mb-5">
               <div class="bagaininner">
                  ...
                  if (!empty($orders)) {
                     ...
                     <div class="row ">
                        ...
                        <div class="edit_profle col-md-5 float-right">
                           <div class="form-group order_histpory_filter flex-row align-items-center">
                              ...
                              <select class="profil_form col-md-6" id="cus_orders_sel" onChange="On_cus_orders_sel()">
                     ...
                     foreach ($orders as $o) {
                        $ocount++;
                        $order_status_arr[] = $o->order_status; ?>
                        ...
                        <div class="ordersBox orderpro_<?php echo $o->order_status ?> dispatched"
                           data-order_status="<?php echo $o->order_status ?>"> <!--class="cus_orders"-->
                           <div class="ordersmllbox">
                              <div class="icon"><span class="fa fa-truck"></span></div>
                              <div class="status">
                                 <?php echo $o->order_status_display_user ?>
                              </div>
                              <div class="date"><span
                                    class="fa fa-clock-o"></span><?php echo date("D, d M y", strtotime($o->added_on)) ?>
                              </div>
                              <div class="Amt">Order Amount : <?php echo $o->symbol ?>       <?php echo $o->total ?></div>
                              <div class="totalQty"><span class="itmqty"><?php echo $o->total_prod ?> Items &nbsp; <i
                                       class="fa fa-angle-down"></i></span></div>
                           </div>
                           <div class="ordersBoxshow">
                              <ul class="ordersBoxshowtop">
                                 <li>Order ID : <span><a
                                          href="<?php echo base_url() . __orderDetails__ . '/' . $o->orders_id ?>"
                                          class="aClick_1"><?php echo $o->order_number ?></a></span></li>
                                 <li>Order Placed : <span><?php echo date("D, d M y", strtotime($o->added_on)) ?></span></li>
                              </ul>
                              <div class="ordersBoxshowbody">
                                 <div class="ordersBoxbodyInner">
                                    <p><strong>Delivery Address</strong>
                                       <span><?php echo $o->d_name ?></span><br>
                                       <?php echo $o->d_address ?>, <?php echo $o->d_city_name ?>,
                                       <?php echo $o->d_zipcode ?>
                                       <br><span>Ph: <?php echo $o->d_number ?></span>
                                    </p>
                                 </div>
                                 <div class="ordersBoxbodyInner">
                                    <p><strong>Payment Information</strong>
                                       <span>Payment Status : </span> <span class="text-success"><? if ($o->is_cod == 1) {
                                          echo "COD";
                                       } else {
                                          echo "Success";
                                       } ?></span><br>
                                 ...
                                 <div class="ordersBoxbodyInner summary">
                                    <ul>
                                       ...
                                       <? if ($o->total_packing_charges > 0) { ?>
                                          <li><span>Packing Charges </span><span> : <?php echo $o->symbol ?>
                                                <?php echo $o->total_packing_charges ?></span></li><? } ?>
                                       <li><span>Delivery Charges </span><span> : <?php echo $o->symbol ?>
                                             <?php echo $o->delivery_charges ?></span></li>
                                       <? if ($o->shipping_discount > 0) { ?>
                                          <li><span>Shipping Discount </span><span> : - <?php echo $o->symbol ?>
                                                <?php echo $o->shipping_discount ?></span></li> <? } ?>
                                       <? if ($o->cod_charges > 0) { ?>
                                          <li><span>COD Charges </span><span> : - <?php echo $o->symbol ?>
                                                <?php echo $o->cod_charges ?></span></li> <? } ?>
                                       <li><span>Order Amount </span><span> : <?php echo $o->symbol ?>
                                             <?php echo $o->total ?></span></li>
                                       <li><span><small>Savings </small></span><span class="text-success"> :
                                             <?php echo $o->symbol ?>       <?php echo ($acctual_total - $o->total) ?></span></li>
                                    </ul>
                                 </div>
                              </div>

                              <div class="ordersBoxfooter">
                                 <a href="<?php echo base_url() . __orderDetails__ . '/' . $o->orders_id ?>"
                                    class="aClick_1">View
                                    More Details &gt;</a>
                              </div>
                           </div>
   ...
   <div id="smartblog_block" class="block products_block hb-animate-element bottom-to-top hb-in-viewport">
      ...
      <script>
         window.addEventListener('load', function () {
            $(" #cus_orders_sel").html('<?php echo $val ?>');
            On_cus_orders_sel()
         })
