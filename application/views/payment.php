                ...
                <div class="l-c-div">
                  ...
                  <div class="l-c-phone">
                    <div>
                      ...
                      <span class="l-c-phone-span">+91<?php  echo $user->number ?></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="hide-div-content">
                  <div>
                    ...
                    <div class="hide-div-please-note row">
                      <span>Please note that upon clicking "Logout" you will lose all items in cart and will be
                        redirected to <?php  echo _brand_name_ ?> home page.</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="leftside-checkout-inner">
            <div class="lefside-checkout-content">
              ...
              <div class="hide-div changeAddressDiv tab2_selection">
                <h3 class="hide-div-heading">
                  <span class="hide-div-span1">2</span>
            ...
            <div class="leftside-checkout-inner">
              <div class="lefside-checkout-content">
                ...
                <div class="l-c-head tab3_head">
                  <h3 class="l-c-h31">
                    <span class="l-c-span">3</span>
                  </h3>
                  <div class="l-c-div">
                    <div class="l-c-login">ORDER SUMMARY
                      <svg height="10" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="_1t8m48">
                        <path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" stroke="#859212"></path>
                      </svg>
                    </div>
                    <div class="l-c-div">
                      ...
                      <div class="l-c-phone">
                        <div>
                          <span class="l-c-phone-span">3 Items</span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="hide-div tab3_selection" style="display:none">
                  <h3 class="hide-div-heading">
                    <span class="hide-div-span1">3</span>
            ...
            <div class="leftside-checkout-inner">
              <div class="lefside-checkout-content">
                ...
                <div class="hide-div tab4_selection" style="display:none">
                  <h3 class="hide-div-heading">
                    <span class="hide-div-span1">4</span>
                    <span class="hide-div-span2">PAYMENT OPTIONS</span>
                  </h3>
                  <form action="<?php  echo base_url() . 'pay-now' ?>" onsubmit="myFunction()" method="post">
                    <div class="hide-div-content1">
                        ...
                        <div class="hide-div-content1">
                          ...
                          <div class="hide-div-label1">
                            <label class="row ">
                              ...
                              <div class="col-lg-11 col-11">
                                <div class="hide-div-address-pay-options">
                                  <span>Cash on Delivery (<?php  echo $currency->symbol ?>
                                    <?php  echo number_format($total + $ship_details->cod_charges) ?>)</span>
                                </div>
    ...
    if (payment_type == 2) {
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          $("#payNowBTN").html(text);
          if (result.status == 1) {
            var easebuzzCheckout = new EasebuzzCheckout('<?php  echo __PG_MERCHANT_KEY__ ?>', '<?php  echo __PG_ENV__ ?>')
            var options = {
              ...
              onResponse: (response) => {
                ...
                if (response.status == "userCancelled") {
                  ...
                  $.ajax({
                    type: "POST",
                    url: '<?php  echo base_url() ?>order_confirmation',
                    dataType: "json",
                    data: { 'response': response, "<?php  echo $csrf['name'] ?>": "<?php  echo $csrf['hash'] ?>" },
                    success: function (result) { //alert(result.status);
                      console.log('result start');

                      if (result.status == 1) {
                        window.location = "<?php  echo base_url() . __orderStatus__ ?>";
                      }
                      else {
                        window.location = "<?php  echo base_url() . __orderStatus__ ?>";
                      }
...
<div class="modal fade" id="func_update_email_info_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-custom1 ">
    <div class="modal-content">
      <div class="modal-header modal-header2">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><?php  echo (!empty($user->email)) ? "Update" : "Add" ?> Your
          email</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">✕</button>
      </div>
