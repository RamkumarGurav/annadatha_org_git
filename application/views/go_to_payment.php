    ...
    <div class="grid-container" style="display:">
        ...
        <div class="form-container">
            ...
            <form method="POST" name="redirect" id="redirect"
                action="<?php echo base_url() ?>easebuzz/easebuzz.php?api_name=initiate_payment">
                ...
                <div class="main-form">
                    ...
                    <div class="mandatory-data">
                        <div class="form-field">
                            ...
                            <input id="txnid" class="txnid" name="txnid"
                                value="<?php echo $payment_gateway_data['Order_Id'] ?>" placeholder="T31Q6JT8HB">
                        </div>

                        <div class="form-field">
                            <?  //$payment_gateway_data['Amount']='1.00'; ?>
                            <label for="amount">Amount<sup>(should be float)*</sup></label>
                            <input id="amount" class="amount" name="amount"
                                value="<?php echo $payment_gateway_data['Amount'] ?>" placeholder="125.25">
                        </div>

                        <div class="form-field">
                            <label for="firstname">First Name<sup>*</sup></label>
                            <input id="firstname" class="firstname" name="firstname"
                                value="<?php echo $payment_gateway_data['name'] ?>" placeholder="Easebuzz Pvt. Ltd.">
                        </div>

                        <div class="form-field">
                            <label for="email">Email ID<sup>*</sup></label>
                            <input id="email" class="email" name="email"
                                value="<?php echo $payment_gateway_data['email'] ?>"
                                placeholder="initiate.payment@easebuzz.in">
                        </div>

                        <div class="form-field">
                            <label for="phone">Phone<sup>*</sup></label>
                            <input id="phone" class="phone" name="phone"
                                value="<?php echo $payment_gateway_data['number'] ?>" placeholder="0123456789">
                        </div>

                        <div class="form-field">
                            <label for="productinfo">Product Information<sup>*</sup></label>
                            <input id="productinfo" class="productinfo" name="productinfo" value="Test"
                                placeholder="Apple Laptop">
                        </div>

                        <div class="form-field">
                            <label for="surl">Success URL<sup>*</sup></label>
                            <input id="surl" class="surl" name="surl"
                                value="<?php echo $payment_gateway_data['Redirect_Url'] ?>"
                                placeholder="http://localhost:3000/response.php">
                        </div>

                        <div class="form-field">
                            <label for="furl">Failure URL<sup>*</sup></label>
                            <input id="furl" class="furl" name="furl"
                                value="<?php echo $payment_gateway_data['Redirect_Url'] ?>"
                                placeholder="http://localhost:3000/response.php">
                        </div>
                    ...
                    <div class="optional-data">
                        ...
                        <div class="form-field">
                            ...
                            <input id="address1" class="address1" name="address1"
                                value="<?  //=$payment_gateway_data['address'] ?>" placeholder="#250, Main 5th cross,">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input id="city" class="city" name="city" value="<?  //=$payment_gateway_data['city'] ?>"
                                placeholder="Pune">
                        </div>

                        <div class="form-field">
                            <label for="state">State</label>
                            <input id="state" class="state" name="state"
                                value="<?  //=$payment_gateway_data['state'] ?>" placeholder="Maharashtra">
                        </div>

                        <div class="form-field">
                            <label for="country">Country</label>
                            <input id="country" class="country" name="country"
                                value="<?  //=$payment_gateway_data['country'] ?>" placeholder="India">
                        </div>

                        <div class="form-field">
                            <label for="zipcode">Zip-Code</label>
                            <input id="zipcode" class="zipcode" name="zipcode"
                                value="<?  //=$payment_gateway_data['pincode'] ?>" placeholder="123456">
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input id="show_payment_mode" class="show_payment_mode" name="show_payment_mode" value=""
                                placeholder='NB,DC,CC,Debit+ATM Pin,MW,UPI,OM,EMI'>
                        </div>
