...
<div class="mt-1">
	<div class="container mb-5">
		...
		<!-- <div class="row ">
						<div class=" col-md-6">
								<img src="<?php  echo IMAGE ?>sign-up.jpg" class="loginleft">
						</div>
						<div class="col-md-5">
														...
														<div class="form-group">
															...
															echo form_input($attributes); ?>
																...
																echo form_input($attributes); ?>		
																		...
																		<p class="hereby">Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <a href="<?php  echo base_url(); ?>privacy-policy"  target="_blank">privacy policy</a>.</p> 
																 </div>
																 <br>
																 <div class="d-flex justify-content-between" style=" margin:0 auto"> 
																		<p><a href="<?php  echo base_url(__login__); ?>" class="bcklog">Back to login <i class="fa fa-long-arrow-left"></i></a></p>
