                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="GeneralTd HEader" style="vertical-align:top;">
                            ...
                            <img src="<?php echo base_url() . __scriptFilePath__ ?>images/logo.png" width="150"
                                style="margin:0;">
                        ...
                        <td colspan="2" class="GeneralTd HEader" style="vertical-align:top;padding-left: 80px;">
                            <p style="margin:0;"><strong><?php echo _project_name_ ?></strong></p>
                            <p style="margin:0;"><i class="fa fa-map-marker"></i> <?php echo _project_address_ ?></p>
                            <p style=" margin:0"><i class="fa fa-envelope"></i> <?php echo _project_email_ ?></p>
                            <p style=" margin:0"><i class="fa fa-phone"></i><?php echo _project_contact_ ?></p>
                            <p style="margin:0;"><strong>GST No :</strong> <?php echo __GSTIN__ ?></p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="7" class="GeneralTd text-left  B-TB"><strong>Order By :</strong> rashmi , 123 ,
                            rashmi@marswebsolutions.com</td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" height="10" class="GeneralTd B-B2" style=" padding:3px; text-align:right;">
                            ...
                            <!-- <img src="<?php echo base_url() . __scriptFilePath__ ?>images/signature.jpg" width="150" style="margin:0;"> -->
