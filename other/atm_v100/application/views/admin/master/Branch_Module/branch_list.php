                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='ft.branch_name' <? if ($field_name == 'ft.branch_name') {
                                                        echo 'selected';
                                                    } ?>>Branch
                                                        Name</option>
                                                    <option value='ft.branch_address' <? if ($field_name == 'ft.branch_address') {
                                                        echo 'selected';
                                                    } ?>>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->branch_id; ?>" /></td>
                                                <? } ?>
                                                <td><a
                                                        href="<?= MAINSITE_Admin . $user_access->class_name . "/branch-view/" . $urm->branch_id ?>"><?= $urm->branch_name ?></a>
                                                </td>
                                                <td><?= $urm->branch_address ?></td>
                                                <?php /*?><td><?=$urm->dial_code?></td><?php */ ?>
                                                <!-- <td><?= $urm->branch_code ?></td> -->
