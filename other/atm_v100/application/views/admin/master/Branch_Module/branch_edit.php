			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<? if (!empty($branch_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<?= MAINSITE_Admin . $user_access->class_name . "/branch_view/" . $branch_id ?>">View</a></li>
						<? } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><?= $branch_name ?> <small><?= $record_action ?></small></h3>
					</div>
					<!-- /.card-header -->
					<?php
								...
								<div class="col-lg-6 col-md-4 col-sm-6">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control form-control-sm" required id="branch_address"
											name="branch_address" value="<?= $branch_address ?>" placeholder="Branch Address">
