                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='ft.ip_address' <? if ($field_name == 'ft.ip_address') {
                                                        echo 'selected';
                                                    } ?>>IP Address
                                                    </option>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <? if (!empty($ip_address_data)) { ?>
                                    <tbody>
                                        ...
                                        foreach ($ip_address_data as $urm) {
                                            $count++;
                                            ?>
                                            <tr>
                                                <td><?= $count ?>.</td>
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->ip_address_id; ?>" /></td>
                                                <? } ?>
                                                <td><a
                                                        href="<?= MAINSITE_Admin . $user_access->class_name . "/ip-address-view/" . $urm->ip_address_id ?>"><?= $urm->ip_address ?></a>
                                                </td>
                                                <td><?php if (!empty($urm->added_on)): ?>
                                                        <?= date("d-m-Y", strtotime($urm->added_on)) ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->added_by_name)): ?>
                                                        <?= $urm->added_by_name ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->updated_on)): ?>
                                                        <?= date("d-m-Y", strtotime($urm->updated_on)) ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->updated_by_name)): ?>
                                                        <?= $urm->updated_by_name ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if ($urm->status == 1) { ?> <i class="fas fa-check btn-success btn-sm 
                                                        "></i>
