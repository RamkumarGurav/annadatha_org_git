                            ...
                            <div class="divTable">
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($ip_address_data->added_on)) {
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($ip_address_data->added_by_name)) {
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($ip_address_data->updated_on)) {
                                ...
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($ip_address_data->updated_by_name)) {
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if ($ip_address_data->status == 1) { ?> Active <i
