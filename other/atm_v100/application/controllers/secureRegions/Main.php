...
class Main extends CI_Controller
{
	...
	function get_left_nav()
	{
		...
		$this->data['left_menu_user_employee'] = $this->data['User_auth_obj']
			->get_left_menu_by_ismaster_params_moduleid(11, $params_arr);

		$this->data['left_menu_ip_address'] = $this->data['User_auth_obj']
			->get_left_menu_by_ismaster_params_moduleid(12, $params_arr);
		...
		// $this->data['left_menu_media'] = $this->data['User_auth_obj']->get_left_menu_by_ismaster_params_moduleid(11, $params_arr);
