...
class User_Employee_Module extends Main
{
	...
	function doEdit()
	{
		...
		if (
			...
			&& empty($_POST['aadhar_number']) && empty($_POST['pan_number']) && empty($_POST['birthday']) && empty($_POST['joing_date'])
		...
		$enter_data['start_time'] = $start_time;
		$enter_data['end_time'] = $end_time;
